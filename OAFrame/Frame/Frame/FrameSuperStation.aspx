...
<body onresize="javascript:initLeftTree();" onbeforeunload="alert("1")" >
                ...
                <f:Region ID="Region1" Margins="0 0 0 0" Height="60px" ShowBorder="false" ShowHeader="false"
                    ...
                    <Items>
                        <f:ContentPanel ShowBorder="false" ShowHeader="false"
                            ...
                            <div class="DivLogoSuperStation"></div>
        ...
        F.ready(function () {
            var mainTabStrip = Ext.getCmp('<%= mainTabStrip.ClientID %>');
                mainTabStrip.addTab({
                    'id': 'HomePage',
                    //'url': '',
                    'url': '/EQMSPortalMH/Pages/EnvAir/RealTimeData/InstrumentOnlineState.aspx',
                    'title': '首页',
                    'closable': false,
                    'iconCls': 'home',
                    'bodyStyle': 'padding:0px;'
            ...
            $("#frame1").attr("src", V02PortalSZ + "/Portal/LeftTree.aspx?ParentModuleGuid=df60c5db-3498-4ae5-987d-a8f090edd91b&Token=" + Token + "&id=" + Math.random());
        });
