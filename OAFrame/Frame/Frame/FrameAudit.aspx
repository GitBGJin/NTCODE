...
<body onresize="javascript:initLeftTree();">
    ...
    <script language="javascript" type="text/javascript">
        ...
        F.ready(function () {
            ...
            $("#frame1").attr("src", V02PortalSZ + "/Portal/LeftTree.aspx?ParentModuleGuid=bfa06df3-082c-4664-9bc7-5f44de4e5616&Token=" + Token + "&id=" + Math.random());
        });
