<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrameAll3.aspx.cs" Inherits="Com.Sinoyd.Frame.WebUI.FrameAll3" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Timer ID="Timer1" Interval="3" Enabled="false" OnTick="Timer1_Tick" EnableAjaxLoading="false" runat="server">
        </f:Timer>
