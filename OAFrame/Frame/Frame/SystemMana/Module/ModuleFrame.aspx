<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModuleFrame.aspx.cs" Inherits="Com.Sinoyd.Frame.WebUI.SystemMana.Module.ModuleFrame" %>
                                                ...
                                                <f:ContentPanel runat="server" ID="cp1" ShowBorder="false" ShowHeader="false">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>是否启用：</td>
                                                            <td width="150">
                                                                <f:DropDownList runat="server" ID="ddl_IsEnabled" Label="是否启用" ShowLabel="false">
                                                                    <f:ListItem Text="所有状态" Value="所有状态" />
                                                                    <f:ListItem Selected="true" Text="是" Value="1" />
                                                                    <f:ListItem Text="否" Value="0" />
                                                                </f:DropDownList>
                                                            </td>
                                                            <td style="display: none;">浏览标识：</td>
                                                            <td width="150" style="display: none;">
                                                                <f:TextBox ID="txt_ModuleCode" Label="菜单编号" runat="server" ShowLabel="false"></f:TextBox>
                                                            </td>
                                                            <td>
                                ...
                                <f:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" runat="server" AnchorValue="100% -36"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" Title="Grid1" ShowBorder="false" ShowHeader="false"
                                            ...
                                            AllowPaging="false" EnableHeaderMenu="false" EnableTextSelection="true">
                                            <Columns>
                                                ...
                                                <f:TemplateField HeaderText="浏览标识" Width="150" TextAlign="Center" Hidden="true">
                                                    <ItemTemplate>
                                                        <div style="text-align: left;">
                                                            <%# DataBinder.Eval(Container.DataItem, "ModuleCode").ToString()%>
                                                        </div>
                                                    </ItemTemplate>
                                                </f:TemplateField>
