<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CodeEdit.aspx.cs" Inherits="Com.Sinoyd.Frame.WebUI.SystemMana.Code.CodeEdit" %>
            ...
            <Items>
                <f:Form Title="Form1" BodyPadding="5px" ID="Form3"
                    ...
                    <Rows>
                        <f:FormRow>
                            <Items>
                                <f:Label ID="NodeSelect" runat="server" Label="所属分类">
                                </f:Label>
                            </Items>
                        </f:FormRow>
                        <f:FormRow>
                            <Items>
                                <f:TextBox runat="server" Required="True" Label="代码项名称" ShowRedStar="True" ID="txt_CodeName" MaxLength="30">
                                </f:TextBox>
                            </Items>
                        </f:FormRow>
                        <f:FormRow>
