<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CodeTypeFrame.aspx.cs" Inherits="Com.Sinoyd.Frame.WebUI.SystemMana.Code.CodeTypeFrame" %>
                ...
                <f:Region ID="mainRegion" ShowHeader="false" Layout="Fit" Margins="3 3 3 3" Position="Center"
                    ...
                    <Items>
                        <f:Panel ID="Panel2" runat="server" ShowBorder="true"
                            ShowHeader="false" Width="900px" Height="300px" Layout="Anchor" Title="分类管理">
                            <Items>
                                                ...
                                                <f:ContentPanel runat="server" ID="cp1" ShowBorder="false" ShowHeader="false">
                                                    <table>
                                                        <tr>
                                                            <td>分类名称：</td>
                                                            <td width="150">
                                                                <f:TextBox ID="txt_TypeName" Label="分类名称" runat="server" ShowLabel="false" MaxLength="30"></f:TextBox>
                                                            </td>
                                                            <td>
                                    ...
                                    <Toolbars>
                                        <f:Toolbar ID="Toolbar1" runat="server">
                                            <Items>
                                                ...
                                                <f:Button ID="btnDelete" Text="删除" runat="server" Icon="Delete" OnClick="Delete_Click" ConfirmText="您确定删除选中的分类吗？"></f:Button>
                                            </Items>
                                        </f:Toolbar>
                                    </Toolbars>
                                    <Items>
                                        <f:Grid ID="Grid1" Title="Grid1" ShowBorder="false" ShowHeader="false"
                                            ...
                                            <Columns>
                                                <f:TemplateField HeaderText="分类名称"  Width="150" TextAlign="Center">
                                                    <ItemTemplate>
