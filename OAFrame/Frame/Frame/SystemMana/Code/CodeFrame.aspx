<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CodeFrame.aspx.cs" Inherits="Com.Sinoyd.Frame.WebUI.SystemMana.Code.CodeFrame" %>
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region2" Width="200px"
                    Margins="3 3 3 3" ShowHeader="false" Title="代码分类" Icon="Outline" EnableCollapse="true"
                                                ...
                                                <f:ContentPanel runat="server" ID="cp1" ShowBorder="false" ShowHeader="false">
                                                    <table>
                                                        <tr>
                                                            <td>代码名称：</td>
                                                            <td width="150">
                                                                <f:TextBox ID="txt_CodeName" Label="代码名称" runat="server" ShowLabel="false" MaxLength="30"></f:TextBox>
                                                            </td>
                                                            <td>
                                    ...
                                    <Toolbars>
                                        <f:Toolbar ID="Toolbar1" runat="server">
                                            <Items>
                                                ...
                                                <f:Button ID="btnDelete" Text="删除" runat="server" Icon="Delete" OnClick="Delete_Click" ConfirmText="您确定删除选中的代码吗？"></f:Button>
                                            </Items>
                                        </f:Toolbar>
                                    </Toolbars>
                                    <Items>
                                        <f:Grid ID="Grid1" Title="Grid1" ShowBorder="false" ShowHeader="false"
                                            ...
                                            <Columns>
                                                <f:TemplateField HeaderText="代码名称"  Width="150" TextAlign="Center">
                                                    <ItemTemplate>
                                                        <div style="text-align: left;">
                                                            <%# DataBinder.Eval(Container.DataItem, "CodeName").ToString()%>
                                                        </div>
                                                    </ItemTemplate>
                                                </f:TemplateField>
                                                ...
                                                <f:TemplateField HeaderText="代码项" Width="80" TextAlign="Center">
                                                    <ItemTemplate>
                                                        <a href="<%# GetSetUrl(DataBinder.Eval(Container.DataItem, "[RowGuid]")) %>">
