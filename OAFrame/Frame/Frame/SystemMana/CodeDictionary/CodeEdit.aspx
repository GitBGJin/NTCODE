<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CodeEdit.aspx.cs" Inherits="Com.Sinoyd.Frame.WebUI.SystemMana.CodeDictionary.DeptEdit" %>
            ...
            <Items>
                <f:Form Title="Form1" BodyPadding="5px" ID="Form3"
                    ...
                    <Rows>
                        <f:FormRow>
                            <Items>
                                <f:TextBox runat="server" Required="True" Label="&nbsp;名称" ShowRedStar="True" ID="txt_CodeDictionaryName" MaxLength="30">
                                </f:TextBox>
