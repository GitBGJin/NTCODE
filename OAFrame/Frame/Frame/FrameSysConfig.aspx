...
<body onresize="javascript:initLeftTree();">
                ...
                <f:Region ID="Region1" Margins="0 0 0 0" Height="60px" ShowBorder="false" ShowHeader="false"
                    ...
                    <Items>
                        <f:ContentPanel ShowBorder="false" ShowHeader="false"
                            ...
                            <div class="DivLogoSysConfig"></div>
    ...
    <script language="javascript" type="text/javascript">
        ...
        F.ready(function () {
            ...
            $("#frame1").attr("src", V02PortalSZ + "/Portal/LeftTree.aspx?ParentModuleGuid=1a339764-c55d-4129-a9ab-29a60eca90aa&Token=" + Token + "&id=" + Math.random());
        });
