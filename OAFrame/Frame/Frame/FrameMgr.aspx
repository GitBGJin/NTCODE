...
<body onresize="javascript:initLeftTree();">
                                            ...
                                            <tr>
                                                                        ...
                                                                        <td class="lineButton_center">
                                                                            <table>
                                                                                <tr>
                                                                                   <%-- <td>
                                                                                        <div>
                                                                                            <input type="button" class="iconText" onclick="OpenSetWin1()" title="个人菜单设置" id="Button7" style="border: none; cursor: pointer;" />
                                                                                        </div>
                                                                                    </td>--%>
                                                                                    <td>
                                                                                        <div>
                                                ...
                                                <td id="Td_right_menu">
                                                    <div>
                                                        ...
                                                        <div id="iconImg" style="background-position:-91px -61px"></div>
                                                        <div id="dropDown"></div>
                                                    </div>
                                                </td>
                ...
                <f:Region ID="Region2" Split="true"
                    ...
                    <Items>
                        <f:ContentPanel runat="server" ID="abc1" Width="100%" ShowBorder="false" ShowHeader="false" BoxConfigAlign="Center" Title="<font style='color:#FFF;font-size:14px;font-weight:bold;'>系统菜单</font>">
                            <iframe id="frame1" name="leftMenuFrame" height="10000px" width="100%" frameborder="0" title="Neptune"></iframe>
                        </f:ContentPanel>
    ...
    <script language="javascript" type="text/javascript">
        ...
        F.ready(function () {
            ...
            mainTabStrip.addTab({
                'id': 'HomePage',
                //'url': 'SystemMana/User/UserFrame.aspx?Token=' + Token,
                'url': '',
                'title': '首页',
                'closable': false,
                'iconCls': 'home',
            ...
            $("#frame1").attr("src", V02PortalSZ + "/Portal/LeftTree.aspx?ParentModuleGuid=cec76cd7-8624-44ca-814a-1852e17899c2&Token=" + Token + "&id=" + Math.random());
        });
