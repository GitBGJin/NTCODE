<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeftTree.aspx.cs" Inherits="Com.Sinoyd.Frame.WebUI.Personal.ModuleLeftTree2.LeftTree" %>
            ...
            $('.vtitle').click(function () {
                ...
                $('.vtitle em').each(function (e) {
                    if (e == tabs_i) {
                        ...
                        $("#first_" + e).css("background-color", "#528ECD");
                    } else {
                        $(this).removeClass('v02').addClass('v01');
                        $("#first_" + e).css("background-color", "#AED3F0");
                    }
                });
                $('.vcon').slideUp().eq(tabs_i).slideDown();
            });
            
            if ("<%=ViewState["fisrtModuleGuid"]%>" != "") {
                window.parent.showwindows('<%=ViewState["fisrtModuleGuid"]%>', '<%=ViewState["firstUrl"]%>', '<%=ViewState["firstTitle"]%>');
            }
