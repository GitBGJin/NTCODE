                ...
                <f:Region ID="Region1" Margins="0 0 0 0" Height="60px" ShowBorder="false" ShowHeader="false"
                    ...
                    <Items>
                        <f:ContentPanel ShowBorder="false" ShowHeader="false"
                            ...
                            <div class="DivLogoRelevance"></div>
        ...
        F.ready(function () {
            var mainTabStrip = Ext.getCmp('<%= mainTabStrip.ClientID %>');
                mainTabStrip.addTab({
                    'id': 'HomePage',
                    'url': '',
                    //'url': '/EQMSPortalNT/Pages/EnvAir/DataAnalyze/OriginalScatter.aspx',
                    'title': '首页',
                    'closable': false,
                    'iconCls': 'home',
                    'bodyStyle': 'padding:0px;'
            ...
            $("#frame1").attr("src", V02PortalSZ + "/Portal/LeftTree.aspx?ParentModuleGuid=b39d74d8-09af-4ba0-8385-1734ce88a551&Token=" + Token + "&id=" + Math.random());
        });
