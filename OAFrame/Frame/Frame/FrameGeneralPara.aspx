...
<body onresize="javascript:initLeftTree();">
    <form id="form1" runat="server">
        ...
        <script runat="server" language="C#">
            static string InnerIP = System.Configuration.ConfigurationManager.AppSettings["InnerIP"].ToString();
            bool IsInnerNetWork = SmartEP.Utilities.Web.NetWork.Networks.IsInnerNetWork(InnerIP.ToString());
            ...
            {
                if (IsInnerNetWork == true)
                {
                    //PortalUrl = InnerPortalUrl;
                    WelcomeTitle.InnerText = "欢迎，" + HttpContext.Current.Session["DisplayName"];
                }
            }
        ...
        <script type="text/javascript">
            ...
            var PortalUrl = '<%=PortalUrl.ToString()%>';
            ...
            function Back() {
                    top.location = V02PortalSZ + "/Portal/HomePage.aspx";
            }
            function SysChange(sysName) {
                if (window.confirm("你确定要切换系统？")) {
                    if (sysName == 'SuperStation')
                        top.location = V02PortalSZ + "/Portal/MidPage.aspx?Type=SuperStation";
                    else if (sysName == 'GeneralPara')
                        top.location = V02PortalSZ + "/Portal/MidPage.aspx?Type=GeneralPara";
                    else if (sysName == 'Relevance')
                        top.location = V02PortalSZ + "/Portal/MidPage.aspx?Type=Relevance";
                    else if (sysName == 'Audit')
                        top.location = V02PortalSZ + "/Portal/MidPage.aspx?Type=Audit";
                    else if (sysName == 'SysConfig')
                        top.location = V02PortalSZ + "/Portal/MidPage.aspx?Type=SysConfig";
                    else if (sysName == 'Statistic')
                        top.location = V02PortalSZ + "/Portal/MidPage.aspx?Type=Statistic";
                    else if (sysName == 'GIS')
                        window.location = V02PortalSZ + "/Portal/MidPage.aspx?Type=GIS";
                    else if (sysName == 'Video')
                        window.location = V02PortalSZ + "/Portal/MidPage.aspx?Type=Video";
                    else if (sysName == 'Mgr')
                ...
                <f:Region ID="Region1" Margins="0 0 0 0" Height="60px" ShowBorder="false" ShowHeader="false"
                    ...
                    <Items>
                        <f:ContentPanel ShowBorder="false" ShowHeader="false"
                                    ...
                                    <tr>
                                        <td style="background: url(Content/images/imgs/bg_leftMenurepeat.png) repeat-y; width: 73px;">
                                            <ul>
                                                <li id="SuperStation">
                                                    <a href="#">
                                                        <img src="Content/images/nt/超级站管理.png" alt="" />
                                                        <span >超级站</span>
                                                    </a>
                                                </li>
                                                <li id="GeneralPara">
                                                    <a href="#">
                                                        <img src="Content/images/nt/常规参数.png" alt="" />
                                                        <span>常规参数</span>
                                                    </a>
                                                </li>
                                                <li id="Relevance">
                                                    <a href="#">
                                                        <img src="Content/images/nt/关联性分析.png" alt="" />
                                                        <span>关联性</span>
                                                    </a>
                                                </li>
                                                <li id="Audit">
                                                    <a href="#">
                                                        <img src="Content/images/nt/数据审核.png" alt="" />
                                                        <span>数据审核</span>
                                                    </a>
                                                </li>
                                                <li id="SysConfig">
                                                    <a href="#">
                                                        <img src="Content/images/nt/系统管理.png" alt="" />
                                                        <span>系统管理</span>
                                                    </a>
                                                </li>
                                                <li id="Statistic">
                                                    <a href="#">
                                                        <img src="Content/images/nt/统计.png" alt="" />
                                                        <span>统计</span>
                                                    </a>
                                                </li>
                                                <li id="GIS">
                                                    <a href="#">
                                                        <img src="Content/images/nt/GIS.png" alt="" />
                                                        <span>GIS</span>
                                                    </a>
                                                </li>
                                                <li id="Video">
                                                    <a href="#">
                                                        <img src="Content/images/nt/报表管理.png" alt="" />
                                                        <span>报表管理</span>
                                                    </a>
                                                </li>
                                                <li id="Mgr">
                                                    <a href="#">
                                                        <img src="Content/images/nt/后台.png" alt="" />
                                                        <span>后台</span>
                                                    </a>
                                                </li>
                                            </ul>
                            ...
                            <div class="DivLogoGeneralPara"></div>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td valign="top" style="width: 460px;">
                                                    <%--<div style="background: url(App_Themes/Neptune/imgs/icon_All.png) no-repeat 0 2px;"></div>--%>
                                                    <%--<div class="DivLogoAir"></div>--%>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                                                        ...
                                                                        <td class="lineButton_center">
                                                                            <table>
                                                                                <tr>
                                                                                    <td>
                                                                                        <div>
                                                                                            <input type="button" class="iconText" onclick="OpenModuleFrame()" title="个人菜单设置" id="Button7" style="border: none; cursor: pointer;" />
                                                                                        </div>
                                                                                    </td>
                                                                                    <td>
                                                                                        <div>
                                                                                            <input type="button" class="iconSetting" onclick="OpenSetWin()" title="重置密码" id="Button8" style="border: none; cursor: pointer;" />
                                                                                        </div>
                                                                                    </td>
                                                                                    <td>
                                                                                        <div>
                                                                                    ...
                                                                                    <td>
                                                                                        <div>
                                                                                            <input type="button" class="iconCloth" title="返回" onclick="Back()" id="Button6" style="border: none; cursor: pointer;" />
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                ...
                <f:Region ID="Region2" Split="true"
                    ...
                    <Items>
                        <f:ContentPanel runat="server" ID="abc1" Width="205%" Height="650%" ShowBorder="false" ShowHeader="false" BoxConfigAlign="Center" Title="<font style='color:#FFF;font-size:14px;font-weight:bold;'>系统菜单</font>">
                              <iframe id="frame1" name="leftMenuFrame" width="100%" frameborder="0" title="Neptune" scrolling="auto"></iframe>
                        </f:ContentPanel>
    ...
    <script language="javascript" type="text/javascript">
        ...
        F.ready(function () {
            ...
            $("#frame1").attr("src", V02PortalSZ + "/Portal/LeftTree.aspx?ParentModuleGuid=f2ee4d05-6caa-4505-8f41-990ded228607&Token=" + Token + "&id=" + Math.random());

            var mainTabStrip = Ext.getCmp('<%= mainTabStrip.ClientID %>');
                mainTabStrip.addTab({
                    'id': 'HomePage',
                    //'url':'',
                    'url': '/EQMSPortalNT/Pages/EnvAir/RealTimeData/RealTimeOnlineState.aspx',
                    'title': '首页',
                    'closable': false,
                    'iconCls': 'home',
                    'bodyStyle': 'padding:0px;'
            ...
            //$("#frame2").attr("src", V02PortalSZ + "/Portal/PersonalLeftTree.aspx?ParentModuleGuid=f2ee4d05-6caa-4505-8f41-990ded228607&Token=" + Token + "&id=" + Math.random());
        });
