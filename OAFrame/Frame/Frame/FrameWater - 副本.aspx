...
<body onresize="javascript:initLeftTree();">
                ...
                <f:Region ID="Region1" Margins="0 0 0 0" Height="60px" ShowBorder="false" ShowHeader="false"
                    ...
                    <Items>
                        <f:ContentPanel ShowBorder="false" ShowHeader="false"
                            ...
                            <table style="background-image: url(Content/images/index/WaterTop.png); background-repeat: no-repeat; padding-top: 0px; border-width: 0px; background-color: #8eddfa;" width="100%">
                                <tr>
    ...
    <script language="javascript">
        ...
        F.ready(function () {
            ...
            $("#frame1").attr("src", V02PortalSZ + "/Portal/LeftTree.aspx?ParentModuleGuid=fd2d3899-7047-4452-9a70-8fd329160a73" + "&id=" + Math.random());
        });
