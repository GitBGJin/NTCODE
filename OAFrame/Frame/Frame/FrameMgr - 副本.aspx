...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        .tableLogo {
            ...
            width: 100%;
            height: 100%;
            background: url('Content/images/index/AirTop.png');
            ...
            filter: progid:DXImageTransform.Microsoft.AlphaImageLoader( src='Content/images/index/AirLogoBg.JPG', sizingMethod='scale');
            height: 100%;
            left: 0;
            top: 0;*/
        }
...
<body onresize="javascript:initLeftTree();">
    <form id="form1" runat="server">
        ...
        <script runat="server" language="C#">
            ...
            protected void SysLogout_Click(object sender, EventArgs e)
            {
                string PortalUrl = System.Configuration.ConfigurationManager.AppSettings["PortalUrl"].ToString();
                string PortalName = System.Configuration.ConfigurationManager.AppSettings["PortalName"].ToString();
                Response.Redirect(PortalUrl + "/" + PortalName + "/Login.aspx");
            }
        </script>
                ...
                <f:Region ID="Region1" Margins="0 0 0 0" Height="60px" ShowBorder="false" ShowHeader="false"
                    ...
                    <Items>
                        <f:ContentPanel ShowBorder="false" ShowHeader="false"
                            ...
                            <table style="background: url('Content/images/index/MgrTop.png'); background-repeat: no-repeat; background-color: #8eddfa" width="100%">
                                <tr>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" style="background-color: none; height: 55px;">
                                            <tr>
                                                <td valign="top" style="width: 500px;">
                                                    <%--<img src="Content/images/index/AirTop.png" />--%></td>
                                                <td></td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td align="right">
                                        <table cellpadding="0" cellspacing="0" border="0" height="60" style="background-image: url('Content/images/index/rightLogo.png'); background-color: none;">
                                            <tr>
    ...
    <script language="javascript">
        ...
        F.ready(function () {
            ...
            //$("#frame1").attr("src", V02PortalSZ + "/LeftTree.aspx?ParentModuleGuid=cec76cd7-8624-44ca-814a-1852e17899c2" + "&id=" + Math.random());
            $("#frame1").attr("src", V02PortalSZ + "/LeftTree.aspx?ParentModuleGuid=0" + "&id=" + Math.random());
        });
