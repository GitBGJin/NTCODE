<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrameAll2.aspx.cs" Inherits="Com.Sinoyd.Frame.WebUI.FrameAll2" %>
...
<body onresize="javascript:initLeftTree();">
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server" BodyPadding="3">
            <Regions>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" height="60" style="background-color: #3D85D3;">
                                            <tr>
                                                ...
                                                <td style="display: none;">
                                                    ...
                                                    <f:TextBox runat="server" ID="txt_Menu1Count" Text="1"></f:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                ...
                <f:Region ID="Region2" Split="false"
                    Width="230px" Margins="0 0 0 0" ShowHeader="false" ShowBorder="true" Title="菜单"
                    Icon="Outline" EnableCollapse="true" Layout="Fit" Position="Left" runat="server" Collapsed="false">
                    <Items>
                        <f:ContentPanel runat="server" ID="abc1" ShowBorder="false" ShowHeader="true" BoxConfigAlign="Center" Title="<font style='color:#FFF;font-size:14px;font-weight:bold;'>系统菜单</font>">
    ...
    <script language="javascript">
        ...
        F.ready(function () {
            ...
            $("#frame1").attr("src", 'Personal/ModuleLeftTree2/LeftTree.aspx?DetailModuleGuid=<%= Request["DetailModuleGuid"] %>&offsetHeight=' + $('#<%= txt_Menu1Count.ClientID %>').val() + "&id=" + Math.random());
        });
