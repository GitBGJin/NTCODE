...
<body onresize="javascript:initLeftTree();">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server" BodyPadding="3">
            <Regions>
                        ...
                        <f:ContentPanel ShowBorder="false" ShowHeader="false"
                            ...
                            <div id="leftMenu" style="color: #333; font-size: 13px; width: 73px; display: none; position: fixed; top: 0; right: 0; z-index: 9999; margin-top: 47px;">
                                <table>
                                    <tr>
                                        <td>
                                            <img src="Content/images/imgs/bg_leftMenuUp.png" alt="" style="margin: 0px 0px -3px -1px;" />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <img src="Content/images/imgs/bg_leftMenudown.png" alt="" style="margin-top: -3px; margin-left: -1px;" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
                                    ...
                                    <td id="Td_right" align="right">
                                        <table>
                                            <tr>
                                                ...
                                                <td id="Td_right_menu">
                                                    <div>
                                                        <div id="iconImg" style="background-position:-29px -56px"></div>
                                                        <div id="dropDown"></div>
                                                    </div>
                                                </td>
                ...
                <f:Region ID="Region2" Split="true"
                    ...
                    <Items>
                        <f:ContentPanel runat="server" ID="ContentPanel2" Width="205%" Height="650%" ShowBorder="false" ShowHeader="false" BoxConfigAlign="Center" Title="<font style='color:#FFF;font-size:14px;font-weight:bold;'>系统菜单</font>">
                        ...
                        <%--<f:TabStrip ID="TabStrip1" EnableTabCloseMenu="true" ShowBorder="true" runat="server" Hidden="false">
                            <Tabs>
                                <f:Tab ID="Tab1" Title="标准菜单" runat="server" Icon="Application" Width="100%">
                                    <Items>
    ...
    <script language="javascript" type="text/javascript">
        ...
        var V02PortalSZ = PortalUrl + "/" + PortalName;
        var Token = '<%=Request["Token"].ToString()%>';
        var homePage = V02PortalSZ + "/Pages/EnvWater/Dock/Dashboard.aspx";
