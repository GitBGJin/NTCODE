        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server" BodyPadding="3">
            <Regions>
                                            ...
                                            <ul>
                                                <li id="FrameAir">
                                                    <a href="#">
                                                        ...
                                                        <span style="text-align: center;">环境空气</span>
                                                    </a>
                                                </li>
                                                <li id="FrameWater">
                                                    <a href="#">
                ...
                <f:Region ID="Region2" Split="true"
                    ...
                    <Items>
                        <f:TabStrip ID="TabStrip1" EnableTabCloseMenu="true" ShowBorder="true" runat="server" Height="100%">
                            <Tabs>
                                ...
                                <f:Tab ID="Tab2" Title="个人菜单" runat="server" Icon="User">
                                    <Items>
                                        <f:ContentPanel runat="server" ID="abc2" Width="205%" Height="650%" ShowBorder="false" ShowHeader="false" BoxConfigAlign="Center" Title="<font style='color:#FFF;font-size:14px;font-weight:bold;'>系统菜单</font>">
                                            <iframe id="frame2" name="leftPersonalMenuFrame" width="100%" height="100%" frameborder="0" title="Neptune" scrolling="auto"></iframe>
                                        </f:ContentPanel>
                                    </Items>
                                </f:Tab>
                            </Tabs>
    ...
    <script language="javascript" type="text/javascript">
        ...
        F.ready(function () {
            var mainTabStrip = Ext.getCmp('<%= mainTabStrip.ClientID %>');
                mainTabStrip.addTab({
                    'id': 'HomePage',
                    'url': '/EQMSPortalSZ/Pages/EnvAir/Dock/DashboardWhite.aspx',
                    'title': '首页',
                    'closable': false,
                    'iconCls': 'home',
                    'bodyStyle': 'padding:0px;'
            ...
            $("#frame2").attr("src", V02PortalSZ + "/Portal/PersonalLeftTree.aspx?ParentModuleGuid=cbb3a26a-42cb-4149-afc8-18058196dd21&Token=" + Token + "&id=" + Math.random());
        });
