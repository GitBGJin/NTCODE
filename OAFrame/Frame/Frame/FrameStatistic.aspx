...
<body onresize="javascript:initLeftTree();">
                ...
                <f:Region ID="Region1" Margins="0 0 0 0" Height="60px" ShowBorder="false" ShowHeader="false"
                    ...
                    <Items>
                        <f:ContentPanel ShowBorder="false" ShowHeader="false"
                            ...
                            <div class="DivLogoStatistic"></div>
    ...
    <script language="javascript" type="text/javascript">
        ...
        F.ready(function () {
            ...
            $("#frame1").attr("src", V02PortalSZ + "/Portal/LeftTree.aspx?ParentModuleGuid=daa97524-6227-4492-8353-f1ac1e35be6d&Token=" + Token + "&id=" + Math.random());
        });

        function initLeftTree() {
            $("#frame1").attr("height", GetBodyHeight());
            //$("#frame1").attr("src", V02PortalSZ + "/Portal/LeftTree.aspx?ParentModuleGuid=2e0dda1e-9a9f-4564-a464-33a9b4a39a72&Token=" + Token + "&id=" + Math.random());
        }
