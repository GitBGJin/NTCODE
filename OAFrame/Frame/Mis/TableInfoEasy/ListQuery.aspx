<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListQuery.aspx.cs" Inherits="Com.Sinoyd.Mis.WebUI.TableInfoEasy.ListQuery"
    Debug="true" %>
                ...
                <f:ContentPanel ID="ContentPanel1" runat="server" BodyPadding="5px" ShowBorder="false" ShowHeader="false" Title="ContentPanel">
                    <table>
                        <tr>
                            ...
                            <td>
                                <f:Button ID="btnImport" Text="查找" runat="server" Icon="Magnifier" OnClick="btnSearch_Click"></f:Button>
                            </td>
                        </tr>
                    </table>
                </f:ContentPanel>
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                ...
                                <f:Button ID="btnDel" Text="删除" runat="server" Icon="Cancel" EnablePostBack="true" OnClick="btnDel_OnClick" ConfirmText="您确定删除选中的数据吗？">
                                </f:Button>
                                <f:Button ID="btnExport" Text="导出" runat="server" Icon="PageExcel" EnableAjax="false" OnClick="btnExport_OnClick">
                                </f:Button>
                            </Items>
                        </f:Toolbar>
                    </Toolbars>
                    <Items>
                        <f:Grid ID="Grid1" Title="Grid1" PageSize="20" ShowBorder="false" ShowHeader="False" AllowSorting="true"
                             SortDirection="ASC"  SortField="ID" AllowPaging="true" runat="server" EnableCheckBoxSelect="true"
                             DataKeyNames="RowGuid" IsDatabasePaging="true" OnPageIndexChange="Grid1_PageIndexChange"
                             OnSort="Grid1_Sort" EnableTextSelection="true" RowVerticalAlign="Middle" EnableHeaderMenu="false">
                            <Columns>
                                <f:RowNumberField Width="40"></f:RowNumberField>
                            </Columns>
                        </f:Grid>
                    </Items>
                </f:Panel>
