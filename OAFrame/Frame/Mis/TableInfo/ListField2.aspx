<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListField2.aspx.cs" Inherits="Com.Sinoyd.Mis.WebUI.TableInfo.ListField2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Mis表字段管理(列表、搜索)</title>
</head>
<body>
        ...
        <Items>
            <f:Grid ID="Grid1" Title="基本设置" PageSize="200" ShowBorder="false" ShowHeader="false"
                ...
                <Columns>
                    ...
                    <f:TemplateField Width="85px" HeaderText="显示位置" TextAlign="Center">
                        <ItemTemplate>
                            <asp:DropDownList Width="100%" runat="server" ID="ddl_ListPosition">
                    ...
                    <f:TemplateField Width="85px" HeaderText="显示宽度" TextAlign="Center">
                        <ItemTemplate>
                            <asp:TextBox runat="server" ID="txt_ListGridWidth" Width="100%" Text='<%# DataBinder.Eval(Container.DataItem, "ListGridWidth").ToString()%>'>
                            </asp:TextBox>
                        </ItemTemplate>
                    </f:TemplateField>
                    <f:TemplateField Width="85px" HeaderText="启用排序" TextAlign="Center">
                        <ItemTemplate>
                            <asp:DropDownList Width="100%" runat="server" ID="ddl_ListIsSort">
                                <asp:ListItem Text="是" Value="1"></asp:ListItem>
                                <asp:ListItem Text="否" Value="0"></asp:ListItem>
                            </asp:DropDownList>
                        </ItemTemplate>
                    ...
                    <f:TemplateField Width="85px" HeaderText="高级搜索" TextAlign="Center">
                        <ItemTemplate>
                            <asp:DropDownList Width="100%" runat="server" ID="ddl_SearchIsShowAdv">
                                <asp:ListItem Text="是" Value="1"></asp:ListItem>
                                <asp:ListItem Text="否" Value="0"></asp:ListItem>
                            </asp:DropDownList>
                        </ItemTemplate>
                    </f:TemplateField>
                    <f:TemplateField Width="85px" HeaderText="搜索类型" TextAlign="Center">
                        <ItemTemplate>
                            <asp:DropDownList Width="100%" runat="server" ID="ddl_SearchType">
                    ...
                    <f:TemplateField Width="85px" HeaderText="搜索框宽度" TextAlign="Center">
                        <ItemTemplate>
                            <asp:TextBox runat="server" ID="txt_SearchWidth" Width="100%" Text='<%# DataBinder.Eval(Container.DataItem, "SearchWidth").ToString()%>'>
                            </asp:TextBox>
                        </ItemTemplate>
                    </f:TemplateField>
                </Columns>
