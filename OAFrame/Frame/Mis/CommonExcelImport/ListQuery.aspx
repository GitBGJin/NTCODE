<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListQuery.aspx.cs" Inherits="Com.Sinoyd.Mis.WebUI.CommonExcelImport.ListQuery"
    Debug="true" %>
...
<body>
    ...
    <f:PageManager ID="PageManager1" AutoSizePanelID="Panel1" runat="server" AjaxTimeout="600"></f:PageManager>
            ...
            <f:Panel ID="Panel2" ShowBorder="true" ShowHeader="false" runat="server" AnchorValue="100% -36"
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar1" runat="server">
                        <Items>
                            <f:Button ID="btnNew" Text="上传Excel" runat="server" Icon="PageExcel" EnablePostBack="true">
                            </f:Button>
                ...
                <Items>
                    <f:Grid ID="Grid1" Title="Grid1" PageSize="20" ShowBorder="true" ShowHeader="False"
                        AllowSorting="true" SortDirection="ASC" AllowPaging="true" runat="server" EnableCheckBoxSelect="false"
    ...
    <f:Window ID="Window1" Title="Add" EnableIFrame="true" runat="server" EnableCollapse="false"
        ...
        Width="600px" Height="120px" OnClose="Window1_OnClose" Hidden="true">
    </f:Window>
    <f:Window ID="Window2" Title="Edit" EnableIFrame="true" runat="server" EnableCollapse="false"
        EnableDrag="false" EnableConfirmOnClose="false" IFrameUrl="about:blank" Target="Self"
        Width="600px" Height="120px" OnClose="Window2_OnClose" Hidden="true">
    </f:Window>
    </form>
</body>
</html>
