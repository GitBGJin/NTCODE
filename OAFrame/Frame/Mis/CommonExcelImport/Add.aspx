<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Com.Sinoyd.Mis.WebUI.CommonExcelImport.Add" %>
                    ...
                    <Rows>
                        ...
                        <f:FormRow>
                            <Items>
                                ...
                                <f:TextBox runat="server" ID="txt_SheetName" Label="Sheet名" Required="true" ShowRedStar="true">
                                </f:TextBox>
                            </Items>
                        </f:FormRow>
                    </Rows>
