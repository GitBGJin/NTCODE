<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListApply.aspx.cs" Inherits="TK.Mis.Web.TableInfoSet.Circle.ListApply" %>
...
<body>
            ...
            <f:ContentPanel ID="ContentPanel1" runat="server" BodyPadding="5px" ShowBorder="false" ShowHeader="false" Title="ContentPanel">
                <table>
                    <tr>
                        ...
                        <td width="300">
                            <f:TextBox ID="txt_ShowTableName" runat="server" Width="300">
                            </f:TextBox>
                        </td>
                        ...
                        <td width="100" style="display:none;">
                            <f:DropDownList runat="server" ID="ddl_Type" Label="状态" Width="100">
            ...
            <f:Panel ID="Panel2" ShowBorder="false" ShowHeader="false" runat="server" AnchorValue="100% -36" Layout="Fit">
                <Toolbars>
                    <f:Toolbar ID="Toolbar1" runat="server" Hidden="true">
                        <Items>
                            <f:Button ID="btnNew" Text="添加" runat="server" Icon="Add" EnablePostBack="false" Hidden="true">
                            </f:Button>
                            <f:Button ID="btnDel" Text="删除" runat="server" Icon="Cancel" EnablePostBack="true" OnClick="btnDel_OnClick" ConfirmText="您确定删除选中的记录吗？" Hidden="true">
                            </f:Button>
                ...
                <Items>
                    <f:Grid ID="Grid1" Title="Grid1" PageSize="20" ShowBorder="true" ShowHeader="False" SortDirection="ASC" AllowPaging="true" runat="server" EnableCheckBoxSelect="false" DataKeyNames="RowGuid" IsDatabasePaging="true" OnSort="Grid1_Sort" OnPageIndexChange="Grid1_PageIndexChange" EnableTextSelection="true" RowVerticalAlign="Middle">
                        <Columns><f:RowNumberField></f:RowNumberField>
                            ...
                            <f:TemplateField TextAlign="Center" Width="60" HeaderText="状态" Hidden="true">
                                <ItemTemplate>
                                    <%# getStatus(DataBinder.Eval(Container.DataItem, "[Status]"))%>
                                </ItemTemplate>
                            </f:TemplateField>
                            <f:TemplateField TextAlign="Center" Width="60" HeaderText="是否上报" Hidden="true">
                                <ItemTemplate>
                                    <%# getApplyStatus(DataBinder.Eval(Container.DataItem, "[RowGuid]").ToString())%>
                                </ItemTemplate>
                            </f:TemplateField>
                            <f:TemplateField TextAlign="Center" Width="80" HeaderText="上报">
                                <ItemTemplate>
                                    <%# getApplyUrl(DataBinder.Eval(Container.DataItem, "[Title]").ToString(), DataBinder.Eval(Container.DataItem, "[TableRowGuid]").ToString(), DataBinder.Eval(Container.DataItem, "[RowGuid]").ToString(), DataBinder.Eval(Container.DataItem, "[Status]").ToString())%>
                                </ItemTemplate>
                            </f:TemplateField>
                        </Columns>
                    </f:Grid>
    ...
    <f:Window ID="Window1" Title="Edit" EnableIFrame="true" runat="server" EnableCollapse="true" EnableDrag="true" IFrameUrl="about:blank" Target="Parent" EnableMaximize="true" AutoScroll="true" Width="800px" Height="520px" CloseAction="HidePostBack" OnClose="Window1_OnClose" Hidden="true">
    </f:Window>
