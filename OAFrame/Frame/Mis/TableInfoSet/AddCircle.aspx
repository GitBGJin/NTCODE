<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCircle.aspx.cs" Inherits="TK.Mis.Web.TableInfoSet.AddCircle" %>
            ...
            <f:Form Title="基本信息" BodyPadding="5px" ID="Form3" ShowHeader="false" ShowBorder="false" runat="server" EnableLightBackgroundColor="true" LabelWidth="90" EnableCollapse="true">
                <Rows>
                    ...
                    <f:FormRow ColumnWidths="25% 25% 25% 25%">
                        <Items>
                            <f:DropDownList runat="server" ID="ddl_FromCelColumn" Required="true" ShowRedStar="true" Label="开始列">
                            </f:DropDownList>
                            <f:NumberBox runat="server" ID="txt_FromCellRow" DecimalPrecision="0" MinValue="1" MaxValue="1000" Label="开始行" Required="true" ShowRedStar="true">
                            </f:NumberBox>
                            <f:DropDownList runat="server" ID="ddl_EndCellColumn" Required="true" ShowRedStar="true" Label="结束列">
                            </f:DropDownList>
                            <f:NumberBox runat="server" ID="txt_EndCellRow" DecimalPrecision="0" MinValue="1" MaxValue="1000" Label="结束行" Required="true" ShowRedStar="true">
                            </f:NumberBox>
                        </Items>
                    </f:FormRow>
                    <f:FormRow>
