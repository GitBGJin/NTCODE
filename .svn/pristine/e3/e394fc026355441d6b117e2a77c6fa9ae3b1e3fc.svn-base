<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OperationStatistics.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.DataAnalyze.OperationStatistics" %>
    ...
    <form id="form1" runat="server">
        <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
            <script type="text/javascript" language="javascript">
                ...
                function RowClick(pointName, dtStart, dtEnd, factorCodes) {
                    var moduleGuide = "ee2ecbfd-eb45-432f-92bd-215dd9a44275";
                    OpenFineUIWindow(moduleGuide, "Pages/EnvAir/DataAnalyze/AuditData.aspx?PointName=" + pointName + "&DTBegin=" + dtStart + "&DTEnd=" + dtEnd + "&Factors=" + factorCodes, "审核数据")
                }
            </script>
            ...
            <telerik:RadPane ID="paneWhere" runat="server" Height="60px" Width="100%" Scrolling="None"
                ...
                <table id="Tb" style="width: 100%; height: 100%" cellspacing="1" cellpadding="0" class="Table_Customer"
                    ...
                    <tr>
                        ...
                        <td class="content" style="width: 300px;">
                            <telerik:RadMonthYearPicker ID="monthBegin" runat="server" MinDate="1900-01-01" BorderWidth="1px" Width="110px"
                        ...
                        <td class="content" style="width: 300px;">
                            <telerik:RadMonthYearPicker ID="monthEnd" runat="server" MinDate="1900-01-01" BorderWidth="1px" Width="110px"
                                DatePopupButton-ToolTip="打开日历选择" Calendar-FirstDayOfWeek="Monday" DateInput-DateFormat="yyyy-MM"
                                Calendar-FastNavigationSettings-TodayButtonCaption="当前年月" MonthYearNavigationSettings-TodayButtonCaption="当前年月"
                                Calendar-FastNavigationSettings-OkButtonCaption="确定" MonthYearNavigationSettings-OkButtonCaption="确定"
                                Calendar-FastNavigationSettings-CancelButtonCaption="取消" MonthYearNavigationSettings-CancelButtonCaption="取消" />
