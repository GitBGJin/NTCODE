...
{
    /// <summary>
    /// 名称：AuditAirInfectantByMinuteDAL.cs
    /// 创建人：李飞
    /// 创建日期：2015-08-30
    /// 维护人员：
    /// 最新维护人员：
    ...
    /// 版权所有(C)：江苏远大信息股份有限公司
    /// </summary>
    public class AuditAirInfectantByMinuteDAL
    {
        #region << 变量 >>
        /// <summary>
        /// 数据库处理类
        ...
        /// 数据库表名
        /// </summary>
        private string tableName = "Audit.TB_AuditAirInfectantByMinute";
        #endregion
        ...
        /// 构造函数
        /// </summary>
        public AuditAirInfectantByMinuteDAL()
        {
