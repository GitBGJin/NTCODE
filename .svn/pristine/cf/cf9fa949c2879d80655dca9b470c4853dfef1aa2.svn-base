<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AirQualityAutoMonthReport.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.Report.AirQualityAutoMonthReport" %>
