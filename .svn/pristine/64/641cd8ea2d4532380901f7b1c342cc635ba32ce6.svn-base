...
namespace Model	
{
	public partial class TB_OriRegionDayAQIReport
	{
		private string _cityDayAQIUid;
		public virtual string CityDayAQIUid
		{
			get
			{
				return this._cityDayAQIUid;
			}
			set
			{
				this._cityDayAQIUid = value;
			}
		}
		...
		private string _statisticalType;
