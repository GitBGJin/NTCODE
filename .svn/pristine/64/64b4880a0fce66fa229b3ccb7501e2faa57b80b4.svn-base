...
namespace SmartEP.WebUI.Pages.EnvAir.OperatingMaintenance
{
    ...
    /// 功能摘要：仪器检修详情
    /// 版权所有(C)：江苏远大信息股份有限公司
    public partial class InstrumentOverhaulInfo : SmartEP.WebUI.Common.BasePage
    {
        /// <summary>
        /// 数据处理服务
        /// </summary>
        ...
        public void BindGrid()
        {
            ...
            int pageSize = gridInstrumentOverhaulInfo.PageSize;//每页显示数据个数  
            int pageNo = gridInstrumentOverhaulInfo.CurrentPageIndex;//当前页的序号
            ...
            {
                gridInstrumentOverhaulInfo.DataSource = new DataTable();
            }
            else
            {
                gridInstrumentOverhaulInfo.DataSource = airDataEffectRateData;
            }

            //数据总行数
            gridInstrumentOverhaulInfo.VirtualItemCount = recordTotal;
