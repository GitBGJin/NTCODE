<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OnlineInfo.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.Dock.OnlineInfo" %>
    ...
    <form id="form1" runat="server">
        <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
            <script type="text/javascript">
                function GetData() {
                    ...
                    obj.Molde = document.getElementById("<%=hdMolde.ClientID%>").value;
                    return obj;
                }
            </script>
                    ...
                    */
                    ...
                    $.each(effectData, function (key, obj) {
                        if (obj.OnlineCount == 0 && obj.OfflineCount == 0) {
                            onlineValue.push(0);//给在线的默认值为2 否则会出现无任何效果的饼图
                            offOnlineValue.push(0);
                            totalValue.push(0);
                        }
                        else {
                        ...
                        function (ec) {
                            ...
                            myChart.on('click', function (param) {
                                ...
                                switch (param.dataIndex) {
                                    case 0: OpenFineUIWindow("49502372-21c4-440b-9243-e71571712dba", "Pages/EnvAir/RealTimeData/RealTimeOnlineState.aspx?online=0&pointNames=" + document.getElementById("<%=hdPointNames.ClientID%>").value + "&FactorName=" + document.getElementById("<%=hdFactorName.ClientID%>").value, "实时在线信息"); break;//在线
                                    case 1: OpenFineUIWindow("49502372-21c4-440b-9243-e71571712dba", "Pages/EnvAir/RealTimeData/RealTimeOnlineState.aspx?online=1&pointNames=" + document.getElementById("<%=hdPointNames.ClientID%>").value + "&FactorName=" + document.getElementById("<%=hdFactorName.ClientID%>").value, "实时在线信息"); break;//离线
                                }
                                ...
                                series: [
                                    {
                                        ...
                                        data: [
                                            {
                                                value: onlineValue, name: '在线', itemStyle: {
                                                    normal: { color: '#7DC734' }
                                                }
                                            },
            ...
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="btnSearch">
                    <UpdatedControls>
                        ...
                        <telerik:AjaxUpdatedControl ControlID="hdMolde" LoadingPanelID="RadAjaxLoadingPanel1" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
            </AjaxSettings>
        ...
        <telerik:RadSplitter ID="splitter" runat="server" Orientation="Horizontal" Height="100%" BorderWidth="0"
            ...
            <telerik:RadPane ID="paneWhere" runat="server" Height="35px" Width="100%" Scrolling="None" MaxHeight="100"
                ...
                <table id="Tb" style="width: 100%; height: 100%" cellspacing="1" cellpadding="0" class="Table_Customer"
                    ...
                    <tr>
                        ...
                        <td class="content" style="width: 32%;">
                            <asp:RadioButtonList ID="radlDataType" runat="server" RepeatDirection="Horizontal" class="radio inline netState">
                            </asp:RadioButtonList>
                        </td>
            ...
            <telerik:RadPane ID="paneImage" runat="server" Width="100%" Height="100%" Scrolling="None"
                ...
                <asp:HiddenField ID="hdMolde" runat="server" />
