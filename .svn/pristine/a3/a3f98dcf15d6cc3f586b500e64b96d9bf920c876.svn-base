...
{
	public partial class ValidDataSolutionDetailEntity : IStandardEntityProperty
	{
		private int m_id;
		...
		private string m_validDataSolutionUid;
		public virtual string ValidDataSolutionUid
		{
			get
			{
				return this.m_validDataSolutionUid;
			}
			set
			{
				this.m_validDataSolutionUid = value;
			}
		}
