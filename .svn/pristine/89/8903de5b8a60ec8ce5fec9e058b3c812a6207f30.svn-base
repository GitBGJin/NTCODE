...
namespace SmartEP.Infrastructure.Generic
{
    ...
    [Serializable]
    public class LinkedListExtension<T> : System.Collections.Generic.LinkedList<T>, ICollection<T>
    {

        #region 构造函数
        public LinkedListExtension()
            : base() 
        { }

        public LinkedListExtension(IEnumerable<T> collection)
            : base(collection) 
        { }

        private LinkedListExtension(SerializationInfo info, StreamingContext context)
            : base(info, context) 
        { }
        #endregion
