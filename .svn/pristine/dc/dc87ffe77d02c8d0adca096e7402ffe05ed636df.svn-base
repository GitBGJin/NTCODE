...
namespace SmartEP.AMSRepository.Air
{
    ...
    /// 实时数据仓储类
    /// </summary>
    public class InfectantByRTRepository : BaseGenericRepository<AirAutoMonitoringModel, InfectantByRTEntity>, IInfectantRepository
    {
        ...
        /// 一分钟数据处理DAL类
        /// </summary>
        InfectantDAL m_InfectantDAL = new InfectantDAL(ApplicationType.Air, PollutantDataType.RealTime);
