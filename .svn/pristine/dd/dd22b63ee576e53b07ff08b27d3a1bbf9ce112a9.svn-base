...
{
	public partial class WaterYearReportEntity : IMonitoringBusinessEntityProperty
	{
		private string m_yearReportUid;
		public virtual string YearReportUid
		{
			get
			{
				return this.m_yearReportUid;
			}
			set
			{
				this.m_yearReportUid = value;
			}
		}
