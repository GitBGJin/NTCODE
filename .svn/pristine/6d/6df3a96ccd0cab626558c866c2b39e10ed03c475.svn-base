<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChartFrameAnalysis.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.Chart.ChartFrameAnalysis" %>
        ...
        <script type="text/javascript">
            ...
            function InitChart() {
                try {
                    ...
                    var radlDataType = hiddenData[2];
                    var pageType = hiddenData[3];
                    var currentDate = hiddenData[4];
                    var aRatio = hiddenData[5];
                    var bRatio = hiddenData[6];
