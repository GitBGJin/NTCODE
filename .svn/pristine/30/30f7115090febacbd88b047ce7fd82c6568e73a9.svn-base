<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddInstrumentMove.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.OperatingMaintenance.AddInstrumentMove" %>
            ...
            <telerik:RadPane ID="paneWhere" runat="server" Height="40px" Width="100%" Scrolling="None"
                ...
                <table id="Tb" style="width: 100%; height: 100%" cellspacing="1" cellpadding="0" class="Table_Customer"
                    ...
                    <tr id="yearWhere">
                        ...
                        <td class="title" style="width: 5%; text-align: center;">维护人：</td>
                ...
                <div class="order-form" id="samplingMain">
                    <div class="profile">
                        ...
                        <ul class="profile-form" style="float: left; height: 320px;">
                            <li><span class="v" style="width: 150px;">维护内容：</span> <span class="k">
                                <telerik:RadTextBox ID="rtbWaterName" runat="server"></telerik:RadTextBox>
                            </span></li>

                            <li><span class="v" style="width: 150px;">性能测试结果评价：</span> <span class="k">
                ...
                <telerik:RadGrid ID="gridSamplingRecord" runat="server" GridLines="None" Height="100%" Width="100%"
                    ...
                    <MasterTableView GridLines="None" TableLayout="Fixed" CommandItemDisplay="Top" IsFilterItemExpanded="False"
                        ...
                        <Columns>
                            ...
                            <telerik:GridNumericColumn HeaderText="性能测试结果评价" UniqueName="PointName" DataField="PointName" DecimalDigits="0" MaxLength="14" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" EmptyDataText="--" />
