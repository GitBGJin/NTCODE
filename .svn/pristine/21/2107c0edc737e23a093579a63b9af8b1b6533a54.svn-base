...
namespace SmartEP.AMSRepository.Air
{
    ...
    /// 5分钟实时数据仓储类
    /// </summary>
    public class InfectantBy5Repository : BaseGenericRepository<AirAutoMonitoringModel, InfectantBy5Entity>, IInfectantRepository
    {
        ...
        /// 5分钟数据处理DAL类
        /// </summary>
        InfectantDAL m_InfectantDAL = new InfectantDAL(ApplicationType.Air, PollutantDataType.Min5);
        ...
        public DataView GetAvgDataPager(string[] portIds, string[] factors
            , DateTime dateStart, DateTime dateEnd, int pageSize, int pageNo, out int recordTotal, string orderBy = "PointId,Tstamp")
        {
            return m_InfectantDAL.GetAvgDataPagerMin5(portIds, factors, dateStart, dateEnd, pageSize, pageNo, out recordTotal, orderBy);
        }
        /// <summary>
        /// 取得虚拟分页查询数据和总行数(行转列数据)
        /// </summary>
        ...
        public DataView GetDataPagerWithO3(string[] portIds, string[] factors
            , DateTime dateStart, DateTime dateEnd, int pageSize, int pageNo, out int recordTotal, string orderBy = "PointId,Tstamp")
        {
            return m_InfectantDAL.GetDataPagerWithO3(portIds, factors, dateStart, dateEnd, pageSize, pageNo, out recordTotal, orderBy);
        }
