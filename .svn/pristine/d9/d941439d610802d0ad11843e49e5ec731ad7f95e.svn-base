...
namespace SmartEP.AMSRepository.Water
{
    ...
    /// 10分钟实时数据仓储类
    /// </summary>
    public class InfectantBy30Repository : BaseGenericRepository<WaterAutoMonitoringModel, InfectantBy30Entity>, IInfectantRepository
    {
        ...
        /// 30分钟数据处理DAL类
        /// </summary>
        InfectantDAL m_InfectantDAL = new InfectantDAL(ApplicationType.Water, PollutantDataType.Min30);
