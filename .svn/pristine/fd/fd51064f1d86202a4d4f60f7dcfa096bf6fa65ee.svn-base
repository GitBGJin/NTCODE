<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FactorCbxRsm.ascx.cs" Inherits="SmartEP.WebUI.Controls.FactorCbxRsm" %>
...
<telerik:RadComboBox ID="RadCBoxFactor" runat="server" AutoPostBack="false" SkinID="Default" Skin="Default"
 ...
 OnClientDropDownClosed="OnFactorClientDropDownClosed_Change">
    <HeaderTemplate>
        <table>
            <tr>
                <td>
