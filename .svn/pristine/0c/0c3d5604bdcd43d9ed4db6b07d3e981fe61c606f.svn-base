...
{
    /// <summary>
    /// 名称：OM_DeviceRepairRepository.cs
    /// 创建人：王秉晟
    /// 创建日期：2016-03-09
    /// 维护人员：
    /// 最新维护人员：
    ...
    /// 版权所有(C)：江苏远大信息股份有限公司
    /// </summary>
    public class OM_DeviceRepairRepository : BaseGenericRepository<MonitoringBusinessModel, OM_DeviceRepairEntity>
    {
        /// <summary>
        /// 根据key主键判断记录是否存在
        /// </summary>
        ...
        /// 任务配置DAL
        /// </summary>
        OM_DeviceRepairDAL d_OM_TaskItemConfigDAL = Singleton<OM_DeviceRepairDAL>.GetInstance();
