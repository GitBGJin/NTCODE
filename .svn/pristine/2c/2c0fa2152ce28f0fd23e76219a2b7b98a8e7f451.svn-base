...
namespace SmartEP.Infrastructure.Generic
{
    ...
    [Serializable]
    public class QueueExtension<T> : System.Collections.Generic.Queue<T>, ICollection<T>
    {
		...
		public QueueExtension(IEnumerable<T> collection) : base(collection) 
        { }

        public QueueExtension(int capacity)
            : base(capacity) 
        { }
        #endregion
