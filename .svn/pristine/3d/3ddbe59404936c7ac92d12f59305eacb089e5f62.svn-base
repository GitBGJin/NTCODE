...
namespace SmartEP.AMSRepository.Water
{
    ...
    /// 5分钟实时数据仓储类
    /// </summary>
    public class InfectantBy5Repository : BaseGenericRepository<WaterAutoMonitoringModel, InfectantBy5Entity>, IInfectantRepository
    {
        ...
        /// 5分钟数据处理DAL类
        /// </summary>
        InfectantDAL m_InfectantDAL = new InfectantDAL(ApplicationType.Water, PollutantDataType.Min5);
