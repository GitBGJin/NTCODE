<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InstrumentRepairInfo.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.OperatingMaintenance.InstrumentRepairInfo" %>
    ...
    <form id="form1" runat="server">
        <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
            <script type="text/javascript" language="javascript">
                ...
                function Refresh_Grid(args) {
                    if (args) {
                        var MasterTable = $find("<%= gridInstrumentRepairInfo.ClientID %>").get_masterTableView();
                        MasterTable.rebind();
                    }
                }
        ...
        <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" UpdatePanelsRenderMode="Inline">
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="gridInstrumentRepairInfo">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="gridInstrumentRepairInfo" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
            ...
            <telerik:RadPane ID="paneWhere" runat="server" Height="50px" Width="100%" Scrolling="None"
                ...
                <table id="Tb" style="width: 100%; height: 100%" cellspacing="1" cellpadding="0" class="Table_Customer"
                    ...
                    <tr>
                        ...
                        <td class="title" style="width: 8%; text-align: right;">维护人员：
                        </td>
                        <td class="content" style="width: 5%;">

                            <asp:Label ID="lblRepairPersonnel" runat="server" Text="张龙"></asp:Label>
                        </td>
                        <td class="title" style="width: 8%; text-align: right;">出厂编号：</td>
                        <td class="content" style="width: 5%;">

                            <asp:Label ID="lblSerialNumber" runat="server" Text="2015.01.01"></asp:Label>

                        </td>
                        <td class="title" style="width: 8%; text-align: right;">本站编号：</td>

                        <td>
                            <asp:Label ID="lblStationNumber" runat="server" Text="仪器零件磨损"></asp:Label>
                        </td>
            ...
            <telerik:RadPane ID="paneGrid" runat="server" Width="100%" Height="100%" Scrolling="None"
                ...
                <telerik:RadMultiPage ID="multiPage" runat="server" Width="100%" Height="100%" ScrollBars="Hidden" SelectedIndex="0">
                    <telerik:RadPageView ID="pvGrid" runat="server" Visible="true">
                        <telerik:RadGrid ID="gridInstrumentRepairInfo" runat="server" GridLines="None" Height="100%" Width="100%"
                            ...
                            <MasterTableView GridLines="None" TableLayout="Fixed" CommandItemDisplay="Top" IsFilterItemExpanded="False"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridNumericColumn HeaderText="日期" UniqueName="PointName" DataField="PointName" DecimalDigits="0" MaxLength="14" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" EmptyDataText="--" />

                                    <telerik:GridNumericColumn HeaderText="故障现象描述" UniqueName="PointName" DataField="PointName" DecimalDigits="0" MaxLength="14" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" EmptyDataText="--" />
                                    <telerik:GridNumericColumn HeaderText="解决方案" UniqueName="PointName" DataField="PointName" DecimalDigits="0" MaxLength="14" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" EmptyDataText="--" />
                                    <telerik:GridNumericColumn HeaderText="性能评价" UniqueName="PointName" DataField="PointName" DecimalDigits="0" MaxLength="14" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" EmptyDataText="--" />
