...
namespace SmartEP.AMSRepository.Water
{
    ...
    /// 一分钟实时数据仓储类
    /// </summary>
    public class InfectantByRTRepository : BaseGenericRepository<WaterAutoMonitoringModel, InfectantByRTEntity>, IInfectantRepository
    {
        ...
        /// 一分钟数据处理DAL类
        /// </summary>
        InfectantDAL m_InfectantDAL = new InfectantDAL(ApplicationType.Water, PollutantDataType.RealTime);
