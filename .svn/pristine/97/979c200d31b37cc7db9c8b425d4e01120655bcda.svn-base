<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InstrumentSendAdd.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.Instrument.InstrumentSendAdd" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table id="maintable" class="Table_Customer" width="100%">
            ...
            <tr>
                <td class="title" style="width: 120px; text-align: center;">送修站点:
                </td>
                ...
                <td class="content" style="width: 200px;">
                    <telerik:RadComboBox runat="server" ID="InstrumentName" Width="250px">
                    </telerik:RadComboBox>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox runat="server" ID="OperateResult" Width="180px"></asp:TextBox>
                </td>
            </tr>
            <tr>
