<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FactorRsmAudit.ascx.cs" Inherits="SmartEP.WebUI.Controls.FactorRsmAudit" %>
...
<telerik:RadSiteMap runat="server" ID="RSM" Width="97%">
    <LevelSettings>
        <telerik:SiteMapLevelSetting Level="0" Layout="List" ListLayout-AlignRows="true">
            <NodeTemplate>
                <br />
                <asp:CheckBox runat="server" ID="RsmChkA" Checked="false" Font-Bold="true" onclick="SelectParentNode(this,'multi');" OnCheckedChanged="RsmChkB_CheckedChanged" AutoPostBack="true"
        ...
        <telerik:SiteMapLevelSetting Level="1" Layout="Flow">
            <NodeTemplate>
                <div class="ContentHolder">
                    <asp:CheckBox runat="server" ID="RsmChkB" Checked="false" onclick="SelectChildNode(this,'multi');" OnCheckedChanged="RsmChkB_CheckedChanged" AutoPostBack="true"
                        Text='<%# DataBinder.Eval(Container.DataItem, "PName")%>'
                        ToolTip='<%# DataBinder.Eval(Container.DataItem, "PID")%>' />
                </div>
            </NodeTemplate>
