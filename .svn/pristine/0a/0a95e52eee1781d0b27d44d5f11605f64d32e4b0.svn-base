...
{
	public partial class OutlierSettingEntity : IBusinessRuleEntityProperty
	{
		private int m_id;
		...
		private string m_outlierUid;
		public virtual string OutlierUid
		{
			get
			{
				return this.m_outlierUid;
			}
			set
			{
				this.m_outlierUid = value;
			}
		}
		...
		private string m_comparePoints;
		public virtual string ComparePoints
		{
			get
			{
				return this.m_comparePoints;
			}
			set
			{
				this.m_comparePoints = value;
			}
		}
		
		private string m_outlierRange;
		public virtual string OutlierRange
		{
			get
			{
				return this.m_outlierRange;
			}
			set
			{
				this.m_outlierRange = value;
			}
		}
		...
		private decimal? m_referenceValue;
		public virtual decimal? ReferenceValue
		{
			...
			set
			{
				this.m_referenceValue = value;
			}
		}
		
		private decimal? m_outlierRate;
