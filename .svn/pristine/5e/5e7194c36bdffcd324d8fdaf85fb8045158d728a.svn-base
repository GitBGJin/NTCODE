<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YearMaintenance.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.OperatingMaintenance.YearMaintenance" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadGrid ID="gridYear" runat="server" GridLines="None" Height="100%" Width="100%"
            ...
            OnNeedDataSource="gridYear_NeedDataSource" OnItemDataBound="gridYear_ItemDataBound"
            ...
            <MasterTableView GridLines="None" TableLayout="Fixed" CommandItemDisplay="None" IsFilterItemExpanded="False"
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn HeaderText="年度维护保养" DataField="TestItems" UniqueName="TestItems" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></telerik:GridBoundColumn>
                    <telerik:GridTemplateColumn HeaderText="实施日期" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <telerik:RadDateTimePicker runat="server" MinDate="1900-01-01" BorderWidth="1px" DateInput-DateFormat="yyyy-MM-dd HH:00"
                                DatePopupButton-ToolTip="打开日历选择" TimePopupButton-ToolTip="打开小时选择" Calendar-FirstDayOfWeek="Monday"
                                Calendar-FastNavigationSettings-TodayButtonCaption="当前年月" Width="220" ID="dtpYear"
                                Calendar-FastNavigationSettings-OkButtonCaption="确定"
                                Calendar-FastNavigationSettings-CancelButtonCaption="取消"
                                TimeView-HeaderText="小时" />
                        </ItemTemplate>
