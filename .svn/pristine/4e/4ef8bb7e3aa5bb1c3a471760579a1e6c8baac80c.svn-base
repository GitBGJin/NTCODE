...
/*数据比对*/
function groupChartByPointidCom(pointids, names, url, iframeHeight) {
    $("#ChartContainer").html("");
    var chartdiv = "";
    ...
    $.each(pointids.split(';'), function (chartNo, value) {
                ...
                chartdiv += '<iframe name="chartIframe" id="frame' + value + '" src="' + url + '?PointID=' + value + '" frameborder="0" marginheight="0" marginwidth="0" width="100%" height="100%" scrolling="no"></iframe>';
                chartdiv += '</div>';
