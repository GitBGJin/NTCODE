<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InstrumentMoveInfo.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.OperatingMaintenance.InstrumentMoveInfo" %>
    ...
    <form id="form1" runat="server">
        <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
            <script type="text/javascript" language="javascript">
                ...
                function Refresh_Grid(args) {
                    if (args) {
                        var MasterTable = $find("<%= gridInstrumentMoveInfo.ClientID %>").get_masterTableView();
                        MasterTable.rebind();
                    }
                }
        ...
        <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" UpdatePanelsRenderMode="Inline">
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="gridInstrumentMoveInfo">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="gridInstrumentMoveInfo" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
            ...
            <telerik:RadPane ID="paneGrid" runat="server" Width="100%" Height="100%" Scrolling="None"
                ...
                <telerik:RadMultiPage ID="multiPage" runat="server" Width="100%" Height="100%" ScrollBars="Hidden" SelectedIndex="0">
                    <telerik:RadPageView ID="pvGrid" runat="server" Visible="true">
                        <telerik:RadGrid ID="gridInstrumentMoveInfo" runat="server" GridLines="None" Height="100%" Width="100%"
                            ...
                            <MasterTableView GridLines="None" TableLayout="Fixed" CommandItemDisplay="Top" IsFilterItemExpanded="False"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridNumericColumn HeaderText="维护内容" UniqueName="PointName" DataField="PointName" DecimalDigits="0" MaxLength="14" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" EmptyDataText="--" />
                                    <telerik:GridNumericColumn HeaderText="维护后性能测试结果评价" UniqueName="PointName" DataField="PointName" DecimalDigits="0" MaxLength="14" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" EmptyDataText="--" />
                                    <telerik:GridNumericColumn HeaderText="维护人" UniqueName="PointName" DataField="PointName" DecimalDigits="0" MaxLength="14" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" EmptyDataText="--" />
