...
namespace Model	
{
	public partial class TB_LostSetting
	{
		private int _id;
		...
		private string _lostSettingUid;
		public virtual string LostSettingUid
		{
			get
			{
				return this._lostSettingUid;
			}
			set
			{
				this._lostSettingUid = value;
			}
		}
		...
		public virtual int? LostNum
		{
			get
			{
				return this._lostNum;
			}
			set
			{
				this._lostNum = value;
