...
namespace Model	
{
	public partial class TB_InfectantByMonth
	{
		private string _infectantByMonUid;
		public virtual string InfectantByMonUid
		{
			get
			{
				return this._infectantByMonUid;
			}
			set
			{
				this._infectantByMonUid = value;
			}
		}
