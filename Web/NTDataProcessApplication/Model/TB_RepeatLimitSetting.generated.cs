...
namespace Model	
{
	public partial class TB_RepeatLimitSetting
	{
		private int _id;
		...
		private string _repeatLimitUid;
		public virtual string RepeatLimitUid
		{
			get
			{
				return this._repeatLimitUid;
			}
			set
			{
				this._repeatLimitUid = value;
			}
		}
		...
		private string _repeatableValueRang;
		public virtual string RepeatableValueRang
		{
			get
			{
				return this._repeatableValueRang;
			}
			set
			{
				this._repeatableValueRang = value;
			}
		}
		
		private int? _repeatableNumber;
		public virtual int? RepeatableNumber
		{
			get
			{
				return this._repeatableNumber;
			}
			set
			{
				this._repeatableNumber = value;
			}
		}
