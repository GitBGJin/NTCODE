...
namespace SmartEP.Service.AutoMonitoring.Air
{
    ...
    /// 版权所有(C)：江苏远大信息股份有限公司
    /// </summary>
    public class MonitoringDataAir : IMonitoringData, IInfectantDALService
    {
        /// <summary>
        /// 实时监控数据公用接口（ORM）
        /// </summary>
        ...
        public MonitoringDataAir(PollutantDataType pollutantDataType)
        {
        ...
        public static IInfectantDALService GetInfectantDALService(PollutantDataType pollutantDataType)
        {
            ...
            {
                case PollutantDataType.Min1:
                    iService = SmartEP.Core.Generic.Singleton<InfectantBy1Service>.GetInstance();
                    break;
                case PollutantDataType.Min5:
                    iService = SmartEP.Core.Generic.Singleton<InfectantBy5Service>.GetInstance();
                    break;
                case PollutantDataType.Min60:
                    iService = SmartEP.Core.Generic.Singleton<InfectantBy60Service>.GetInstance();
                    break;
                case PollutantDataType.RealTime:
                    iService = SmartEP.Core.Generic.Singleton<InfectantByRTService>.GetInstance();
                    break;
                default:
                    iService = SmartEP.Core.Generic.Singleton<InfectantBy60Service>.GetInstance();
                    break;
