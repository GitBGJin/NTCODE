...
namespace SmartEP.Service.DataAnalyze.Water.DataQuery
{
    ...
    /// 版权所有(C)：江苏远大信息股份有限公司
    /// </summary>
    public class DayReportManualService
    {
        /// <summary>
        /// 人工点日数据
        /// </summary>
        DayReportManualRepository g_DayReportManualRepository = Singleton<DayReportManualRepository>.GetInstance();
        ...
        /// <returns></returns>
        public IQueryable<DayReportManualEntity> Retrieve(Expression<Func<DayReportManualEntity, bool>> predicate)
        {
            return g_DayReportManualRepository.Retrieve(predicate);
        }
        ...
        public void BatchAdd(List<DayReportManualEntity> DataList)
        {
            g_DayReportManualRepository.BatchAdd(DataList);
        }
        ...
        /// </summary>
        /// <param name="DataList">实体数组</param>
        public void BatchDelete(List<DayReportManualEntity> DataList)
        {
            g_DayReportManualRepository.BatchDelete(DataList);
        }
        ...
        {
            return g_DayReportManualRepository.GenerateData(CalEQITypeUid, IEQI, PointUids, PollutantCodes, dateStart, dateEnd, out errMsg);
        }
        ...
        {
            return g_DayReportManualRepository.GetWaterIEQI(PointUids, PollutantCodes, StartDate, EndDate);
        }
    }
}
