...
namespace SmartEP.Service.Core.Cached
{
    ...
    public class MemcachedClient
    {
        ...
        private static ResourceManager _resourceManager = new ResourceManager("SmartEP.Service.Core.Cached.MemCached.StringMessages", typeof(MemcachedClient).Assembly);
        ...
        public Hashtable Stats(ArrayList servers, string command)
        {
            ...
            for(int i = 0; i < servers.Count; i++)
            {
                ...
                // build command
                command = command.IsNullOrEmpty() ? "stats\r\n" : command + "\r\n";
