...
namespace SmartEP.DomainModel.Framework
{
    ...
    /// 版权所有(C)：江苏远大信息股份有限公司
    [Serializable]
    public partial class InstrumentInstanceRecord3Entity
    {
        public InstrumentInstanceRecord3Entity()
        { }
        #region Model
        ...
        private string _instrumentinstanceguid;
        private int? _id;
        ...
        {
            set { _instrumentinstanceguid = value; }
            get { return _instrumentinstanceguid; }
        }
        /// <summary>
        /// 
        /// </summary>
