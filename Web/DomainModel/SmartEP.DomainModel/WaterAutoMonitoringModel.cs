...
{
    public partial class WaterAutoMonitoringModel : OpenAccessContext, IWaterAutoMonitoringModelUnitOfWork, ICustomOrmContext
	{
		private static string connectionStringName = @"AMS_WaterAutoMonitorConnection";
			
		private static BackendConfiguration backend = GetBackendConfiguration();
				
		private static MetadataSource metadataSource = XmlMetadataSource.FromAssemblyResource("WaterAutoMonitoringModel.rlinq");
		
		public WaterAutoMonitoringModel()
			:base(connectionStringName, backend, metadataSource)
		{ }
		
		public WaterAutoMonitoringModel(string connection)
			:base(connection, backend, metadataSource)
		{ }
		
		public WaterAutoMonitoringModel(BackendConfiguration backendConfiguration)
			:base(connectionStringName, backendConfiguration, metadataSource)
		{ }
			
		public WaterAutoMonitoringModel(string connection, MetadataSource metadataSource)
			:base(connection, backend, metadataSource)
		{ }
		
		public WaterAutoMonitoringModel(string connection, BackendConfiguration backendConfiguration, MetadataSource metadataSource)
		...
		/// <summary>
		/// Allows you to customize the BackendConfiguration of WaterAutoMonitoringModel.
		/// </summary>
		/// <param name="config">The BackendConfiguration of WaterAutoMonitoringModel.</param>
		static partial void CustomizeBackendConfiguration(ref BackendConfiguration config);
		
	}
	
	public interface IWaterAutoMonitoringModelUnitOfWork : IUnitOfWork
	{
