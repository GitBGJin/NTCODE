...
{
	public partial class ExcessiveSettingEntity : IBusinessRuleEntityProperty
	{
		private int m_id;
		...
		private string m_excessiveUid;
		public virtual string ExcessiveUid
		{
			get
			{
				return this.m_excessiveUid;
			}
			set
			{
				this.m_excessiveUid = value;
			}
		}
