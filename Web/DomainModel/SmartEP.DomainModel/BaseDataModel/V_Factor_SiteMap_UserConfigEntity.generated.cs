...
{
	public partial class V_Factor_SiteMap_UserConfigEntity : IMPInfoEntityProperty
	{
		...
		private string m_measureUnitName;
		public virtual string MeasureUnitName
		{
			get
			{
				return this.m_measureUnitName;
			}
			set
			{
				this.m_measureUnitName = value;
			}
		}
