...
{
	public partial class MonthReportEntity : IWaterMonitoringBusinessEntityProperty
	{
		private string m_monthReportUid;
		public virtual string MonthReportUid
		{
			get
			{
				return this.m_monthReportUid;
			}
			set
			{
				this.m_monthReportUid = value;
			}
		}
