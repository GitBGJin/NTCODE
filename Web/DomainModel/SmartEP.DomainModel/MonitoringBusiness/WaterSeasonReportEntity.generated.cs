...
{
	public partial class WaterSeasonReportEntity : IMonitoringBusinessEntityProperty
	{
		private string m_seasonReportUid;
		public virtual string SeasonReportUid
		{
			get
			{
				return this.m_seasonReportUid;
			}
			set
			{
				this.m_seasonReportUid = value;
			}
		}
		...
		private int? m_seasonOfYear;
		public virtual int? SeasonOfYear
		{
			get
			{
				return this.m_seasonOfYear;
			}
			set
			{
				this.m_seasonOfYear = value;
			}
		}
		
		private Guid? m_reportTypeUid;
		public virtual Guid? ReportTypeUid
		{
			get
			{
