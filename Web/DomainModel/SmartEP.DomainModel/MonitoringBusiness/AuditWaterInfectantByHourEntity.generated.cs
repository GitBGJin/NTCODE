...
{
	public partial class AuditWaterInfectantByHourEntity : IMonitoringBusinessEntityProperty
	{
		private string m_auditHourUid;
		public virtual string AuditHourUid
		{
			get
			{
				return this.m_auditHourUid;
			}
			set
			{
				this.m_auditHourUid = value;
			}
		}
