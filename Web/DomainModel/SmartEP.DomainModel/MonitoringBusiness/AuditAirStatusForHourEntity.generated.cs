...
{
	public partial class AuditAirStatusForHourEntity : IMonitoringBusinessEntityProperty
	{
		...
		private string m_pointIdType;
		public virtual string PointIdType
		{
			get
			{
				return this.m_pointIdType;
			}
			set
			{
				this.m_pointIdType = value;
			}
		}
