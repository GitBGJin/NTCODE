...
{
	public partial class ReportSamplingRateByDayEntity : IMonitoringBusinessEntityProperty
	{
		private string m_daySamplingRateUid;
		public virtual string DaySamplingRateUid
		{
			get
			{
				return this.m_daySamplingRateUid;
			}
			set
			{
				this.m_daySamplingRateUid = value;
			}
		}
