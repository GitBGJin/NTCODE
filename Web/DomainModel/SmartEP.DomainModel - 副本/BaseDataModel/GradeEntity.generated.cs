...
{
	public partial class GradeEntity : IAlarmNotifyEntityProperty
	{
		...
		private string m_gradeTypeUid;
		public virtual string GradeTypeUid
		{
			get
			{
				return this.m_gradeTypeUid;
			}
			set
			{
				this.m_gradeTypeUid = value;
			}
		}
		
		private string m_gradeColor;
		public virtual string GradeColor
		{
			get
			{
				return this.m_gradeColor;
			}
			set
			{
				this.m_gradeColor = value;
			}
		}
