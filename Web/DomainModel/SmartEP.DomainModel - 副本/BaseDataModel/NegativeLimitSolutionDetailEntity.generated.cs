...
{
	public partial class NegativeLimitSolutionDetailEntity : IStandardEntityProperty
	{
		private string m_negativeLimitSolutionUid;
		public virtual string NegativeLimitSolutionUid
		{
			get
			{
				return this.m_negativeLimitSolutionUid;
			}
			set
			{
				this.m_negativeLimitSolutionUid = value;
			}
		}
