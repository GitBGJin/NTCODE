...
{
	public partial class OutlierSolutionDetailEntity : IStandardEntityProperty
	{
		...
		private string m_outlierRang;
		public virtual string OutlierRang
		{
			get
			{
				return this.m_outlierRang;
			}
			set
			{
				this.m_outlierRang = value;
			}
		}
