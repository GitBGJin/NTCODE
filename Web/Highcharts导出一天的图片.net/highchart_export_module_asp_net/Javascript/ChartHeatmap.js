function ajaxHighChart(title, subtitle, strJSON, id, xName, yName, zName,hdMin, hdMax) {
    ...
    //    stopC = eval('(' + stopC + ')');
    //    expt = "{type: \"image/svg+xml\",url: \"/NTJGLDXG/highcharts_export.aspx\",}";
    //    expt = eval('(' + expt + ')');
    //}
    //if (subtitle == "消光系数355") {
    ...
    //    stopC = eval('(' + stopC + ')');
    //    expt = "{type: \"image/svg+xml\",url: \"/NTJGLDXG/highcharts_exporte.aspx\",}";
    //    expt = eval('(' + expt + ')');
    //}
    //if (subtitle == "退偏图") {
    ...
    //    stopC = eval('(' + stopC + ')');
    //    expt = "{type: \"image/svg+xml\",url: \"/NTJGLDXG/highcharts_exportd.aspx\",}";
    //    expt = eval('(' + expt + ')');
    //}
