...
namespace SmartEP.Infrastructure.Generic
{
    ...
    [Serializable]
    public class ListExtension<T> : System.Collections.Generic.List<T>, ICollection<T> //:Collection<T>  // where T : new()
    {
		...
		public ListExtension(IEnumerable<T> collection) : base(collection) 
        { }

        public ListExtension(int capacity)
            : base(capacity) 
        { }
        #endregion
