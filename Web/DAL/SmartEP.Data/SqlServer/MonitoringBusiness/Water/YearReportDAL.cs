...
namespace SmartEP.Data.SqlServer.MonitoringBusiness.Water
{
    ...
    public class YearReportDAL
    {
        ...
        /// 数据库表名
        /// </summary>
        private string tableName = "WaterReport.TB_YearReport";
        #endregion
        ...
        {
            tableName = SmartEP.Data.Enums.EnumMapping.GetAutoMonitorTableName(ApplicationType.Water, PollutantDataType.Year);
            connection = SmartEP.Data.Enums.EnumMapping.GetConnectionName(ApplicationType.Water, PollutantDataType.Year);
        }
        #endregion
            ...
            , int yearFrom, int yearTo, int pageSize, int pageNo, out int recordTotal, string orderBy = "PointId,Year")
        {
            ...
            string fieldName = "PointId,Year" + factorSql + factorDataFlagSql + factorAuditFlagSql + factorEQISql + factorGradeSql + wqSql;
        ...
        public DataView GetExportData(string[] portIds, string[] factors
            , int yearFrom, int yearTo, string orderBy = "PointId,Year")
        {
            tableName = "dbo.V_Water_YearReport";
            orderBy = !string.IsNullOrEmpty(orderBy) ? orderBy : "PointId,Year";
            int recordTotal = 0;
            int pageSize = 99999999;
            int pageNo = 0;
            ...
            string pointSql = string.Empty;
            orderBy = string.IsNullOrEmpty(orderBy) ? "PointId,Year" : orderBy;
            string fieldName = "rowNum as '序号',PointId,portName,Year as '年' " + factorSql + factorFlagSql;
            string groupBy = "PointId,portName,Year";
            string where = string.Format(" Year>='{0}' AND Year<='{1}' ", yearFrom, yearTo) + portIdsStr;
            return g_GridViewPager.GetPivotDataPager(tableName, fieldName, groupBy, orderBy, where, pageSize, pageNo, connection, out recordTotal);
        }
        /// <summary>
