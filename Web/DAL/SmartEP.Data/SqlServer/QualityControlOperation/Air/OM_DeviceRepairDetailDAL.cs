...
{
    /// <summary>
    /// 名称：OM_DeviceRepairDetailDAL.cs
    /// 创建人：王秉晟
    /// 创建日期：2016-03-09
    /// 维护人员：
    /// 最新维护人员：
    ...
    /// 版权所有(C)：江苏远大信息股份有限公司
    /// </summary>
    public class OM_DeviceRepairDetailDAL
    {
        #region << 变量 >>
        /// <summary>
        /// 数据库处理类
        ...
        /// 数据库表名
        /// </summary>
        private string tableName = "dbo.TB_OM_DeviceRepairDetail";
        ...
        /// 构造函数
        /// </summary>
        public OM_DeviceRepairDetailDAL()
        {
