...
namespace SmartEP.MonitoringBusinessRepository.Air
{
    ...
    /// 空气季数据仓储类
    /// </summary>
    public class SeasonReportRepository : BaseGenericRepository<MonitoringBusinessModel, AirSeasonReportEntity>
    {
        ...
        {
          return m_SeasonReportDAC.GetSeasonDataPagerRegion(portIds, factors, yearFrom, seasonOfYearFrom, yearTo, seasonOfYearTo, pageSize, pageNo, out recordTotal, orderBy);
        }
        /// <summary>
        /// 取得虚拟分页查询数据和总行数(行转列数据)
        /// </summary>
        ...
        public DataView GetDataPagerAvg(string[] portIds, string[] factors
            , int yearFrom, int seasonOfYearFrom, int yearTo, int seasonOfYearTo, int pageSize, int pageNo, out int recordTotal, string orderBy = "PointId,Year,SeasonOfYear")
        {
            return m_SeasonReportDAC.GetDataPagerAvg(portIds, factors, yearFrom, seasonOfYearFrom, yearTo, seasonOfYearTo, pageSize, pageNo, out recordTotal, orderBy);
        }
        /// <summary>
        /// 取得虚拟分页查询数据和总行数(行转列数据)
        /// </summary>
        ...
        public DataView GetSeasonDataAvg(string[] portIds, string[] factors
            , int yearFrom, int seasonOfYearFrom, int yearTo, int seasonOfYearTo, int pageSize, int pageNo, out int recordTotal, string orderBy = "PointId,Year,SeasonOfYear")
        {
            return m_SeasonReportDAC.GetSeasonDataAvg(portIds, factors, yearFrom, seasonOfYearFrom, yearTo, seasonOfYearTo, pageSize, pageNo, out recordTotal, orderBy);
        }
        /// <summary>
        /// 取得虚拟分页查询数据和总行数(行转列数据)
        /// </summary>
        ...
        {
            return m_SeasonReportDAC.GetDataPagerDF(portIds, factors, yearFrom, seasonOfYearFrom, yearTo, seasonOfYearTo,  pageSize, pageNo,  orderBy);
        }
        /// <summary>
        /// 取得虚拟分页查询数据和总行数(行转列数据)
        /// </summary>
