...
namespace SmartEP.MonitoringBusinessRepository.QualityControlOperation.Water
{
    ...
    /// 版权所有(C)：江苏远大信息股份有限公司
    /// </summary>
    public class ActionConfigRepository
    {
        ActionConfigDAL d_ActionConfigDAL = Singleton<ActionConfigDAL>.GetInstance();
        ...
        public int Add(ActionConfigEntity model)
        {
            if (model != null)
            {
                return d_ActionConfigDAL.Add(model);
            }
            return 0;
        }
        ...
        public bool Update(ActionConfigEntity model)
        {
            if (model != null)
            {
                return d_ActionConfigDAL.Update(model);
            }
            return false;
        }
        ...
        {
            return d_ActionConfigDAL.Delete(id);
        }
        ...
        {
            return d_ActionConfigDAL.GetList(strWhere);
        }
    }
}
