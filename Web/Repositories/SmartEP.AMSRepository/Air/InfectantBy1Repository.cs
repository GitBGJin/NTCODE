...
namespace SmartEP.AMSRepository.Air
{
    ...
    /// 一分钟实时数据仓储类
    /// </summary>
    public class InfectantBy1Repository : BaseGenericRepository<AirAutoMonitoringModel, InfectantBy1Entity>, IInfectantRepository
    {
        ...
        /// 一分钟数据处理DAL类
        /// </summary>
        InfectantDAL m_InfectantDAL = new InfectantDAL(ApplicationType.Air, PollutantDataType.Min1);
        ...
        public DataView GetAvgDataPager(string[] portIds, string[] factors
            , DateTime dateStart, DateTime dateEnd, int pageSize, int pageNo, out int recordTotal, string orderBy = "PointId,Tstamp")
        {
            return m_InfectantDAL.GetAvgDataPagerMin1(portIds, factors, dateStart, dateEnd, pageSize, pageNo, out recordTotal, orderBy);
        }
        /// <summary>
        /// 激光雷达图表数据查询
        /// </summary>
        ...
        {
            return m_InfectantDAL.GetLadarData(Quality, pageSize, pageNo, out recordTotal, DtStart, DtEnd, stch, stchMin);
        }
        /// <summary>
        /// 激光雷达列表数据查询
        /// </summary>
        ...
        {
            return m_InfectantDAL.GetLadarDataNew(Quality, pageSize, pageNo, out recordTotal, DtStart, DtEnd);
        }
        /// <summary>
        /// 激光雷达边界层高度数据查询
        /// </summary>
        ...
        {
            return m_InfectantDAL.GetLadarBorder(Quality, pageSize, pageNo, out recordTotal, DtStart, DtEnd);
        }
        /// <summary>
        /// 取得虚拟分页查询数据和总行数(行转列数据)
        /// </summary>
