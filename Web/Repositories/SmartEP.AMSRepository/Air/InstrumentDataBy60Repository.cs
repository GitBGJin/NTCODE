...
namespace SmartEP.AMSRepository.Air
{
    ...
    /// 版权所有(C)：江苏远大信息股份有限公司
    /// </summary>
    public class InstrumentDataBy60Repository : BaseGenericRepository<AirAutoMonitoringModel, InstrumentDataBy60Entity>
    {
        /// <summary>
        /// 仪器状态DAL
        /// </summary>
        InstrumentDataDAL g_InstrumentDataDAL = new InstrumentDataDAL(ApplicationType.Air);
