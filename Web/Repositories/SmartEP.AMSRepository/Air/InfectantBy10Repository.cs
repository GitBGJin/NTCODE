...
namespace SmartEP.AMSRepository.Air
{
    ...
    /// 10分钟实时数据仓储类
    /// </summary>
    public class InfectantBy10Repository : BaseGenericRepository<AirAutoMonitoringModel, InfectantBy10Entity>, IInfectantRepository
    {
         /// <summary>
        ///
        /// </summary>
        ...
        /// 10分钟数据处理DAL类
        /// </summary>
        InfectantDAL m_InfectantDAL = new InfectantDAL(ApplicationType.Air, PollutantDataType.Min10);
