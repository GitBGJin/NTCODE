...
namespace SmartEP.AMSRepository.Water
{
    ...
    /// 10分钟实时数据仓储类
    /// </summary>
    public class InfectantBy10Repository : BaseGenericRepository<WaterAutoMonitoringModel, InfectantBy10Entity>, IInfectantRepository
    {
        ...
        /// 10分钟数据处理DAL类
        /// </summary>
        InfectantDAL m_InfectantDAL = new InfectantDAL(ApplicationType.Water, PollutantDataType.Min10);
