    ...
    public class BasePage : System.Web.UI.Page
    {
        ...
        public void SaveLog(string userGuid)
        {
           ...
           dt= getInfo(userGuid);
            ...
            string sql = @"insert into TB_Frame_LoginLog (RowGuid,UserGuid,DisplayName,LoginID,LoginTime,LoginIP,LoginNote,RowStatus)  values(newid(),'" + userGuid + "','" + displayName + "','" + loginID + "','" + loginTime + "','" + GetIpAddress() + "','" + loginNote + "','" + rowStatus + "')";
