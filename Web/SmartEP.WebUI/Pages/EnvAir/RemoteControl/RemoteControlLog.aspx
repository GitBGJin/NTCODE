<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RemoteControlLog.aspx.cs"
    Inherits="SmartEP.WebUI.Pages.EnvAir.RemoteControl.RemoteControlLog" %>
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" GridLines="None" AllowPaging="True"
                ...
                <MasterTableView GridLines="None" PageSize="15" CommandItemDisplay="Top" IsFilterItemExpanded="False"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="reqState" HeaderText="请求状态" UniqueName="reqState">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Description" HeaderText="命令反馈" UniqueName="Description">
                        </telerik:GridBoundColumn>
...
<%--                        <telerik:GridBoundColumn DataField="feedback" HeaderText="命令反馈" UniqueName="feedback">
                    ...
                    <PagerStyle FirstPageToolTip="首页" NextPageToolTip="下页" LastPageToolTip="尾页" PrevPageToolTip="上页"
                        PageSizeLabelText="显示记录数:" PagerTextFormat="跳转页面:{4}&amp;nbsp;[第 &lt;strong&gt;{0}&lt;/strong&gt; 页共 &lt;strong&gt;{1}&lt;/strong&gt;页]&amp;nbsp;&amp;nbsp;[第 &lt;strong&gt;{2}&lt;/strong&gt; 到 &lt;strong&gt;{3}&lt;/strong&gt;,共 &lt;strong&gt;{5}&lt;/strong&gt;条信息]">
                    </PagerStyle>
                    <CommandItemTemplate>
