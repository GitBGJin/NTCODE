<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RealTimeOnlineState.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.RealTimeData.RealTimeOnlineState" %>
            ...
            <telerik:RadPane ID="paneWhere" runat="server" Height="60px" Width="100%" Scrolling="None"
                ...
                <table id="Tb" style="width: 100%; height: 100%" cellspacing="1" cellpadding="0" class="Table_Customer"
                    ...
                    <tr>
                        ...
                        <td style="width: 4%; text-align: center;">站点:</td>
                        ...
                        <td class="title" style="width: 6%; text-align: center;">监测因子:
                        </td>
                        ...
                        <td style="width: 10%; text-align: left;">
                            ...
                            <telerik:RadDropDownList ID="weekTo" runat="server" Width="100px">
                                <Items>
                    ...
                    <tr>
                        ...
                        <td colspan="4" id="ti"><%--超标：30 &nbsp;&nbsp;异常：30 &nbsp;&nbsp;--%>&nbsp;&nbsp;

                            <%--<span class="margin20-l">--%>
                            <%--<label class="radio inline netState">
                                    <input type="radio" id="DataType" name="DataType" checked="checked" value="2" onclick="ChangeDataType()" />5分钟数据
                                </label>
                                <label class="radio inline netState">
                                    <input type="radio" id="Radio1" name="DataType" value="3" onclick="ChangeDataType()" />1小时数据
                                </label>--%>
                            <%--</span>--%>
