<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="24HSinglePollutantDataAnalyze.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.RealTimeData._24HSinglePollutantDataAnalyze" %>
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadSplitter ID="splitter" runat="server" Orientation="Horizontal" Height="100%" BorderWidth="0"
            ...
            <telerik:RadPane ID="paneWhere" runat="server" Height="65px" Width="100%" Scrolling="None" MaxHeight="100"
                ...
                <table id="Tb" style="width: 100%; height: 100%" cellspacing="1" cellpadding="0" class="Table_Customer"
                    ...
                    <tr>
                        ...
                        <td class="content">
                            <CbxRsm:PointCbxRsm runat="server" ApplicationType="Air" CbxWidth="130" CbxHeight="350" MultiSelected="true" DropDownWidth="350" ID="pointCbxRsm"></CbxRsm:PointCbxRsm>
                        </td>
                        <td class="title" style="width: 90px; text-align: center;">监测因子:
                        </td>
                        <td class="content" style="width: 22%;">
                            <telerik:RadDropDownList runat="server" ID="rcbFactors" Width="130px">
                                <Items>
                                    <telerik:DropDownListItem Text="二氧化硫" Value="SO2" />
                                    <telerik:DropDownListItem Text="二氧化氮" Value="NO2" />
                                    <telerik:DropDownListItem Text="细颗粒物" Value="PM25" />
            ...
            <telerik:RadPane ID="paneImage" runat="server" Width="100%" Height="100%" Scrolling="None"
                ...
                <div id="divDataEffectRate" style="height: 600px; border: 1px solid #ccc; padding: 10px;"></div>
