<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Particless.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.SuperStationManagement.Particless" %>
                ...
                <telerik:RadMultiPage ID="multiPage" runat="server" Width="100%" Height="100%" ScrollBars="Hidden" SelectedIndex="0">
                    <telerik:RadPageView ID="grvGrid" runat="server" Visible="true">
                        <telerik:RadGrid ID="gridAudit" runat="server" GridLines="None" Height="100%" Width="100%"
                            ...
                            <telerik:RadButton ID="RadButton1" runat="server" BackColor="#1984CA" ForeColor="White"  AutoPostBack="false" OnClientClicking="ClientButtonClicking" Text="标记位说明" Visible="false">
                                <ContentTemplate>
                    ...
                    <telerik:RadPageView ID="HighChart" runat="server" Visible="true">
