<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GeneralFactor.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.SuperStationManagement.GeneralFactor" %>
            ...
            <telerik:RadPane ID="paneWhere" runat="server" Height="80px" Width="100%" Scrolling="None"
                ...
                <table id="Tb" style="width: 100%; height: 100%" cellspacing="1" cellpadding="0" class="Table_Customer"
                    ...
                    <tr>
                        ...
                        <td class="content" style="width: 200px;">
                            <CbxRsm:FactorCbxRsm runat="server" ApplicationType="Air" CbxWidth="380" DropDownWidth="420" ID="factorCbxRsm" Visible="true"></CbxRsm:FactorCbxRsm>
                            <telerik:RadComboBox runat="server" ID="cbFactor" Width="380px" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" Visible="false" CheckedItemsTexts="DisplayAllInInput" Localization-CheckAllString="选择全部" EmptyMessage="请选择">
                            </telerik:RadComboBox>
                        </td>
                        ...
                        <%--<td class="content" align="left" style="width: 150px;" rowspan="3">
                            <asp:CheckBox ID="IsStatistical" Checked="false" Text="分因子" runat="server" />
                        </td>--%>
                        ...
                        <div style="padding-top: 6px;">
                            <div style="float: left;">
                                <asp:RadioButtonList runat="server" ID="PointFactor" AutoPostBack="true" Visible="false" RepeatDirection="Vertical" RepeatColumns="2" OnSelectedIndexChanged="PointFactor_SelectedIndexChanged">
                                    ...
                                    <asp:ListItem Text="按站点分类" Value="point"></asp:ListItem>
                                </asp:RadioButtonList>
                            </div>
