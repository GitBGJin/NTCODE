<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExternalLabel.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.SuperStationManagement.ExternalLabel" %>
            ...
            <script type="text/javascript">
                ...
                function InitGroupChart() {
                    try {
                        ...
                        //    //var Data = eval("(" + hdDate.value + ")");
                        //    var chartdiv = "";
                        //    //$.each(Data.split(';'), function (chartNo, value) {
                        //    //    
                        //    //    chartdiv = "";
                        //    //    chartdiv += '<div style=" width:100%; height:600px;" id="dv'+chartNo+'">';
                        ...
                        //    //    $("#ChartContainer").height(parseInt(parseInt($("#pvChart").css("height")) - 65) + 50 + "px");//设置图表Iframe的高度
                        //    //    $("#ChartContainer").width("100%");//设置图表Iframe的宽度
                        //    //})
                        //    $.each(Data.split(';'), function (chartNo, value) {

                        //        chartdiv = "";
                        //        chartdiv += '<div style=" width:100%; height:300px;" id="dv'+chartNo+'">';
                        //        //chartdiv += '<iframe name="chartIframe" id="frame' + chartNo + '" src="../Chart/AirQualityChart.aspx?pointIds=' + pointIds + '&factor=' + value + '&DSType=' + DSType + '&chartType=' + chartType + '&chartContent=' + chartContent + '&quality=' + quality + '&dtBegion=' + dtBegion + '&dtEnd=' + dtEnd + '"  frameborder="0" marginheight="0" marginwidth="0" width="100%" height="90%" scrolling="no"></iframe>';
                        //        chartdiv += '</div>';
                        //        $("#ChartContainer").append(chartdiv);
                        //        value = '[' + value + ']';
                        //        value = eval("(" + value + ")");
                        //        var contain = 'dv' + chartNo;
                        //        
            ...
            <telerik:RadPane ID="paneWhere" runat="server" Height="80px" Width="100%" Scrolling="None"
                ...
                <table id="Tb" style="width: 100%; height: 100%" cellspacing="1" cellpadding="0" class="Table_Customer"
                    ...
                    <tr>
                        ...
                        <td class="content" align="left" style="width: 150px;" rowspan="2">
                            <table>
                                <tr>
                                    <td>
                                        <asp:RadioButton ID="No" text="一级类" runat="server" GroupName="分类" AutoPostBack="true" Checked="true"  OnCheckedChanged="No_CheckedChanged"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:RadioButton ID="IsType" text="二级类" runat="server" GroupName="分类" AutoPostBack="true" OnCheckedChanged="No_CheckedChanged"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:RadioButton ID="IsStatistical" text="分因子" runat="server" GroupName="分类" AutoPostBack="true"   OnCheckedChanged="No_CheckedChanged"/>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        ...
                        <td class="content" style="width: 600px;" runat="server" visible="false">
