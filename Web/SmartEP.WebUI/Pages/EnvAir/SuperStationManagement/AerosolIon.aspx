<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AerosolIon.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.SuperStationManagement.AerosolIon" %>
            ...
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="btnSearch">
                    <UpdatedControls>
                        ...
                        <telerik:AjaxUpdatedControl ControlID="HiddenChartType" LoadingPanelID="RadAjaxLoadingPanel1"/>
                        ...
                        <telerik:AjaxUpdatedControl ControlID="hdPointName" LoadingPanelID="RadAjaxLoadingPanel1"/>
                    </UpdatedControls>
                </telerik:AjaxSetting>
                        ...
                        <td class="content" style="width: 500px;">
                            ...
                            <div runat="server" id="dbtDay">
                                <telerik:RadDatePicker ID="dayBegin" runat="server" MinDate="1900-01-01" BorderWidth="1px"
                                    ...
                                    MonthYearNavigationSettings-CancelButtonCaption="取消" Calendar-FastNavigationStep="12" />
                                &nbsp;&nbsp;至&nbsp;&nbsp;
