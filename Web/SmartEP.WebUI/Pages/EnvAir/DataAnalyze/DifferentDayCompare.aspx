<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DifferentDayCompare.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.DataAnalyze.DifferentDayCompare" %>
...
function onRequestEnd(sender, args) {
            ...
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="tabStrip">
                    <UpdatedControls>
                        ...
                        <telerik:AjaxUpdatedControl ControlID="OriginalData" LoadingPanelID="RadAjaxLoadingPanel1" />
        ...
        <telerik:RadSplitter ID="splitter" runat="server" Orientation="Horizontal" Height="100%" Width="100%"
                ...
                <table id="Tb" style="width: 100%; height: 100%" cellspacing="1" cellpadding="0" class="Table_Customer"
                    ...
                    <tr>
                        ...
                        <td class="content" align="left" style="width: 100px;" rowspan="3">
                            <asp:CheckBox ID="OriginalData" Checked="false" Text="原始数据" runat="server" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="title" style="width: 80px; text-align: center;">
                            <div runat="server" id="divSame" visible="false">时间:</div>
                            <div runat="server" id="divMul" visible="false">基准时间:</div>
                        </td>
                        <td class="content" style="width: 420px;">
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td class="title" style="width: 80px; text-align: center;">
                            <div runat="server" id="divMulti" visible="false">比对时间:</div>
                        </td>
                        <td class="content" style="width: 420px;">
                                    ...
                                    <table>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>&nbsp;&nbsp;第</td>
                                                <td>
                                                    <telerik:RadDropDownList ID="ddlWeekFrom" runat="server" Width="40px" SelectedText="DropDownListItem1" SelectedValue="4" OnSelectedIndexChanged="ddlWeekFrom_SelectedIndexChanged" AutoPostBack="true">
                                                    </telerik:RadDropDownList>
                                                </td>
                                                <td>周&nbsp;&nbsp;至</td>
                                                <td>
                                                ...
                                                <td>&nbsp;&nbsp;第</td>
                                                <td>
                                                    <telerik:RadDropDownList ID="ddlWeekTo" runat="server" Width="40px" SelectedText="4" SelectedValue="4" OnSelectedIndexChanged="ddlWeekTo_SelectedIndexChanged" AutoPostBack="true">
                                                    </telerik:RadDropDownList>
                                                </td>
                                                <td>周</td>
                                            </tr>
            ...
            <telerik:RadPane ID="paneTab" runat="server" Scrolling="None" Width="100%" Height="26px"
                BorderWidth="0" BorderStyle="None" BorderSize="0">
                <telerik:RadTabStrip ID="tabStrip" runat="server" MultiPageID="multiPage" OnClientTabSelecting="OnClientSelectedIndexChanging" OnTabClick="tabStrip_TabClick" AutoPostBack="true"
                    CssClass="RadTabStrip_Customer">
                    <Tabs>
                        <telerik:RadTab Text="相同时段多个站点多个参数比对" Value="0">
                        </telerik:RadTab>
                        <telerik:RadTab Text="可变时段多个站点多个参数比对" Value="1">
                        </telerik:RadTab>
                    </Tabs>
                </telerik:RadTabStrip>
            </telerik:RadPane>
            ...
            <telerik:RadPane ID="paneGrid" runat="server" Width="100%" Height="100%" Scrolling="None"
                ...
                <telerik:RadMultiPage ID="multiPage" runat="server" Width="100%" Height="100%" ScrollBars="Hidden" SelectedIndex="0">
                    <telerik:RadPageView ID="pvGrid" runat="server" Visible="true">
                        <%--  <telerik:RadGrid ID="rgDataCompare" runat="server" GridLines="None" Height="50%" Width="100%"
                            AllowPaging="True" PageSize="10" AllowCustomPaging="true" AllowSorting="true" ShowFooter="true"
                            AutoGenerateColumns="true" AllowMultiRowSelection="false"
                            EnableHeaderContextMenu="false" EnableHeaderContextFilterMenu="false"
                            ShowStatusBar="false" BorderWidth="0" BorderStyle="None" BorderSize="0"
                            OnNeedDataSource="rgDataCompare_NeedDataSource" OnItemDataBound="rgDataCompare_ItemDataBound" OnColumnCreated="rgDataCompare_ColumnCreated"
                        ...
                        <telerik:RadGrid ID="gridDataCompare" runat="server" GridLines="None" Height="100%" Width="100%"
                            AllowPaging="True" PageSize="20" AllowCustomPaging="true" AllowSorting="true" ShowFooter="true"
                            AutoGenerateColumns="true" AllowMultiRowSelection="false"
                            EnableHeaderContextMenu="false" EnableHeaderContextFilterMenu="false"
                            ShowStatusBar="false" BorderWidth="0" BorderStyle="None" BorderSize="0"
                            ...
                            <MasterTableView GridLines="None" TableLayout="Fixed" CommandItemDisplay="Top" IsFilterItemExpanded="False"
                                ...
                                <PagerStyle FirstPageToolTip="首页" AlwaysVisible="true" Position="Bottom" NextPageToolTip="下页" LastPageToolTip="尾页" PrevPageToolTip="上页"
                                    PageSizeLabelText="显示记录数:" PageSizes="30 40 50" PagerTextFormat="跳转页面:{4}&amp;nbsp;显示 &lt;strong&gt;{2}&lt;/strong&gt; - &lt;strong&gt;{3}&lt;/strong&gt;条,共 &lt;strong&gt;{5}&lt;/strong&gt;条"></PagerStyle>
                            </MasterTableView>
                            <CommandItemStyle Width="100%" />
                            <ClientSettings>
                                <Scrolling AllowScroll="True" EnableVirtualScrollPaging="false" UseStaticHeaders="True"
