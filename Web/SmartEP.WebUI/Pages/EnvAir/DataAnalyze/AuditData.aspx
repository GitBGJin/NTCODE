<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditData.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.DataAnalyze.AuditData" %>
...
<body>
    <form id="form1" runat="server">
        <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            ...
            <%--<script src="../../../Resources/JavaScript/JQuery/grid(5.2.7).split.Patch.js"></script>--%>
            <script type="text/javascript">
                ...
                function InitGroupChart() {
                    try {
                      ...
                      var regionF = $("#HiddenDataRegionOrPoint").val();
                      var regionValue = $("#HiddenDataRegionValue").val();
                        if (pointF == "point") {                //已站点画图
                            ...
                            if (regionF == "City")
                            {
                              groupChartByRegion(regionValue, "", hdGroupFac, hdGroupName, "../Chart/ChartFrame.aspx", height);
                            } else{
                ...
                function ClientButtonClicking(sender, args) {
                    var uri = "AuditDataWindow.aspx";
                    var oWindow = window.radopen(uri, "ConfigOfflineDialog");
                }
        ...
        <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" DefaultLoadingPanelID="RadAjaxLoadingPanel1"
            ...
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="ddlDataSource">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="ddlDataSource" LoadingPanelID="RadAjaxLoadingPanel1" />
                ...
                <telerik:AjaxSetting AjaxControlID="btnSearch">
                    <UpdatedControls>
                        ...
                        <telerik:AjaxUpdatedControl ControlID="HiddenDataRegionOrPoint" />
                        <telerik:AjaxUpdatedControl ControlID="HiddenDataRegionValue" />
...
<%--                        <telerik:AjaxUpdatedControl ControlID="hdIsLJPY" /> --%>
        ...
        <telerik:RadSplitter ID="splitter" runat="server" Orientation="Horizontal" Height="100%" Width="100%"
            ...
            <telerik:RadPane ID="paneWhere" runat="server" Height="100px" Width="100%" Scrolling="None"
                ...
                <table id="Tb" style="width: 100%; height: 100%" cellspacing="1" cellpadding="0" class="Table_Customer"
                    border="0">
                  <tr runat="server" id="selectYs" visible="false">
                    ...
                    <tr>
                        ...
                        <td class="content" style="width: 460px;">
                            <CbxRsm:PointCbxRsm runat="server" ApplicationType="Air" CbxWidth="380" CbxHeight="350" MultiSelected="true" DropDownWidth="520" ID="pointCbxRsm"
                                OnSelectedChanged="pointCbxRsm_SelectedChanged" DefaultIPointMode="Region"></CbxRsm:PointCbxRsm>
                        </td>
                        <td class="title" style="width: 100px">监测因子:
                        </td>
                        <td class="content" style="width: 400px;">
                            <CbxRsm:FactorCbxRsm runat="server" ApplicationType="Air" CbxWidth="380" DropDownWidth="420" ID="factorCbxRsm"></CbxRsm:FactorCbxRsm>
                        </td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td class="title" style="width: 100px">数据来源:
                        </td>
                        <td class="content" style="width: 200px;">
                            ...
                            <%--<telerik:RadButton ID="RadButton1" runat="server" Text="测试"></telerik:RadButton>--%>
                        </td>
                    </tr>
                </table>
            </telerik:RadPane>
            <telerik:RadPane ID="paneTab" runat="server" Scrolling="None" Width="100%" Height="26px"
                ...
                <telerik:RadTabStrip ID="tabStrip" runat="server" SelectedIndex="0" MultiPageID="multiPage" OnClientTabSelecting="OnClientSelectedIndexChanging"
                    ...
                    <Tabs>
                        ...
                        <telerik:RadTab Text="热力图"  Visible="false">
                        </telerik:RadTab>
                    </Tabs>
                </telerik:RadTabStrip>
            </telerik:RadPane>
                ...
                <telerik:RadMultiPage ID="multiPage" runat="server" Width="100%" Height="100%" ScrollBars="Hidden" SelectedIndex="0">
                    <telerik:RadPageView ID="grvGrid" runat="server" Visible="true">
                        <telerik:RadGrid ID="gridAudit" runat="server" GridLines="None" Height="100%" Width="100%"
                            ...
                            <telerik:RadButton ID="RadButton1" runat="server" BackColor="#1984CA" ForeColor="White"  AutoPostBack="false" OnClientClicking="ClientButtonClicking" Text="标记位说明" Visible="true">
                                <ContentTemplate>
                    ...
                    <telerik:RadPageView ID="HighChart" runat="server" Visible="false">
                        <%--<iframe id="iframeHeatMap"  style="width: 100%; height: 100%;"
        ...
        <telerik:RadWindowManager ID="RadWindowManager1" runat="server" VisibleStatusbar="false" Behaviors="Move,Pin,Reload,Close" EnableShadow="false">
            <Windows>
                <telerik:RadWindow ID="ConfigOfflineDialog" runat="server" Height="410px" Width="530px" Skin="Outlook" IconUrl="~/App_Themes/Fminine/images/RadGridHeaderBg2.png"
                    Title="标记位说明" ReloadOnShow="false" ShowContentDuringLoad="false" Modal="false" />
            </Windows>
        ...
        <asp:HiddenField ID="HiddenDataRegionOrPoint" runat="server" Value="" />
        <asp:HiddenField ID="HiddenDataRegionValue" runat="server" Value="" />
...
<%--        <asp:HiddenField ID="hdIsLJPY" runat="server" Value="0" />--%>
    </form>
</body>
</html>
