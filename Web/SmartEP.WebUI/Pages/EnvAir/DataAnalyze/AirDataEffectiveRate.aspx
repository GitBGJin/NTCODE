<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AirDataEffectiveRate.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.DataAnalyze.AirDataEffectiveRate" %>
...
<body>
    <form id="form1" runat="server">
        <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
            <script type="text/javascript" language="javascript">
                ...
                function Refresh_Grid(args) {
                    if (args) {
                        var MasterTable = $find("<%= grdAirEffectiveRate.ClientID %>").get_masterTableView();
                        MasterTable.rebind();
                    }
                }
                //控制导出时按钮不会隐藏掉处理
        ...
        <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" UpdatePanelsRenderMode="Inline">
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="grdAirEffectiveRate">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="grdAirEffectiveRate" LoadingPanelID="RadAjaxLoadingPanel1" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
        ...
        <telerik:RadSplitter ID="splitter" runat="server" Orientation="Horizontal" Height="100%" BorderWidth="0"
                ...
                <table id="Tb" style="width: 100%; height: 100%" cellspacing="1" cellpadding="0" class="Table_Customer"
                    ...
                    <tr>
                        ...
                        <td class="content" style="width: 220px;">
                            <CbxRsm:PointCbxRsm runat="server" ApplicationType="Air" Visible="false" CbxWidth="200" CbxHeight="350" DefaultAllSelected="true" MultiSelected="true" DropDownWidth="520" ID="pointCbxRsm"></CbxRsm:PointCbxRsm>
                        ...
                        <td class="content" style="width: 270px;">
                            <%--<div>--%>
                                <CbxRsm:FactorCbxRsm ID="factorCbxRsm" runat="server" ApplicationType="Air" CbxWidth="270" DropDownWidth="400"  Visible="false" ></CbxRsm:FactorCbxRsm>
                            <%--</div>
                            <div>--%>
            ...
            <telerik:RadPane ID="paneGrid" runat="server" Width="100%" Height="100%" Scrolling="None"
                BorderWidth="0" BorderStyle="None" BorderSize="0">
                <telerik:RadGrid ID="grdAirEffectiveRate" runat="server" GridLines="None" Height="100%" Width="100%"
                    ...
                    OnNeedDataSource="grdAirEffectiveRate_NeedDataSource" OnItemDataBound="grdAirEffectiveRate_ItemDataBound" OnColumnCreated="grdAirEffectiveRate_ColumnCreated"
                            ...
                            <div style="width: 100%; position: relative;">
                                ...
                                <div style="position: absolute; right: 10px; top: 2px;">
                                    <table style="font-size: 12px">
                                        <tr>
                                            <td style="text-align: center">数据捕获率<br />
                                                系统运行时数：运行考核总时数
                                            </td>
                                        </tr>
                                    </table>
