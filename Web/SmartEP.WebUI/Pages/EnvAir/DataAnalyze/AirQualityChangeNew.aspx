<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AirQualityChangeNew.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.DataAnalyze.AirQualityChangeNew" %>
                    ...
                    <tr>
                        ...
                        <td class="content" style="width: 210px;">--%>
                            <telerik:RadComboBox runat="server" ID="ReportType" Visible="false" Width="210px">
                                <Items>
                                    <telerik:RadComboBoxItem Text="各县(市)、区达标率情况月报" Value="Rate"  />
                                    <telerik:RadComboBoxItem Text="各县(市)、区空气质量变化情况" Value="Change"  Selected="true"/>
                                </Items>
                            </telerik:RadComboBox>
                        <%--</td>--%>
                        <td>
