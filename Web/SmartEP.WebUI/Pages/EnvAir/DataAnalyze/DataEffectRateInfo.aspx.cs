...
namespace SmartEP.WebUI.Pages.EnvAir.DataAnalyze
{
    ...
    /// 版权所有(C)：江苏远大信息股份有限公司
    /// </summary>
    public partial class DataEffectRateInfo : System.Web.UI.Page
    {
        /// <summary>
        /// 数据处理服务
        /// </summary>
        ...
        public void BindGrid(string effectRateInfoId)
        {
            ...
            //绑定数据                               
            var samplingRateData = airDataEffectRate.GetEffectRateDetailData(portIds, factors, dtmBegin, dtmEnd, pageSize, pageNo, out recordTotal);
