<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RealTimeAQI_NT.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.DataAnalyze.RealTimeAQI_NT" %>
    ...
    <form id="form1" runat="server">
        <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
            <script type="text/javascript" language="javascript">
                ...
                function CreatChart() {
                    ...
                    if (chartContent == "factorIAQI") {
                        ...
                        $.each(factors.split(','), function (chartNo, value) {
                            ...
                            chartdiv += '<iframe name="chartIframe" id="frame' + chartNo + '" src="../Chart/AirQualityChart.aspx?pointIds=' + pointIds + '&factor=' + value + '&chartType=' + chartType + '&flag=rt' + '&chartContent=' + chartContent + '&dtBegion=' + dtBegion + '&isCheck=' + isCheck + '"  frameborder="0" marginheight="0" marginwidth="0" width="100%" height="90%" scrolling="no"></iframe>';
                            chartdiv += '</div>';
                    ...
                    if (chartContent == "primaryAQI" || chartContent == "primaryValue") {
                        ...
                        chartdiv = "";
                        chartdiv += '<div style=" width:100%; height:600px;">';
                        chartdiv += '<iframe name="chartIframe" id="frame' + Math.random() + '" src="../Chart/AirQualityChart.aspx?pointIds=' + pointIds + '&chartType=' + chartType + '&flag=rt' + '&chartContent=' + chartContent + '&dtBegion=' + dtBegion + '&isCheck=' + isCheck + '"  frameborder="0" marginheight="0" marginwidth="0" width="100%" height="90%" scrolling="no"></iframe>';
                        chartdiv += '</div>';
                        $("#container").append(chartdiv);
                ...
                function RowClick() {
                    ...
                    var moduleGuide = "EF71CD35-419A-4FB3-809C-91AD94088600";
                    OpenFineUIWindow(moduleGuide, "Pages/EnvAir/Report/AirQualityDayReport.aspx", "评价数据")
                }
        ...
        <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" UpdatePanelsRenderMode="Inline">
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="IsCheck">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="IsCheck" />
                        <telerik:AjaxUpdatedControl ControlID="hdIsCheck" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
                <telerik:AjaxSetting AjaxControlID="btnSearch">
                    <UpdatedControls>
                        ...
                        <telerik:AjaxUpdatedControl ControlID="gridHoursAQI" LoadingPanelID="RadAjaxLoadingPanel1" />
                        <telerik:AjaxUpdatedControl ControlID="hdPointId" LoadingPanelID="RadAjaxLoadingPanel1" />
                        <telerik:AjaxUpdatedControl ControlID="hddt" LoadingPanelID="RadAjaxLoadingPanel1" />
                        ...
                        <telerik:AjaxUpdatedControl ControlID="hdIsCheck" LoadingPanelID="RadAjaxLoadingPanel1" />
                ...
                <telerik:AjaxSetting AjaxControlID="tabStrip">
                    <UpdatedControls>
                        ...
                        <telerik:AjaxUpdatedControl ControlID="container" LoadingPanelID="RadAjaxLoadingPanel1" />
                        <telerik:AjaxUpdatedControl ControlID="hdIsCheck" LoadingPanelID="RadAjaxLoadingPanel1" />
                        <%--<telerik:AjaxUpdatedControl ControlID="IsCheck" LoadingPanelID="RadAjaxLoadingPanel1" />--%>
                    </UpdatedControls>
                </telerik:AjaxSetting>
                ...
                <telerik:AjaxSetting AjaxControlID="gridHoursAQI">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="gridHoursAQI" LoadingPanelID="RadAjaxLoadingPanel1" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
...
<%--                <telerik:AjaxSetting AjaxControlID="timer">
        ...
        <telerik:RadSplitter ID="splitter" runat="server" Orientation="Horizontal" Height="100%" BorderWidth="0" Width="100%">
            <telerik:RadPane ID="paneWhere" runat="server" Height="60px" Width="100%" Scrolling="None" BorderWidth="0" BorderStyle="None" BorderSize="0">
                <table id="Tb" style="width: 100%; height: 100%" cellspacing="1" cellpadding="0" class="Table_Customer" border="0">
                    <tr>
                        ...
                        <td class="title" style="width: 100px; text-align: center;">时间:
                        </td>
                        <td class="content" style="width: 200px;">
                            <telerik:RadDateTimePicker ID="dtpBegin" runat="server" MinDate="1900-01-01" BorderWidth="1px"
                                ...
                                TimeView-HeaderText="小时" Width="160px" Calendar-FastNavigationStep="12" />
                        </td>
                        <td class="content" id="checkBox" align="left" style="width: 150px; display: none;" rowspan="1">
                            <asp:CheckBox ID="IsCheck" Checked="true" Text="是否选择平均值" runat="server" />
                        </td>
                        <td class="content" align="center" rowspan="1">
            ...
            <telerik:RadPane ID="paneTab" runat="server" Scrolling="None" Width="100%" Height="26px" BorderWidth="0" BorderStyle="None" BorderSize="0">
                <telerik:RadTabStrip ID="tabStrip" runat="server" SelectedIndex="0" MultiPageID="multiPage" CssClass="RadTabStrip_Customer" OnClientTabSelected="TabSelected">
                    <Tabs>
                        <telerik:RadTab Text="列表">
                        </telerik:RadTab>
                        <telerik:RadTab Text="当日小时AQI">
                        </telerik:RadTab>
            ...
            <telerik:RadPane ID="paneGrid" runat="server" Width="100%" Height="100%" Scrolling="None" BorderWidth="0" BorderStyle="None" BorderSize="0">
                <telerik:RadMultiPage ID="multiPage" runat="server" Width="100%" Height="100%" ScrollBars="Hidden" SelectedIndex="0">
                    <telerik:RadPageView ID="grvGrid" runat="server" Visible="true">
                        <telerik:RadGrid ID="gridRealTimeAQI" runat="server" GridLines="None" Height="100%" Width="100%"
                            ...
                            OnNeedDataSource="grid_NeedDataSource" OnItemDataBound="grid_ItemDataBoundHour"
                            CssClass="RadGrid_Customer" Visible="true">
                            ...
                            <MasterTableView GridLines="None" TableLayout="Fixed" CommandItemDisplay="Top" IsFilterItemExpanded="False"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn HeaderText="监测点位名称" UniqueName="PointId" DataField="PointId" EmptyDataText="--" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="100px" />
...
<%--                                    <telerik:GridBoundColumn HeaderText="浓度/(μg/m<sup>3</sup>)" UniqueName="Recent8HoursO3NT" DataField="Recent8HoursO3NT" EmptyDataText="--" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ColumnGroupName="O38NT" HeaderStyle-Width="90px" />
                    ...
                    <telerik:RadPageView ID="pvHoursAQI" runat="server" Visible="true">
                        <telerik:RadGrid ID="gridHoursAQI" runat="server" GridLines="None" Height="100%" Width="100%"
                            AllowPaging="True" PageSize="24" AllowCustomPaging="true" AllowSorting="false" ShowFooter="false"
                            AutoGenerateColumns="true" AllowMultiRowSelection="false"
                            EnableHeaderContextMenu="false" EnableHeaderContextFilterMenu="false"
                            ShowStatusBar="false" BorderWidth="0" BorderStyle="None" BorderSize="0"
                            OnNeedDataSource="gridHoursAQI_NeedDataSource" OnColumnCreated="gridAudit_ColumnCreated" OnItemDataBound="gridHoursAQI_ItemDataBound"
                            CssClass="RadGrid_Customer" Visible="true">
                            <PagerStyle FirstPageToolTip="首页" AlwaysVisible="true" Position="Bottom" NextPageToolTip="下页" LastPageToolTip="尾页" PrevPageToolTip="上页"
                            ...
                            <MasterTableView GridLines="None" TableLayout="Fixed" CommandItemDisplay="Top" IsFilterItemExpanded="False"
                                ...
                                <CommandItemSettings ShowAddNewRecordButton="false" ShowRefreshButton="true" RefreshText="查询" ShowExportToExcelButton="true" ShowExportToWordButton="true" ShowExportToPdfButton="true" />
                                <CommandItemTemplate>
                                    <div style="position: relative;height:25px;float:right">
                                        <span style="line-height:25px">
                                            &nbsp &nbsp <b>平均值由浓度均值计算</b>&nbsp &nbsp
                                        </span>                                        
                                    </div>
                                    <%--<div style="position: relative;">
                                        <telerik:RadToolBar BorderWidth="0" ID="gridRTB" SkinID="Query" CssClass="RadToolBar_Customer" AutoPostBack="true"
                    ...
                    <telerik:RadPageView ID="pvChart" runat="server" Visible="true">
                        <div style="padding-top: 6px;">
                            <div style="float: left;">
                                ...
                                &nbsp &nbsp &nbsp &nbsp 平均值由浓度均值计算
                            </div>
        ...
        <asp:HiddenField ID="hddt" runat="server" Value="0" />
        <asp:HiddenField ID="hdIsCheck" runat="server" Value="0" />
    </form>
</body>
</html>
