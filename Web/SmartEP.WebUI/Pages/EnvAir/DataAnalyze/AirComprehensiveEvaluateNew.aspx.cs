...
{
    public partial class AirComprehensiveEvaluateNew : BasePage
    {
        /// <summary>
        /// 数据处理服务
        /// </summary>
        ...
        public void BindGrid()
        {
            ...
            if (regionGuids != null)
            {
                ...
                dt = analyzeDate.ToTable();
                dt.Columns.Remove("综合考评");
                dt.Columns.Remove("Compre_Status");
            }
            if (analyzeDate != null)
            {
                grdComprehensive.DataSource = dt.DefaultView;//dataView;
        ...
        protected void gridRTB_ButtonClick(object sender, RadToolBarEventArgs e)
        {
            ...
            if (button.CommandName == "ExportToExcel")
            {
                ...
                dtNew.Columns.Remove("综合考评");
                dtNew.Columns.Remove("Compre_Status");
        ...
        private void DataTableToExcel(DataView dv, string fileName, string sheetName)
        {
            ...
            cells.Merge(2, 4, 1, 1);
            cells[2, 5].PutValue("O3百分位(微克/立方米)");
            cells.Merge(2, 5, 1, 1);
            ...
            for (int i = 0; i < dtNew.Rows.Count; i++)
            {
                ...
                cells[rowIndex, 5].PutValue(drNew["O3百分位(微克/立方米)"].ToString());
