<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditSetting_Super.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.Audit.AuditSetting_Super" %>
    ...
    <form id="form1" runat="server">
        <table class="Table_Customer" style="height: 100%; width: 100%">
            <tr style="height: 50px">
                <td class="title" style="width: 120px;display:none">监测点类型：</td>
                <td class="content" style="width: 120px">
                    <asp:DropDownList runat="server" ID="ddlContrlUid" Width="100%" Visible="false"></asp:DropDownList>
                </td>
                <td class="content" style="width: 80px; text-align: center">
                    <asp:ImageButton runat="server" ID="btnSearch" SkinID="ImgBtnSearch" OnClick="btnSearch_Click" Visible="false"/>
                </td>
                <td class="content" style="width: 80px; text-align: center">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        <td style="text-align: center">
                                            ...
                                            <asp:HiddenField ID="hidPointUid" Value='<%#Eval("InsUid") %>' runat="server" />
                                            ...
                                            <asp:HiddenField ID="HiddenField1" Value='<%#Eval("PointUid") %>' runat="server" />
                                            <asp:HiddenField ID="HiddenField2" Value='<%#Eval("PointName") %>' runat="server" />
                                            <asp:HiddenField ID="HiddenField3" Value='<%#Eval("ContrlUid") %>' runat="server" />
                                            <%--<%#Eval("PointName")%>--%>
                                            <%#Eval("InsName")%>
                                        </td>
                                        <td style="text-align: center">
