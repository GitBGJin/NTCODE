<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MutilPointAuditDataLijingpu.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.Audit.MutilPointAuditDataLijingpu" %>
                    ...
                    <telerik:RadPane ID="RadPane2" runat="server" Scrolling="None" Width="100%" Height="58%" OnClientCollapsed="GridClientCollapsed" OnClientExpanded="ChartClientExpanded" OnClientResized="SpliterResized">
                        ...
                        <div id="ButtonDiv" style="height: 66px;">
                            <table style="text-align: left; width: 100%;">
                                <tr>
                                    ...
                                    <td style="width: 60px;">粒径类型</td>
                                    <td style="width: 130px;">
                                        <telerik:RadDropDownList runat="server" ID="Lijingpu" AutoPostBack="false">
                                            <Items>
                                                <telerik:DropDownListItem Value="ASP" Text="ASP" Selected="true" />
                                                <telerik:DropDownListItem Value="L72" Text="L72" />
                                            </Items>
                        ...
                        <div id="GridDiv">
                            <telerik:RadGrid ID="gridAuditData" runat="server" GridLines="None"
                                ...
                                <MasterTableView GridLines="None" TableLayout="Fixed" CommandItemDisplay="None" IsFilterItemExpanded="False" ClientDataKeyNames="PointId,DateTime"
            ...
            <script type="text/javascript">
                ...
                function ModifyAuditData(flag) {
                    if (flag != "-1") {
                        ...
                        //alert(DataTime.join(";"));
                        AjaxAuditOperateDataWeibo(PointID.join(";"), DataTime.join(";"), FactorCode.join(";"), NewData.join(";"), Pollutant.join(";"), reason, '<%=Session["UserGuid"]%>', "AuditAjaxHandler.ashx?DataType=ModifyAuditDataLijingpu&flag=" + flag);
                    } else {
                        CellCancel();
                    }
                    windowState = null;
                ...
                function SubmitAuditClicked(sender, args) {
                    ...
                    var pointId = $("#PointIDHidden").val();
                    AjaxSubmitAuditLijingpu(StartTime, EndTime, pointId, '<%=Session["UserGuid"]%>', '<%=ViewState["pointType"]%>');
                ...
                function BatchEditCellValueChanged(sender, args) {
                    ...
                    if (table._firstRow.rowIndex >= 0) {
                        ...
                        var dropdownlist = $find("<%= Lijingpu.ClientID %>");
                        Pollutant.push(dropdownlist.get_selectedItem().get_value());
