<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MutilPointAuditData.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.Audit.MutilPointAuditData" %>
...
<body scroll="no">
    <form id="form1" runat="server">
            ...
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="refreshData">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="gridAuditData"></telerik:AjaxUpdatedControl>
                        <telerik:AjaxUpdatedControl ControlID="auditChart"></telerik:AjaxUpdatedControl>
                        <telerik:AjaxUpdatedControl ControlID="FactorCodes"></telerik:AjaxUpdatedControl>
                        <telerik:AjaxUpdatedControl ControlID="factorNames"></telerik:AjaxUpdatedControl>
                        <telerik:AjaxUpdatedControl ControlID="PointIDHidden"></telerik:AjaxUpdatedControl>
                    </UpdatedControls>
                </telerik:AjaxSetting>
                ...
                <telerik:AjaxSetting AjaxControlID="gridAuditData">
                    <UpdatedControls>
                        ...
                        <telerik:AjaxUpdatedControl ControlID="PointIDHidden"></telerik:AjaxUpdatedControl>
                        <telerik:AjaxUpdatedControl ControlID="FactorCodes"></telerik:AjaxUpdatedControl>
                        <telerik:AjaxUpdatedControl ControlID="radPoint"></telerik:AjaxUpdatedControl>
            ...
            <telerik:RadPane ID="MiddlePane" runat="server" Scrolling="None" Height="100%" BorderSize="0" Width="78%">
                <telerik:RadSplitter ID="RadSplitter1" runat="server" Orientation="Horizontal" BorderSize="0" Height="100%">
                    ...
                    <telerik:RadPane ID="RadPane2" runat="server" Scrolling="None" Width="100%" Height="58%" OnClientCollapsed="GridClientCollapsed" OnClientExpanded="ChartClientExpanded" OnClientResized="SpliterResized">
                            ...
                            <table style="text-align: left; width: 100%;">
                                <tr>
                                    ...
                                    <td style="width: 130px;">
                                        <telerik:RadDatePicker runat="server" Width="100%" ID="RadDatePickerBegin" AutoPostBack="false" Calendar-FastNavigationStep="12"
                                    ...
                                    <td>至</td>
                                    <td style="width: 130px;">
                                        <telerik:RadDatePicker runat="server" Width="100%" ID="RadDatePickerEnd" AutoPostBack="false" Calendar-FastNavigationStep="12"
                                            MinDate="1900-01-01" DateInput-Font-Size="10" DateInput-Font-Bold="false" DateInput-DateFormat="yyyy-MM-dd"
                                            DatePopupButton-ToolTip="打开日历选择" TimePopupButton-ToolTip="打开小时选择" Calendar-FirstDayOfWeek="Monday"
                                            Calendar-FastNavigationSettings-TodayButtonCaption="当前年月" Calendar-FastNavigationSettings-OkButtonCaption="确定"
                                            Calendar-FastNavigationSettings-CancelButtonCaption="取消" Timeview-HeaderText="小时"
                                    ...
                                    <td id="SubmitAuditTD" style="width: 80px;" runat="server">
                                        <telerik:RadButton Visible="false" ID="SubmitAudit" runat="server" BackColor="#3A94D3" ForeColor="White" AutoPostBack="false" OnClientClicking="SubmitAuditClicked">
                                            <ContentTemplate>
                                                <asp:Label runat="server" ID="Label4" ForeColor="White" Text="审核提交"></asp:Label>
                                            </ContentTemplate>
                                        </telerik:RadButton>
                                        <telerik:RadButton Visible="false" ID="SubmitAuditWea" runat="server" BackColor="#3A94D3" ForeColor="White" AutoPostBack="false" OnClientClicking="SubmitAuditWeaClicked">
                                            <ContentTemplate>
                                                <asp:Label runat="server" ID="Label4" ForeColor="White" Text="审核提交"></asp:Label>
                                            </ContentTemplate>
                                        </telerik:RadButton>
                        ...
                        <div id="GridDiv">
                            <telerik:RadGrid ID="gridAuditData" runat="server" GridLines="None"
                                ...
                                OnItemDataBound="gridAuditData_ItemDataBound">
                    ...
                    <telerik:RadPane ID="RadPane3" runat="server" Scrolling="None" Width="100%" Height="40%" OnClientCollapsed="ChartPanelCollapsed" OnClientExpanded="ChartClientExpanded" OnClientResized="SpliterResized">
                        <div style="padding-left: 10px; overflow: auto; height: 20%;">
                            <asp:RadioButtonList runat="server" ID="chartFactorRadio" AutoPostBack="true" RepeatDirection="Horizontal" RepeatColumns="10" OnLoad="chartFactorRadio_Load" OnSelectedIndexChanged="chartFactorRadio_SelectedIndexChanged">
                            </asp:RadioButtonList>
                        </div>
                        <div id="auditChart" style="width: 100%; height: 79%;">
                        </div>
                    </telerik:RadPane>--%>
                </telerik:RadSplitter>
            </telerik:RadPane>
        ...
        <div style="display: none">
            ...
            <%--  隐藏域存放选中的站点，在Grid刷新后刷新隐藏域及Chart图表--%>
            <asp:HiddenField ID="PointIDHidden" runat="server" Value="" />
            <asp:HiddenField ID="FactorCodes" runat="server" Value="" />
            <%--  隐藏域存放选中的因子，在Grid刷新后刷新隐藏域及Chart图表--%>
            <asp:HiddenField ID="FactorsHidden" runat="server" Value="" />
        </div>
            ...
            <script type="text/javascript">
                ...
                function LoadingData() {
                    try {
                        ...
                        //var pointId = $("#radPoint").find("[checked]").val();
                        var pointId = $("#PointIDHidden").val();
                        AjaxLoadingMutilFactor(facCode, StartTime, EndTime, pointId, '<%=ViewState["SuperOrNot"]%>', '<%=Session["applicationUID"]%>');
                    } catch (e) {
                    }
                }
                ...
                function SearchClicking(sender, args) {
                    ...
                    for (var i = 0; i < document.getElementById("radPoint").getElementsByTagName("input").length; i++) {
                        if (document.getElementById("radPoint_" + i).checked == true) {
                            flag = 1;
                            break;
                        }
                    }
                ...
                //保存修改数据(时间段有效)
                function ModifyAuditDataRow(flag) {
                    if (flag != "-1") {
                        var reason = document.getElementById('auditReason').value;
                        $('#AuditSubmitDiv').css("display", "");
                        console.log(PointID.join(";") + ":" + DataTime.join(";") + ":" + document.getElementById('FactorCodes').value + ":" + NewData.join(";") + ":" + '<%=Session["applicationUID"]%>' + ":" + reason + ":" + '<%=Session["UserGuid"]%>' + ":" + "AuditAjaxHandler.ashx?DataType=ModifyAuditData&flag=" + ":" + flag);
                        AjaxAuditOperateData(PointID.join(";"), DataTime.join(";"), document.getElementById('FactorCodes').value, NewData.join(";"), '<%=Session["applicationUID"]%>', reason, '<%=Session["UserGuid"]%>', "AuditAjaxHandler.ashx?DataType=ModifyAuditData&flag=" + flag);
                    } else {
                        CellCancel();
                    }
                    windowState = null;
                ...
                //保存修改数据（时间段）
                function ModifyAuditDataForRow(flag) {
                    ;
                    if (flag != "-1") {
                        var reason = document.getElementById('auditReason').value;
                        //alert(DataTime.join(";"));
                        $('#AuditSubmitDiv').css("display", "");
                        AjaxAuditOperateData(PointID.join(";"), DataTime.join(";"), document.getElementById('FactorCodes').value, NewData.join(";"), '<%=Session["applicationUID"]%>', reason, '<%=Session["UserGuid"]%>', "AuditAjaxHandler.ashx?DataType=InvalidRow&flag=" + flag);
                    } else {
                        CellCancel();
                    }
                    windowState = null;
                ...
                function SubmitAuditClicked(sender, args) {
                    ...
                    var EndTime = $find("<%=RadDatePickerEnd.ClientID%>").get_selectedDate().format("yyyy/M/dd");
                    var pointId = $("#PointIDHidden").val();
                    var superOrNot = '<%=ViewState["SuperOrNot"]%>';
                    if (superOrNot == '1') {
                        AjaxSubmitAudit(StartTime, EndTime, pointId, '6cd5c158-8a79-4540-a8b1-2a062759c9a0', '<%=Session["applicationUID"]%>', '<%=Session["UserGuid"]%>', '<%=Session["DisplayName"]%>', '2');
                    }
                    else {
                        AjaxSubmitAudit(StartTime, EndTime, pointId, '6cd5c158-8a79-4540-a8b1-2a062759c9a0', '<%=Session["applicationUID"]%>', '<%=Session["UserGuid"]%>', '<%=Session["DisplayName"]%>', '0');
                    }
                }
                //审核提交(气象)
                function SubmitAuditWeaClicked(sender, args) {
                    if (!confirm("确定提交审核吗？")) { args._cancel = true; return; }
                    $('#AuditSubmitDiv').css("display", "");
                    var StartTime = $find("<%=RadDatePickerBegin.ClientID%>").get_selectedDate().format("yyyy/M/dd");
                    var EndTime = $find("<%=RadDatePickerEnd.ClientID%>").get_selectedDate().format("yyyy/M/dd");
                    var pointId = $("#PointIDHidden").val();
                    var factorCode = $("#FactorsHidden").val();
                    AjaxSubmitAuditWeather(StartTime, EndTime, pointId, factorCode, '<%=Session["applicationUID"]%>', '<%=Session["UserGuid"]%>', '<%=Session["DisplayName"]%>', '<%=ViewState["pointType"]%>');
                }
                //刷新列表
