<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MutilPointAuditStateWX.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.Audit.MutilPointAuditStateWX" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="Search">
                    <UpdatedControls>
                        ...
                        <telerik:AjaxUpdatedControl ControlID="RadGridAnalyze"></telerik:AjaxUpdatedControl>
                        <telerik:AjaxUpdatedControl ControlID="RadCalendar1"></telerik:AjaxUpdatedControl>
                        <telerik:AjaxUpdatedControl ControlID="pagediv" LoadingPanelID="LoadingPanel1"></telerik:AjaxUpdatedControl>
                    </UpdatedControls>
                </telerik:AjaxSetting>
                                ...
                                <table>
                                    <tr>
                                        <td>
                                            ...
                                            <telerik:RadButton runat="server" ID="unselect" BackColor="#3A94D3" ForeColor="White" Visible="false" AutoPostBack="false" ToolTip="不选" OnClientClicked="deleteAll" OnClick="unselect_Click">
                                                <ContentTemplate>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 80px;">
                                        <telerik:RadButton ID="Search" runat="server" BackColor="#3A94D3" Visible="true" ForeColor="White" AutoPostBack="true" OnClick="Search_Click">
                                            <ContentTemplate>
                                                <asp:Label runat="server" ForeColor="White" Text="查询"></asp:Label>
                                            </ContentTemplate>
                                        </telerik:RadButton>
                                        <telerik:RadButton ID="DeleteAudit" runat="server" BackColor="#3A94D3" Visible="false" ForeColor="White" AutoPostBack="true" OnClick="DeleteAudit_Click">
                                            <ContentTemplate>
                                        ...
                                        <telerik:RadGrid ID="gridAuditLog" runat="server" GridLines="None"
                                            ...
                                            <MasterTableView GridLines="None" TableLayout="Fixed" CommandItemDisplay="None" IsFilterItemExpanded="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridTemplateColumn HeaderText="测点名称" UniqueName="PointName" DataField="PointName" />
                                ...
                                <telerik:RadGrid ID="RadGridAnalyze" runat="server" GridLines="None"
                                    ...
                                    <MasterTableView GridLines="None" TableLayout="Fixed" IsFilterItemExpanded="False"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="测点" UniqueName="PointName" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
        ...
        <telerik:RadAjaxLoadingPanel ID="LoadingPanel1" runat="server" Width="1000" Height="1000">
