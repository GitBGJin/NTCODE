<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OzoneCalibrationTwoInfo.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.OperatingMaintenance.OzoneCalibrationTwoInfo" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadSplitter ID="splitter" runat="server" Orientation="Horizontal" Height="100%" BorderWidth="0"
            ...
            <telerik:RadPane ID="paneWhere" runat="server" Height="220px" Width="100%" Scrolling="None"
                ...
                <table id="Tb" style="width: 700px; height: 5%" cellspacing="1" cellpadding="0" class="Table_Customer"
                    ...
                    <tr>
                        ...
                        <td style="width: 10%; text-align: center;">
                            ...
                            <asp:Label ID="lblInstrumentType" runat="server" Text="S010101"></asp:Label>
                        ...
                        <td class="title" style="width: 12%; text-align: center;">仪器编号：
                        </td>
                        <td>
                            <asp:Label ID="lblSiteName" runat="server" Text="ASX0101"></asp:Label>
                        </td>


                    </tr>
                    <tr>
                        <td class="title" style="width: 12%; text-align: center;">校准地点：
                        </td>
                        <td style="width: 10%; text-align: center;">
                        ...
                        <td class="title" style="width: 12%; text-align: center;">开始时间：
                        </td>
                        <td>
                            <asp:Label ID="Label11" runat="server" Text="2015.02.05"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="title" style="width: 12%; text-align: center;">室内温度：</td>
                        <td style="width: 10%; text-align: center;">
                            <asp:Label ID="Label27" runat="server" Text="30℃"></asp:Label>

                        </td>
                        <td class="title" style="width: 12%; text-align: center;">室内湿度：</td>
                        <td style="width: 10%; text-align: center;">
                            <asp:Label ID="Label8" runat="server" Text="25"></asp:Label>

                        </td>
                        <td class="title" style="width: 12%; text-align: center;">室内气压：</td>
                        <td>
                            <asp:Label ID="Label9" runat="server" Text="36"></asp:Label>
                ...
                <div style="margin: 10px 0px 10px 10px;">
                    <table style="width: 700px; height: 10%;" cellspacing="1" cellpadding="1" class=" gridtable" border="1">
                        ...
                        <tr>
                            ...
                            <td class="content" style="width: 5%; text-align: center;">
                                <asp:Label ID="Label2" runat="server" Text="A0105020"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="title" style="width: 10%; text-align: center;" colspan="2">与NISTSRP    比对日期</td>
                        ...
                        <telerik:RadGrid ID="gridMaintenanceInfo" runat="server" GridLines="None" Height="100%" Width="100%"
                            ...
                            <MasterTableView GridLines="None" TableLayout="Fixed" CommandItemDisplay="Top" IsFilterItemExpanded="False"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridNumericColumn HeaderText="传递标准浓度" UniqueName="PointName" DataField="PointName" DecimalDigits="0" MaxLength="14" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" EmptyDataText="--" />

                                    <telerik:GridNumericColumn HeaderText="转换后浓度" UniqueName="PointName" DataField="PointName" DecimalDigits="0" MaxLength="14" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" EmptyDataText="--" />
                                    <telerik:GridNumericColumn HeaderText="被校仪器浓度" UniqueName="PointName" DataField="PointName" DecimalDigits="0" MaxLength="14" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" EmptyDataText="--" />
                                    <telerik:GridNumericColumn HeaderText="响应误差" UniqueName="PointName" DataField="PointName" DecimalDigits="0" MaxLength="14" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" EmptyDataText="--" />
                                </Columns>
