<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeomTrafficSoftwareInfo.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.OperatingMaintenance.TeomTrafficSoftwareInfo" %>
        ...
        <telerik:RadSplitter ID="splitter" runat="server" Orientation="Horizontal" Height="100%" BorderWidth="0"
            ...
            <telerik:RadPane ID="paneWhere" runat="server" Height="100%" Width="100%" Scrolling="None"
                ...
                <table id="Tb" style="width: 80%; height: 5%" cellspacing="1" cellpadding="0" class="Table_Customer"
                    border="0">
                    <tr>
                        <td class="title" style="width: 6%; text-align: center;">站点：
                        </td>
                        ...
                        <td>
                            <asp:Label ID="Label26" runat="server" Text="2015.09.22"></asp:Label>

                        </td>

                    </tr>
                    <tr>
                        <td class="title" style="width: 6%; text-align: center;">签名：</td>
                        <td style="width: 8%; text-align: center;">
                            <asp:Label ID="Label27" runat="server" Text="南门"></asp:Label>
                ...
                <div style="margin: 10px 0px 10px 10px;">
                    <table style="width: 700px; height: 10%;" cellspacing="1" cellpadding="1" class=" gridtable" border="1">
                        ...
                        <tr>
                            ...
                            <td class="content" style="width: 5%; text-align: center;">
                                <asp:Label ID="Label2" runat="server" Text="30atm / mmHg"></asp:Label>
                            </td>
                        </tr>
                ...
                <div style="margin: 10px 0px 10px 10px;">
                    <table style="width: 700px; height: 10%;" cellspacing="1" cellpadding="1" class=" gridtable" border="1">
                        ...
                        <tr>
                            ...
                            <td class="content" style="width: 5%; text-align: center;">
                                <asp:Label ID="Label3" runat="server" Text="S010101"></asp:Label>
                            </td>
                            <td class="title" style="width: 10%; text-align: center;">模型号</td>
                            <td class="content" style="width: 5%; text-align: center;">
                                <asp:Label ID="Label4" runat="server" Text="A221525"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="title" style="width: 10%; text-align: center;">变送器单元序列号</td>
                            <td class="content" style="width: 5%; text-align: center;">
                                <asp:Label ID="Label5" runat="server" Text="B1250125"></asp:Label>
                            </td>
                            <td class="title" style="width: 10%; text-align: center;">设备号</td>
                            <td class="content" style="width: 5%; text-align: center;">
                                <asp:Label ID="Label28" runat="server" Text="C0120253"></asp:Label>
                            </td>
                        </tr>
                ...
                <div style="margin: 10px 0px 10px 10px;">
                    <table style="width: 700px; height: 10%;" cellspacing="1" cellpadding="1" class=" gridtable" border="1">
                        ...
                        <tr>
                            ...
                            <td class="title" style="width: 10%; text-align: center;">压力</td>
                            <td class="content" style="width: 5%; text-align: center;">
                                <asp:Label ID="Label7" runat="server" Text="30atm"></asp:Label>
                            </td>
                        </tr>
