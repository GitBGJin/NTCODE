...
namespace SmartEP.WebUI.Pages.EnvAir.OperatingMaintenance
{
    ...
    /// 功能摘要：仪器维修维护详情
    /// 版权所有(C)：江苏远大信息股份有限公司
    public partial class InstrumentRepairInfo : SmartEP.WebUI.Common.BasePage
    {
        /// <summary>
        /// 数据处理服务
        /// </summary>
        ...
        public void BindGrid()
        {
            ...
            int pageSize = gridInstrumentRepairInfo.PageSize;//每页显示数据个数  
            int pageNo = gridInstrumentRepairInfo.CurrentPageIndex;//当前页的序号
            ...
            {
                gridInstrumentRepairInfo.DataSource = new DataTable();
            }
            else
            {
                gridInstrumentRepairInfo.DataSource = airDataEffectRateData;
            }

            //数据总行数
            gridInstrumentRepairInfo.VirtualItemCount = recordTotal;
