<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaintenanceInfo.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.OperatingMaintenance.MaintenanceInfo" %>
            ...
            <telerik:RadPane ID="paneWhere" runat="server" Height="60px" Width="100%" Scrolling="None"
                ...
                <table id="Tb" style="width: 100%; height: 100%" cellspacing="1" cellpadding="0" class="Table_Customer"
                    ...
                    <tr>
                        ...
                        <td class="title" style="width: 8%; text-align: right;">保养人：
                        </td>
                        <td class="content" style="width: 5%;">
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; width: 8%;">零点漂移：</td>
                        <td class="content" style="width: 5%;">

                            <asp:Label ID="lblZeroDrift" runat="server" Text="233333"></asp:Label>

                        </td>
                        <td style="text-align: right; width: 8%;">跨度漂移：</td>
                        <td>
