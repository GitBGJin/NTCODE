<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeasonMaintenance.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.OperatingMaintenance.SeasonMaintenance" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadGrid ID="gridSeason" runat="server" GridLines="None" Height="100%" Width="100%"
            ...
            OnNeedDataSource="gridSeason_NeedDataSource" OnItemDataBound="gridSeason_ItemDataBound"
            ...
            <MasterTableView GridLines="None" TableLayout="Fixed" CommandItemDisplay="None" IsFilterItemExpanded="False"
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn HeaderText="季维护保养" DataField="TestItems" UniqueName="TestItems" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></telerik:GridBoundColumn>
