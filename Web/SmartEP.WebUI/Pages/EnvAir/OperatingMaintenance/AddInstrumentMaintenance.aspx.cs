...
namespace SmartEP.WebUI.Pages.EnvAir.OperatingMaintenance
{
    ...
    /// 功能摘要：仪器维修维护保养
    /// 版权所有(C)：江苏远大信息股份有限公司
    public partial class AddInstrumentMaintenance : SmartEP.WebUI.Common.BasePage
    {
        /// <summary>
        /// 数据处理服务
        /// </summary>
        WaterCustomDataAnalysisService waterCustomDataAnalysis = new WaterCustomDataAnalysisService();
        /// <summary>
        /// 选择因子
        /// </summary>
