...
namespace SmartEP.WebUI.Pages.EnvAir.OperatingMaintenance
{
    ...
    /// 功能摘要：仪器运行维护详情
    /// 版权所有(C)：江苏远大信息股份有限公司
    public partial class InstrumentMoveInfo : SmartEP.WebUI.Common.BasePage
    {
        /// <summary>
        /// 数据处理服务
        /// </summary>
        ...
        public void BindGrid()
        {
            ...
            int pageSize = gridInstrumentMoveInfo.PageSize;//每页显示数据个数  
            int pageNo = gridInstrumentMoveInfo.CurrentPageIndex;//当前页的序号
            ...
            {
                gridInstrumentMoveInfo.DataSource = new DataTable();
            }
            else
            {
                gridInstrumentMoveInfo.DataSource = airDataEffectRateData;
            }

            //数据总行数
            gridInstrumentMoveInfo.VirtualItemCount = recordTotal;
