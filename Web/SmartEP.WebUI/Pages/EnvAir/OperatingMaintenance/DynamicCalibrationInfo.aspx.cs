...
namespace SmartEP.WebUI.Pages.EnvAir.OperatingMaintenance
{
    ...
    /// 功能摘要：700动态校准仪校准报告
    /// 版权所有(C)：江苏远大信息股份有限公司
    public partial class DynamicCalibrationInfo : SmartEP.WebUI.Common.BasePage
    {
        /// <summary>
        /// 数据处理服务
        /// </summary>
        ...
        public void BindGrid()
        {
            ...
            int pageSize = gridStandardGas.PageSize;//每页显示数据个数  
            int pageNo = gridStandardGas.CurrentPageIndex;//当前页的序号
            ...
            {
                gridStandardGas.DataSource = new DataTable();
                gridDilution.DataSource = new DataTable();
            }
            else
            {
                gridStandardGas.DataSource = airDataEffectRateData;
                gridDilution.DataSource = airDataEffectRateData;
            }

            //数据总行数
            gridStandardGas.VirtualItemCount = recordTotal;
            gridDilution.VirtualItemCount = recordTotal;
