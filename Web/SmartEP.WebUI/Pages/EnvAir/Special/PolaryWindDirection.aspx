<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PolaryWindDirection.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.Special.PolaryWindDirection" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function AjaxLoadingPolary(PointID, FactorCode, dtBegin, dtEnd, radlDataType, WindDir, PolaryType, pointId) {
                ...
                $("#Container").height("450px");//设置图表Iframe的高度
                        ...
                        <td class="content" style="width: 400px;">
                            <table>
                                <tr>
                                    ...
                                    <td class="title" style="width: 80px">风向站点:
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td id="tdContent" runat="server">
                                        <telerik:RadComboBox ID="factorCom" runat="server" Width="100" SkinID="Default" Skin="Default" CheckBoxes="true" Localization-CheckAllString="全选" EnableCheckAllItemsCheckBox="true" CheckedItemsTexts="DisplayAllInInput">
                                            <Items>
                                                <telerik:RadComboBoxItem runat="server" Selected="True" Text="SO2" Value="a21026" Checked="true" />
                                                <telerik:RadComboBoxItem runat="server" Text="NO2" Value="a21004" Checked="true" />
                                                <telerik:RadComboBoxItem runat="server" Text="O3" Value="a05024" Checked="true" />
                                                <telerik:RadComboBoxItem runat="server" Text="CO" Value="a21005" Checked="true" />
                                                <telerik:RadComboBoxItem runat="server" Text="PM2.5" Value="a34004" Checked="true" />
                                                <telerik:RadComboBoxItem runat="server" Text="PM10" Value="a34002" Checked="true" />
                                            </Items>
                                        </telerik:RadComboBox>
                                    </td>
                        ...
                        <div style="text-align: center;">
                            <div style="float: left;">
                                <div style="padding-top: 20px; padding-left: 60px;">
                                    <div id="Container" style="height: 450px; min-width: 450px;">
                                    </div>
                                </div>
                            </div>
                            <div style="float: left;">
                                <div style="padding-top: 120px;">
                                    <telerik:RadGrid ID="polaryGrid" runat="server" GridLines="None" Width="500"
                                        ...
                                        CssClass="RadGrid_Customer" OnNeedDataSource="polaryGrid_NeedDataSource" OnLoad="polaryGrid_Load" >
