<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlarmNotifyEdit.aspx.cs" MasterPageFile="~/WebMaster/MasterPage.Master" Inherits="SmartEP.WebUI.Pages.EnvAir.Alarm.AlarmNotifyEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table id="maintable" width="100%" class="Table_Customer">
        ...
        <tr>
            <td class="title" style="width: 15%;">监测点</td>
            <td class="content" colspan="3">
