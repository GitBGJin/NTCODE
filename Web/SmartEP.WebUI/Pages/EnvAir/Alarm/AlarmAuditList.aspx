<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlarmAuditList.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.Alarm.AlarmAuditList" %>
        ...
        <telerik:radcodeblock id="RadCodeBlock1" runat="server">
            <script type="text/javascript">
                ...
                function ShowEditForm(id,type) {
                    var oWnd = radopen("AlarmAuditEdit.aspx?AlarmUid=" + id+"&type="+type, "AlarmHandle");
                    return false;
                }
            </script>
        ...
        <telerik:radsplitter id="splitter" runat="server" orientation="Horizontal" height="100%" width="100%"
                ...
                <table id="Tb" style="height: 100%;" class="Table_Customer">
                    ...
                    <tr>
                        ...
                        <td class="content" style="width: 20px;">
                            <telerik:RadDateTimePicker ID="dtpBegin" runat="server" Width="180px" MinDate="1900-01-01" DateInput-DateFormat="yyyy-MM-dd HH:00"
                        ...
                        <td class="content" style="width: 200px;">
                            <telerik:RadDateTimePicker ID="dtpEnd" runat="server" Width="180px" MinDate="1900-01-01" DateInput-DateFormat="yyyy-MM-dd HH:00"
                                DatePopupButton-ToolTip="打开日历选择" TimePopupButton-ToolTip="打开小时选择" Calendar-FirstDayOfWeek="Monday"
                                Calendar-FastNavigationSettings-TodayButtonCaption="当前年月"
                                Calendar-FastNavigationSettings-OkButtonCaption="确定"
                                Calendar-FastNavigationSettings-CancelButtonCaption="取消"
                        ...
                        <td class="title" style="width: 80px; text-align: center;">审核状态:
                        </td>
                        <td class="content">已审核<asp:CheckBox ID="cbxHaveAudit" runat="server" Checked="true" />
                            未审核<asp:CheckBox ID="cbxNoAudit" runat="server" Checked="true" />
                        </td>
                    </tr>
                </table>
            ...
            <telerik:RadPane ID="paneGrid" runat="server" Width="100%" Height="100%" Scrolling="None"
                ...
                <telerik:RadGrid ID="gridMonitor" runat="server" GridLines="None" Height="100%" Width="100%"
                    ...
                    <MasterTableView GridLines="None" TableLayout="Fixed" CommandItemDisplay="Top" ShowFooter="false" IsFilterItemExpanded="False"
                        ...
                        <CommandItemTemplate>
<%--                            <telerik:RadToolBar BorderWidth="0" ID="RadToolBar1" SkinID="PLAudit" CssClass="RadToolBar_Customer" AutoPostBack="true"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn HeaderText="点位名称" UniqueName="MonitoringPointName" DataField="MonitoringPointName" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                HeaderStyle-Width="100px" ItemStyle-Width="100px" ReadOnly="true" Visible="True"  />
                            <telerik:GridBoundColumn HeaderText="时间" UniqueName="CreatDateTime" DataField="CreatDateTime" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                HeaderStyle-Width="120px" ItemStyle-Width="120px" ReadOnly="true" Visible="True" />
                            ...
                            <telerik:GridBoundColumn HeaderText="报警内容" UniqueName="Content" DataField="Content" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left"
                                HeaderStyle-Width="300px" ItemStyle-Width="300px" ReadOnly="true" Visible="True" />
                            <%-- <telerik:GridBoundColumn HeaderText="报警级别" UniqueName="AlarmGradeName" DataField="AlarmGradeName" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                HeaderStyle-Width="70px" ReadOnly="true" Visible="True" />--%>
                            <telerik:GridBoundColumn HeaderText="颜色" UniqueName="AlarmGradeUid" DataField="AlarmGradeUid"
                            ...
                            <telerik:GridBoundColumn HeaderText="处理时间" UniqueName="dealTime" DataField="dealTime" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                HeaderStyle-Width="120px" ItemStyle-Width="120px" ReadOnly="true" Visible="True" />
                            <telerik:GridBoundColumn HeaderText="是否审核" UniqueName="auditFlag" DataField="auditFlag" 
                                HeaderStyle-Width="100px" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" Visible="True" HeaderButtonType="None">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn HeaderText="审核时间" UniqueName="auditTime" DataField="auditTime" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                HeaderStyle-Width="120px" ItemStyle-Width="120px" ReadOnly="true" Visible="true" />
                            <telerik:GridTemplateColumn HeaderStyle-Width="50px" ItemStyle-Width="50px" HeaderText="审核" UniqueName="TemplateEditColumn" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
        ...
        <telerik:radwindowmanager id="RadWindowManager1" runat="server" visiblestatusbar="false" behaviors="Move,Pin,Reload,Close"
            enableshadow="true">
            <Windows>
                <telerik:RadWindow ID="AlarmHandle" runat="server" Width="500px" Height="450px" ViewStateMode="Enabled"
