...
{
    public partial class OzonePrecursorChart2 : SmartEP.WebUI.Common.BasePage
    {
        /// <summary>
...
//                , typeName[2]);
                ...
                string sql1 = string.Format(@"select VOC2Type
                                        ...
                                        (SELECT RowGuid from [dbo].[DT_VOC1Type] where VOC1Type in ('{0}')))", typeName[2]);
                ...
                //string BrandData = PageHelper.GetQueryString("BrandData");
                //string[] brand = BrandData.TrimEnd(';').Split(';');
                //decimal sum = 0;
                //decimal del = 0;
                //string BrandNum = "Browser Version	Total Market Share \n ";
                //foreach (string brands in brand)
                //{
                //    string[] Num = brands.Split(':');
                //    sum += Convert.ToDecimal(Num[2]);
                //}
                //foreach (string brands in brand)
                //{
                //    //1.报错
                ...
                //    //4.注意\n
                //    string[] Num = brands.Split(':');
                //    del = DecimalExtension.GetPollutantValue(Convert.ToDecimal(Num[2]) * 100 / sum, 2);
                //    if(del.ToString().Contains("."))
                //    {
                //        foreach(string alkane in alkaneCode)
                //        {
                //            if(Num[0]==alkane)
                //            {
                //                BrandNum += "非甲烷碳氢化合物" + "[" + Num[1] + "]	" + del + "% \n ";
                //            }
                //        }
                //        foreach(string olefin in olefinCode)
                //        {
                //            if(Num[0]==olefin)
                //            {
                //                BrandNum += "卤代烃类VOCs" + "[" + Num[1] + "]	" + del + "% \n ";
                //            }
                //        }
                //        foreach (string aromaticHydrocarbon in aromaticHydrocarbonCode)
                //        {
                //            if (Num[0] == aromaticHydrocarbon)
                //            {
                //                BrandNum += "含氧（氮）类VOCs" + "[" + Num[1] + "]	" + del + "% \n ";
                //            }
                //        }
                //    }
                //    else
                ...
                //            if (Num[0] == alkane)
                //            {
                //                BrandNum += "非甲烷碳氢化合物" + "[" + Num[1] + "]	" + del + ".00" + "% \n ";
                //            }
                //        }
                //        foreach (string olefin in olefinCode)
                //        {
                //            if (Num[0] == olefin)
                //            {
                //                BrandNum += "卤代烃类VOCs" + "[" + Num[1] + "]	" + del + ".00" + "% \n ";
                //            }
                //        }
                //        foreach (string aromaticHydrocarbon in aromaticHydrocarbonCode)
                //        {
                //            if (Num[0] == aromaticHydrocarbon)
                //            {
                //                BrandNum += "含氧（氮）类VOCs" + "[" + Num[1] + "]	" + del + ".00" + "% \n ";
                //            }
                //        }
                //    }
                //}
                //BrandNum += "卤代烃类VOCs[氟利昂11]	0.00% \n ";
                //BrandNum += "含氧(氮)类VOCs[丙醛]	0.00%";
                //hdBrandData.Value = BrandNum;
                //hdBrandData.Value = "Browser Version	Total Market Share \n ";
                //hdBrandData.Value += "非甲烷碳氢化合物[苯]	7.73% \n 非甲烷碳氢化合物[环-己烷]	8.01%  \n 卤代烃类VOCs[环己烷]	8.01%";
                //tsv.InnerHtml += "<p>卤代烃类VOCs" + " " + "[氟利昂11]" + " " + "0.00%" + "</p>";
                //tsv.InnerHtml += "<p>含氧(氮)类VOCs" + " " + "[丙醛]" + " " + "0.00%" + "</p>";
                //hdBrandData.Value = "Browser Version\tTotal Market Share \n 非甲烷碳氢化合物[苯]\t100%  \n 非甲烷碳氢化合物[甲苯]\t0.00%  \n 卤代烃类VOCs[氟利昂11]\t0.00% \n含氧(氮)类VOCs[丙醛]\t0.00%";
                //hdBrandData.Value = "Browser Version\tTotal Market Share \n 非甲烷碳氢化合物[苯]\t100.00% \n 非甲烷碳氢化合物[甲苯]\t0.00% \n 卤代烃类VOCs[氟利昂11]\t0.00% \n 含氧(氮)类VOCs[丙醛]\t0.00%";
            }
            catch (Exception e)
