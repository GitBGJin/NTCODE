<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OzonePrecursorChart2.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.Chart.OzonePrecursorChart2" %>
...
<telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <%--<script src="../../../Resources/JavaScript/PieHighCharts/exporting.js"></script>
        <script src="../../../Resources/JavaScript/PieHighCharts/data.js"></script>
        <script src="../../../Resources/JavaScript/HighCharts/drilldown.js"></script>--%>
    ...
    <%--<script src="../../../Resources/JavaScript/DrillDown/drilldown.js"></script>
        ...
        <%--<script src="../../../Resources/JavaScript/PieHighCharts/data.js"></script>
        <script src="../../../Resources/JavaScript/PieHighCharts/drilldown.js"></script>
        <script src="../../../Resources/JavaScript/PieHighCharts/highcharts.js"></script>
                    ...
                    parsed: function (columns) {
                        ...
                        columns[1] = $.map(columns[1], function (value) {
                            if (value.indexOf('%') === value.length - 1) {
                                //value = parseFloat(value.toString().substring(0, value.toString().length - 2));
