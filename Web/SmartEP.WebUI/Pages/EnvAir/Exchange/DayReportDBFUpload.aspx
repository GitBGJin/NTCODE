...
<body>
    <form id="form1" runat="server">
        ...
        <div id="AuditSubmitDiv" style="display: none; height: 390px; width: 1200px; vertical-align: middle; text-align: center; background-color: white; opacity: 0.7; filter: alpha(opacity=70); z-index: 100; position: absolute;">
            <p style="text-align: center; vertical-align: middle; padding-top: 20%; font-weight: bold; font-size: 18px; color: #b4aa38;">正在同步...</p>
        </div>
      
        <telerik:RadSplitter ID="splitter" runat="server" Orientation="Horizontal" Height="100%" BorderWidth="0"
            Width="100%">
            <telerik:RadPane ID="paneWhere" runat="server" Height="110px" Width="100%" Scrolling="None"
                BorderWidth="0" BorderStyle="None" BorderSize="0">
                <table id="Tb" style="width: 100%; height: 100%" cellspacing="1" cellpadding="0" class="Table_Customer"
                    border="0">
                    <tr>
                        <td class="title" style="width: 100px; text-align: center;">同步站点:
                        </td>
                        <td class="content" style="width: 500px;">
                            <div>
                                <CbxRsm:PointCbxRsm runat="server" ApplicationType="Air" CbxWidth="350" CbxHeight="350" DefaultAllSelected="true" MultiSelected="true" DropDownWidth="520" ID="pointCbxRsm"></CbxRsm:PointCbxRsm>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="title" style="width: 100px; text-align: center;">同步因子:
                        </td>
                        <td class="content" style="width: 500px;">
                            <div>
                                <CbxRsm:FactorCbxRsm runat="server" ApplicationType="Air" CbxWidth="350" DropDownWidth="420" ID="factorCbxRsm"></CbxRsm:FactorCbxRsm>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="title" style="width: 100px; text-align: center;">同步时间:
                        </td>
                        <td class="content" style="width: 500px;">
                        ...
                        <td>
                            <telerik:RadButton ID="UpdateMessage" runat="server" Text="手动同步" OnClientClicking="btnSyncClicked"></telerik:RadButton>
                        </td>
