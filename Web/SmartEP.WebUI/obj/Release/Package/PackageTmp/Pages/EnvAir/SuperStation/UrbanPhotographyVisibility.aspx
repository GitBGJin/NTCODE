<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UrbanPhotographyVisibility.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.SuperStation.UrbanPhotographyVisibility" %>
    ...
    <script type="text/javascript">
        ...
        function GetImgUrl(imgurl) {
            ...
            var rbl = document.getElementsByName("radlDataType");
                document.getElementById("imgName").innerText = "城市影像能见度";
        ...
        function OnClientClicking() {
            var date1 = new Date();
            var date2 = new Date();
            date1 = $find("<%# rdpstartdate.ClientID %>").get_selectedDate();
            date2 = $find("<%# rdpenddate.ClientID %>").get_selectedDate();
        ...
        <table style="width: 100%; height: 98%; text-align: center;">
            <tr style="width: 100%; height: 100%;">
                <td style="width: 200px; height: 100%; vertical-align: top">
                    <br />
                    <telerik:RadDatePicker runat="server" ID="rdpstartdate" DateInput-Label="开始日期" MinDate="1900-01-01" DateInput-DateFormat="yyyy-MM-dd" Calendar-FastNavigationStep="12"></telerik:RadDatePicker>
                    <br />
                    <br />
                    <telerik:RadDatePicker runat="server" ID="rdpenddate" DateInput-Label="截止日期" MinDate="1900-01-01" DateInput-DateFormat="yyyy-MM-dd" Calendar-FastNavigationStep="12"></telerik:RadDatePicker>
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    <asp:ImageButton SkinID="ImgBtnSearch" runat="server" ID="btnSearch" OnClick="btnSearch_Click" OnClientClick="return OnClientClicking()"/>
                    <br />
                    <br />
