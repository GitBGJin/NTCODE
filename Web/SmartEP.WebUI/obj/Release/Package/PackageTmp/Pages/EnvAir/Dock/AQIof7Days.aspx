<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AQIof7Days.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.Dock.AQIof7Days" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function AjaxLoadingData() {
            $.ajax({
                type: 'post', //用POST方式传输
                url: '../ChartAjaxRequest/DayAQI.ashx?r=' + Math.random(),
                dataType: 'json',
                data: {
                    action: 'Days',
                ...
                success: function (data) {
                    getAQIForPre7DaysCallback(data);
                },
                error: function (res) {
                }
            });
