<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/WebMaster/MasterPage.Master" CodeBehind="UserAuthConfigDetail.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.BaseData.UserAuthConfigDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID='ContentPlaceHolder1' runat="server">
    ...
    <telerik:RadTabStrip runat="server" ID="RadTabStrip1" SelectedIndex="0" MultiPageID="RadMultiPage1" CssClass="RadTabStrip_Customer" ontabclick="RadTabStrip1_TabClick">
        <Tabs>
            <telerik:RadTab Text="授权测点" runat="server" Selected="True" />
            <telerik:RadTab Text="授权因子" runat="server" />
        </Tabs>
    </telerik:RadTabStrip>
    <asp:HiddenField ID="UserGuid" Value="" runat="server" />
