<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PointYearReport.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.Report.PointYearReport" %>
                ...
                <table id="Tb" style="width: 100%; height: 100%" cellspacing="1" cellpadding="0" class="Table_Customer"
                    ...
                    <tr>
                        ...
                        <td class="content" style="width: 360px;">
                            <telerik:RadMonthYearPicker ID="dtpBegin" runat="server" MinDate="1900-01-01" Width="85px" BorderWidth="1px" DateInput-DateFormat="yyyy"
