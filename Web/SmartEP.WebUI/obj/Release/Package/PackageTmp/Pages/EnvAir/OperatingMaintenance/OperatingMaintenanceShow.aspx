<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OperatingMaintenanceShow.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.OperatingMaintenance.OperatingMaintenanceShow" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //var iframeTaskInfo = document.getElementById("iframeTaskInfo");
            //var iframeChild = window.frames["iframeTaskInfo"]; 
            //if (iframeChild != undefined && iframeChild != null) {
            //    iframeTaskInfo.style.width = (iframeChild.offsetWidth + 50).toString() + "px";
            //}
        })
    </script>
</head>
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadSplitter ID="splitter" runat="server" Orientation="Horizontal" Height="100%" Width="100%"
            ...
            <telerik:RadPane ID="paneGrid" runat="server" Width="100%" Height="100%" Scrolling="None"
                BorderWidth="0" BorderStyle="None" BorderSize="0">
                <div id="divTaskInfo" style="overflow: hidden; border-top: 0px solid #6995CA; text-align: center;">
