<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InteriorLabel.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.SuperStationManagement.InteriorLabel" %>
                ...
                <table id="Tb" style="width: 100%; height: 100%" cellspacing="1" cellpadding="0" class="Table_Customer"
                    ...
                    <tr>
                        ...
                        <td class="content" style="width: 200px;">
                            <CbxRsm:PointCbxRsm runat="server" ApplicationType="Air" CbxWidth="200" CbxHeight="350" DefaultAllSelected="true" MultiSelected="true" DropDownWidth="320" ID="pointCbxRsm"
                                Visible="true" ></CbxRsm:PointCbxRsm>
                        </td>
                        <%--<td class="title" style="width: 150px">监测因子:
                        </td>
                        <td class="content" style="width: 400px;">
                            <CbxRsm:FactorCbxRsm runat="server" ApplicationType="Air" CbxWidth="380" DropDownWidth="420" ID="factorCbxRsm1"  Visible="false" ></CbxRsm:FactorCbxRsm>
                            <CbxRsm:FactorCbxRsm runat="server"  ApplicationType="Air" CbxWidth="380" DropDownWidth="420" DefaultAllSelected="true" ID="factorCbxRsm" Visible="false"></CbxRsm:FactorCbxRsm>
                         ...
                         <%--<td class="title" style="width: 80px">数据来源:
                                    ...
                                    <%--<td class="content" style="width: 500px;">
                                        ...
                                        <table>
                                            <tr>--%>
                                                <%--<td>--%>
                                                    <telerik:RadDropDownList ID="ddlDataSource" Visible="false" runat="server" Width="200px" OnSelectedIndexChanged="ddlDataSource_SelectedIndexChanged" AutoPostBack="true">
                                            <Items>
                        ...
                        <td class="title" style="width: 80px">单位:
                        </td>
                        ...
                        <div style="padding-top: 6px;" id="PointChart" runat="server" visible="true"> 
                            <div style="float: left;">
                                <asp:RadioButtonList runat="server" ID="PointFactor" AutoPostBack="true" Visible="false" RepeatDirection="Vertical" RepeatColumns="2" OnSelectedIndexChanged="PointFactor_SelectedIndexChanged">
                                    <%--<asp:ListItem Text="总值" Value="all" ></asp:ListItem>--%>
                                    <asp:ListItem Text="因子" Value="point" Selected="True"></asp:ListItem>
                                </asp:RadioButtonList>
                            </div>
