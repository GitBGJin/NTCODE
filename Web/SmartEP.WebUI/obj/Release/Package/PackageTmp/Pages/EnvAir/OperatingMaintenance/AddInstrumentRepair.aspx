<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddInstrumentRepair.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.OperatingMaintenance.AddInstrumentRepair" %>
            ...
            <telerik:RadPane ID="paneWhere" runat="server" Height="40px" Width="100%" Scrolling="None"
                ...
                <table id="Tb" style="width: 100%; height: 100%" cellspacing="1" cellpadding="0" class="Table_Customer"
                    ...
                    <tr id="yearWhere">
                        ...
                        <td class="title" style="width: 5%; text-align: center;">维修人员：</td>
                        <td class="title" style="width: 10%; text-align: center;">
                            <telerik:RadTextBox ID="RadTextBox1" runat="server"></telerik:RadTextBox>
                        </td>
                        <td class="title" style="width: 5%; text-align: center;">日期：</td>
                ...
                <div class="order-form" id="samplingMain">
                    <div class="profile">
                        ...
                        <ul class="profile-form" style="float: left; height: 320px;">
                            <li><span class="v" style="width: 150px;">故障现象描述：</span> <span class="k">
                                <telerik:RadTextBox ID="rtbWaterName" runat="server"></telerik:RadTextBox>
                            </span></li>

                            
                            <li><span class="v" style="width: 150px;">解决方案：</span> <span class="k">
                                <telerik:RadTextBox ID="RadTextBox3" runat="server"></telerik:RadTextBox>
                            </span></li>
                            <li><span class="v" style="width: 150px;">性能评价：</span> <span class="k">
                                <telerik:RadTextBox ID="RadTextBox4" runat="server"></telerik:RadTextBox>
                            </span></li>
                            <li style="text-align: right; margin-top: 170px;">
