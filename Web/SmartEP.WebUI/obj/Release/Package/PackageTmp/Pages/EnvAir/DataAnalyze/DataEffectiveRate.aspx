<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataEffectiveRate.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.DataAnalyze.DataEffectiveRate" %>
...
<body>
    <form id="form1" runat="server">
        <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
            <script type="text/javascript" language="javascript">
                ...
                function Refresh_Grid(args) {
                    if (args) {
                        var MasterTable = $find("<%= grdEffectiveRate.ClientID %>").get_masterTableView();
                        MasterTable.rebind();
                    }
                }
                //控制导出时按钮不会隐藏掉处理
                ...
                function RowClick(pointName, dtStart, dtEnd, factorCodes, ddlSel) {
                    ...
                    var moduleGuide = "BBF1AF89-5183-4FEF-B712-A3A4413AF60B";
                    OpenFineUIWindow(moduleGuide, "Pages/EnvAir/DataAnalyze/AuditData.aspx?PointName=" + pointName + "&DTBegin=" + dtStart + "&DTEnd=" + dtEnd + "&Factors=" + factorCodes + "&ddlSel=" + ddlSel, "原始数据")
                }
            </script>
        ...
        <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" UpdatePanelsRenderMode="Inline">
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="grdEffectiveRate">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="grdEffectiveRate" LoadingPanelID="RadAjaxLoadingPanel1" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
        ...
        <telerik:RadSplitter ID="splitter" runat="server" Orientation="Horizontal" Height="100%" BorderWidth="0"
            ...
            <telerik:RadPane ID="paneGrid" runat="server" Width="100%" Height="100%" Scrolling="None"
                BorderWidth="0" BorderStyle="None" BorderSize="0">
                <telerik:RadGrid ID="grdEffectiveRate" runat="server" GridLines="None" Height="100%" Width="100%"
                    ...
                    OnNeedDataSource="grdEffectiveRate_NeedDataSource" OnItemDataBound="grdEffectiveRate_ItemDataBound" OnColumnCreated="grdEffectiveRate_ColumnCreated"
                            ...
                            <div style="width: 100%; position: relative;">
                                ...
                                <div style="position: absolute; right: 10px; top: 2px;">
                                    <table style="font-size: 12px">
                                        <tr>
                                            <td style="text-align: center">系统正常运行率<br />
                                                系统运行时数：运行考核总时数
                                            </td>
                                        </tr>
                                    </table>
