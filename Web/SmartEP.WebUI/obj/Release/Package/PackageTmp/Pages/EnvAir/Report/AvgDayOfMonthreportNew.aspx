<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AvgDayOfMonthreportNew.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.Report.AvgDayOfMonthreportNew" %>
            ...
            <telerik:RadPane ID="paneWhere" runat="server" Height="143px" Width="100%" Scrolling="None"
                ...
                <table id="Tb" style="height: 100%" class="Table_Customer" border="0">
                    ...
                    <tr>
                        ...
                        <td class="content">
                            <telerik:RadComboBox runat="server" ID="comboCity" Width="360px" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" CheckedItemsTexts="DisplayAllInInput"
                                Localization-CheckAllString="全选">
                                <Items>
                                    <telerik:RadComboBoxItem Text="监测站" Value="9" Checked="true" />
                                    <telerik:RadComboBoxItem Text="拙政园" Value="33" Checked="true" />
                                    <telerik:RadComboBoxItem Text="苏州中学" Value="34" Checked="true" />
                                    <telerik:RadComboBoxItem Text="苏州大学" Value="35" Checked="true" />
                                    <telerik:RadComboBoxItem Text="园区市政" Value="36" Checked="true" />
                                    <telerik:RadComboBoxItem Text="市政府" Value="38" Checked="true" />
                                    <telerik:RadComboBoxItem Text="渔洋山" Value="39" Checked="true" />
                                    <telerik:RadComboBoxItem Text="光大环保" Value="24" Checked="true" />
                                </Items>
                            </telerik:RadComboBox>
