<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OzonePrecursor.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.SuperStationManagement.OzonePrecursor" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%@ Register TagPrefix="CbxRsm" TagName="PointCbxRsm" Src="~/Controls/PointCbxRsm.ascx" %>
<%@ Register TagPrefix="CbxRsm" TagName="FactorCbxRsm1" Src="~/Controls/FactorCbxRsm1.ascx" %>
<%--<%@ Register TagPrefix="CbxRsm" TagName="PageOn" Src="~/Controls/PageOn.ascx" %>--%>
<!DOCTYPE html>
        ...
        <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            ...
            <script type="text/javascript">
                ...
                function CreatCharts() {
                    ...
                    chartdiv5 += '</div>';
                    //$(':radio[name=TypeNameGroup]:checked').next(":label").text()
                    console.log($(':radio[name=TypeNameGroup]:checked').val());
                    if ($(':radio[name=TypeNameGroup]:checked').val() == "一级类")
                    {
...
function onRequestEnd(sender, args) {
        ...
        <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" DefaultLoadingPanelID="RadAjaxLoadingPanel1"
            ...
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="gridAuditTwo">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="gridAuditTwo" LoadingPanelID="RadAjaxLoadingPanel1" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
                <telerik:AjaxSetting AjaxControlID="gridAuditThree">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="gridAuditThree" LoadingPanelID="RadAjaxLoadingPanel1" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
                ...
                <telerik:AjaxSetting AjaxControlID="LinkButton1">
                    <UpdatedControls>
                        ...
                        <telerik:AjaxUpdatedControl ControlID="LinkButton3" />
                        <telerik:AjaxUpdatedControl ControlID="LinkButton4" />
                        <telerik:AjaxUpdatedControl ControlID="gridAudit" LoadingPanelID="RadAjaxLoadingPanel1" />
                        <telerik:AjaxUpdatedControl ControlID="gridAuditTwo"  LoadingPanelID="RadAjaxLoadingPanel1"/>
                        <telerik:AjaxUpdatedControl ControlID="gridAuditThree" LoadingPanelID="RadAjaxLoadingPanel1" />
                        <telerik:AjaxUpdatedControl ControlID="lblShow" />
                        </UpdatedControls>
                    </telerik:AjaxSetting>
                ...
                <telerik:AjaxSetting AjaxControlID="LinkButton4">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="gridAudit" LoadingPanelID="RadAjaxLoadingPanel1" />
                        <telerik:AjaxUpdatedControl ControlID="gridAuditTwo"  LoadingPanelID="RadAjaxLoadingPanel1"/>
                        <telerik:AjaxUpdatedControl ControlID="gridAuditThree" LoadingPanelID="RadAjaxLoadingPanel1" />
                ...
                <telerik:AjaxSetting AjaxControlID="TypeNameGroup">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="gridAudit" LoadingPanelID="RadAjaxLoadingPanel1" />
                        <telerik:AjaxUpdatedControl ControlID="gridAuditTwo"  LoadingPanelID="RadAjaxLoadingPanel1"/>
                        <telerik:AjaxUpdatedControl ControlID="gridAuditThree" LoadingPanelID="RadAjaxLoadingPanel1" />
                        <telerik:AjaxUpdatedControl ControlID="TypeNameGroup" LoadingPanelID="RadAjaxLoadingPanel1" />
                        <telerik:AjaxUpdatedControl ControlID="factorCbxRsm1" LoadingPanelID="RadAjaxLoadingPanel1" />
                        <telerik:AjaxUpdatedControl ControlID="cbFactor" LoadingPanelID="RadAjaxLoadingPanel1" />
                        <telerik:AjaxUpdatedControl ControlID="tbFactor" LoadingPanelID="RadAjaxLoadingPanel1" />
                        <telerik:AjaxUpdatedControl ControlID="lblShow" LoadingPanelID="RadAjaxLoadingPanel1" />
                        <telerik:AjaxUpdatedControl ControlID="LinkButton1" LoadingPanelID="RadAjaxLoadingPanel1" />
                        <telerik:AjaxUpdatedControl ControlID="LinkButton3" LoadingPanelID="RadAjaxLoadingPanel1" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
        ...
        <telerik:RadSplitter ID="splitter" runat="server" Orientation="Horizontal" Height="100%" Width="100%"
            ...
            <telerik:RadPane ID="paneWhere" runat="server" Height="90px" Width="100%" Scrolling="None"
                ...
                <table id="Tb" style="width: 100%; height: 100%" cellspacing="1" cellpadding="0" class="Table_Customer"
                    border="0">
                    <tr>
                        <td class="title" style="width: 180px">站点:
                        </td>
                        <td class="content" style="width: 250px;">
                            <CbxRsm:PointCbxRsm runat="server" ApplicationType="Air" CbxWidth="250" CbxHeight="350" MultiSelected="true" DropDownWidth="520" ID="pointCbxRsm"
                                Visible="true" ></CbxRsm:PointCbxRsm>
                            <%--<telerik:RadDropDownList ID="cbPoint" runat="server" Width="160px" Visible="false">
                            </telerik:RadDropDownList>--%>
                        </td>
                        <td class="title" style="width: 180px">监测因子:
                        </td>
                        <td class="content" style="width: 420px;">
                            ...
                            <%--<telerik:RadDropDownTree ID="RadDropDownTree1" DataSourceID="" runat="server"></telerik:RadDropDownTree>--%>
                        </td>
                        <td class="title" style="width: 180px">排序:
                        </td>
                        ...
                        <td class="content"  style="width: 400px;">
                            <asp:RadioButtonList runat="server" ID="TypeNameGroup"  RepeatDirection="Horizontal" OnSelectedIndexChanged="TypeNameGroup_SelectedIndexChanged" AutoPostBack="true"></asp:RadioButtonList>
                        </td>
                        
                        
                    </tr>
                    <tr>
                        <td class="title" style="width: 180px;">数据类型:
                        </td>
                        <td class="content" style="width: 250px;" >
                        ...
                        <td class="title" style="width: 180px; text-align: center;">开始时间:
                        </td>
                        <td class="content" style="width: 420px;">
                        ...
                        <td class="title" style="width: 180px">数据来源:
                                    </td>
                        ...
                        <td class="content" style="width: 400px;text-align:center">
                            单位:
                            <telerik:RadComboBox runat="server" ID="uunit" Width="90px">
                                <Items>
                                    <telerik:RadComboBoxItem Text="ppb" Value="ppb" Selected="true" />
                                    <telerik:RadComboBoxItem Text="μg/m³" Value="μg/m³" />
                                </Items>
                            </telerik:RadComboBox>
                            <asp:ImageButton ID="btnSearch" runat="server" OnClientClick="return OnClientClicking()"   ImageAlign="Middle" OnClick="btnSearch_Click" SkinID="ImgBtnSearch" />
                        </td>
                    </tr>
                </table>
            </telerik:RadPane>
                    ...
                    <telerik:RadPageView ID="grvGrid" runat="server" Visible="true">
                        <telerik:RadGrid ID="gridAudit" runat="server" GridLines="None" Height="100%" Width="100%"
                            ...
                            <MasterTableView GridLines="None" TableLayout="Fixed" CommandItemDisplay="Top" IsFilterItemExpanded="False"
                                InsertItemCurrentPageIndexAction="ShowItemOnCurrentPage" NoMasterRecordsText="没有数据">
                                ...
                                <PagerStyle FirstPageToolTip="首页" Visible="true"  AlwaysVisible="true"  Position="Bottom" NextPageToolTip="下页" LastPageToolTip="尾页" PrevPageToolTip="上页"
                                ...
                                <%--<CbxRsm:PageOn runat="server" RecPageChanged="" id="PageOn"/>--%>
                            </MasterTableView>
                        ...
                        <telerik:RadGrid ID="gridAuditTwo" runat="server" GridLines="None" Height="100%" Width="100%"
                            AllowPaging="True" PageSize="24" AllowCustomPaging="True" AllowSorting="false" ShowFooter="false"
                            AutoGenerateColumns="True" AllowMultiRowSelection="false" EnableViewState="false"
                            EnableHeaderContextMenu="false" EnableHeaderContextFilterMenu="false" Visible="false"
                            ShowStatusBar="false" BorderWidth="0" BorderStyle="None" BorderSize="0" OnColumnCreated="gridAuditTwo_ColumnCreated"
                            OnNeedDataSource="gridAuditTwo_NeedDataSource" OnItemDataBound="gridAuditTwo_ItemDataBound"
                            CssClass="RadGrid_Customer">
                            <ExportSettings HideStructureColumns="True" IgnorePaging="True" OpenInNewWindow="True" ExportOnlyData="true" />
                            <MasterTableView GridLines="None" TableLayout="Fixed" CommandItemDisplay="Top" IsFilterItemExpanded="False"
                                InsertItemCurrentPageIndexAction="ShowItemOnCurrentPage" NoMasterRecordsText="没有数据">
                                ...
                                <ColumnGroups>
                                    <telerik:GridColumnGroup Name="非甲烷碳氢化合物" HeaderText="非甲烷碳氢化合物"
                                        HeaderStyle-HorizontalAlign="Center" >
                                    </telerik:GridColumnGroup>
                                    <telerik:GridColumnGroup Name="卤代烃类" HeaderText="卤代烃类"
                                        HeaderStyle-HorizontalAlign="Center">
                                    </telerik:GridColumnGroup>
                                    <telerik:GridColumnGroup Name="含氧氮类" HeaderText="含氧氮类"
                                        HeaderStyle-HorizontalAlign="Center">
                                    </telerik:GridColumnGroup>
                                </ColumnGroups>
                                <Columns>
                                    <telerik:GridTemplateColumn HeaderText="序号" UniqueName="rowNum" HeaderStyle-Width="50px" HeaderStyle-Height="50px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                            ...
                            <ClientSettings>
                                <Scrolling AllowScroll="True" EnableVirtualScrollPaging="false" UseStaticHeaders="True" 
                                    SaveScrollPosition="true" FrozenColumnsCount="3"></Scrolling>
                            </ClientSettings>
                        </telerik:RadGrid>
                        <telerik:RadGrid ID="gridAuditThree" runat="server" GridLines="None" Height="100%" Width="100%"
                            AllowPaging="True" PageSize="24" AllowCustomPaging="True" AllowSorting="false" ShowFooter="false"
                            AutoGenerateColumns="true" AllowMultiRowSelection="false" EnableViewState="false"
                            EnableHeaderContextMenu="false" EnableHeaderContextFilterMenu="false" Visible="false"
                            ShowStatusBar="false" BorderWidth="0" BorderStyle="None" BorderSize="0" OnColumnCreated="gridAuditThree_ColumnCreated"
                            OnNeedDataSource="gridAuditThree_NeedDataSource" OnItemDataBound="gridAuditThree_ItemDataBound"
                            CssClass="RadGrid_Customer">
                            <ExportSettings HideStructureColumns="True" IgnorePaging="True" OpenInNewWindow="True" ExportOnlyData="true" />
                            <MasterTableView GridLines="None" TableLayout="Fixed" CommandItemDisplay="Top" IsFilterItemExpanded="False"
                                InsertItemCurrentPageIndexAction="ShowItemOnCurrentPage" NoMasterRecordsText="没有数据">
                                ...
                                <ColumnGroups>
                                    ...
                                    <telerik:GridColumnGroup Name="高碳烷烃" HeaderText="高碳烷烃C6-C12"
                                        HeaderStyle-HorizontalAlign="Center" ParentGroupName="非甲烷碳氢化合物" >
                                    </telerik:GridColumnGroup>
                                    <telerik:GridColumnGroup Name="炔烃" HeaderText="炔烃"
                                        HeaderStyle-HorizontalAlign="Center" ParentGroupName="非甲烷碳氢化合物">
                                    </telerik:GridColumnGroup>
                                    <telerik:GridColumnGroup Name="高碳烯烃" HeaderText="高碳烯烃C6-C12"
                                        HeaderStyle-HorizontalAlign="Center" ParentGroupName="非甲烷碳氢化合物">
                                    </telerik:GridColumnGroup>
                                    <telerik:GridColumnGroup Name="低碳烯烃" HeaderText="低碳烯烃C2-C5"
                                        HeaderStyle-HorizontalAlign="Center"  ParentGroupName="非甲烷碳氢化合物">
                                    </telerik:GridColumnGroup>
                                    <telerik:GridColumnGroup Name="苯系物" HeaderText="苯系物"
                                        HeaderStyle-HorizontalAlign="Center" ParentGroupName="非甲烷碳氢化合物">
                                    </telerik:GridColumnGroup>
                                    <telerik:GridColumnGroup Name="低碳烷烃" HeaderText="低碳烷烃C2-C5"
                                        HeaderStyle-HorizontalAlign="Center" ParentGroupName="非甲烷碳氢化合物">
                                    </telerik:GridColumnGroup>
                                    <telerik:GridColumnGroup Name="氟利昂" HeaderText="氟利昂"
                                        HeaderStyle-HorizontalAlign="Center"  ParentGroupName="卤代烃类">
                                    </telerik:GridColumnGroup>
                                    <telerik:GridColumnGroup Name="卤代芳香烃" HeaderText="卤代芳香烃"
                                        HeaderStyle-HorizontalAlign="Center"  ParentGroupName="卤代烃类">
                                    </telerik:GridColumnGroup>
                                    <telerik:GridColumnGroup Name="卤代烯烃" HeaderText="卤代烯烃"
                                        HeaderStyle-HorizontalAlign="Center"  ParentGroupName="卤代烃类">
                                    </telerik:GridColumnGroup>
                                    <telerik:GridColumnGroup Name="卤代烷烃" HeaderText="卤代烷烃"
                                        HeaderStyle-HorizontalAlign="Center"   ParentGroupName="卤代烃类">
                                    </telerik:GridColumnGroup>
                                    <telerik:GridColumnGroup Name="含氮有机物" HeaderText="含氮有机物"
                                        HeaderStyle-HorizontalAlign="Center"  ParentGroupName="含氧氮类">
                                    </telerik:GridColumnGroup>
                                    <telerik:GridColumnGroup Name="醛类" HeaderText="醛类有机物"
                                        HeaderStyle-HorizontalAlign="Center"  ParentGroupName="含氧氮类">
                                    </telerik:GridColumnGroup>
                                    <telerik:GridColumnGroup Name="酮类" HeaderText="酮类有机物"
                                        HeaderStyle-HorizontalAlign="Center"   ParentGroupName="含氧氮类">
                                    </telerik:GridColumnGroup>
                                    <telerik:GridColumnGroup Name="醚类" HeaderText="醚类有机物"
                                        HeaderStyle-HorizontalAlign="Center"  ParentGroupName="含氧氮类">
                                    </telerik:GridColumnGroup>
                                </ColumnGroups>
                                <Columns>
            ...
            <telerik:RadPane ID="RadPane1" runat="server" Scrolling="None" Width="100%" Height="26px"
                BorderWidth="0" BorderStyle="None" BorderSize="0">
            ...
            <asp:LinkButton ID="LinkButton2" runat="server" Visible="false" Font-Size="9pt"  OnClick="LinkButton2_Click">上一页</asp:LinkButton>    
            <asp:LinkButton ID="LinkButton3" runat="server" Font-Size="9pt"  OnClick="LinkButton3_Click">下一页</asp:LinkButton>    
            <asp:LinkButton ID="LinkButton4" runat="server" Visible="false" Font-Size="9pt"  OnClick="LinkButton4_Click">尾页</asp:LinkButton>--%>
            <%--<telerik:RadTextBox ID="RadTextBox1" Text="显示第1-20条，共30条" runat="server"></telerik:RadTextBox>--%>
            </telerik:RadPane>
        </telerik:RadSplitter>
