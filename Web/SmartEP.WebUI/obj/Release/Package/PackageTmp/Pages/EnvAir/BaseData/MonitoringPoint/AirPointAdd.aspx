<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AirPointAdd.aspx.cs" MasterPageFile="~/WebMaster/MasterPage.Master" Inherits="SmartEP.WebUI.Pages.EnvAir.BaseData.AirPointAdd" %>
    ...
    <table id="maintable" cellspacing="1" width="100%" cellpadding="0" class="Table_Customer" border="0">
        <tr class="btnTitle">
            <td class="btnTitle" colspan="4">
                <asp:ImageButton ID="ImageButton1" SkinID="ImgBtnAdd" runat="server" OnClick="btnAdd_Click" />
            </td>
        </tr>
        <tr>
          <%--  <td class="title">监测站</td>
            ...
            <td class="content">
                <telerik:RadTextBox ID="txtPointName" runat="server" Width="150px"
        ...
        <tr>
      <%--  <td class="title">环境参数</td>
        <td class="content"><telerik:RadComboBox ID="envCodeList" runat="server"    Width="150px"></telerik:RadComboBox></td>--%>
        ...
        <td class="content"><telerik:RadComboBox ID="contrlCodeList" runat="server"    Width="150px"></telerik:RadComboBox></td>
             <td class="title">MN</td>
             <td class="content">
                <telerik:RadTextBox   ID="txtMN" runat="server" MaxLength="14"></telerik:RadTextBox>
                 <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtMN"
                    ErrorMessage="14位数字" ValidationExpression="\d{14,}" /><asp:RequiredFieldValidator
                        ID="RequiredFieldValidator2" runat="server"  ControlToValidate="txtMN" ErrorMessage="不能为空"></asp:RequiredFieldValidator>
            </td>
        </tr> 
         <tr>
