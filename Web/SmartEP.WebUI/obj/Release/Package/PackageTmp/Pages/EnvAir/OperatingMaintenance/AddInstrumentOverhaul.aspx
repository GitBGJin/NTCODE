<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddInstrumentOverhaul.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.OperatingMaintenance.AddInstrumentOverhaul" %>
            ...
            <telerik:RadPane ID="paneWhere" runat="server" Height="40px" Width="100%" Scrolling="None"
                ...
                <table id="Tb" style="width: 100%; height: 100%" cellspacing="1" cellpadding="0" class="Table_Customer"
                    ...
                    <tr id="yearWhere">
                        ...
                        <td class="title" style="width: 5%; text-align: center;">检修人员：</td>
                ...
                <div class="order-form" id="samplingMain">
                    <div class="profile">
                        ...
                        <ul class="profile-form" style="float: left; height: 320px;">
                            <li><span class="v" style="width: 150px;">检测调试结果：</span> <span class="k">
                                <telerik:RadTextBox ID="rtbWaterName" runat="server"></telerik:RadTextBox>
                            </span></li>


                            <li><span class="v" style="width: 150px;">故障现象：</span> <span class="k">
                                <telerik:RadTextBox ID="RadTextBox3" runat="server"></telerik:RadTextBox>
                            </span></li>
                            <li><span class="v" style="width: 150px;">故障原因：</span> <span class="k">
                ...
                <telerik:RadGrid ID="gridSamplingRecord" runat="server" GridLines="None" Height="100%" Width="100%"
                    ...
                    <MasterTableView GridLines="None" TableLayout="Fixed" CommandItemDisplay="Top" IsFilterItemExpanded="False"
                        ...
                        <Columns>
                            ...
                            <telerik:GridNumericColumn HeaderText="检测调试项目" UniqueName="PointName" DataField="PointName" DecimalDigits="0" MaxLength="14" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" EmptyDataText="--" />
                            <telerik:GridNumericColumn HeaderText="检测调试结果" UniqueName="PointName" DataField="PointName" DecimalDigits="0" MaxLength="14" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" EmptyDataText="--" />
