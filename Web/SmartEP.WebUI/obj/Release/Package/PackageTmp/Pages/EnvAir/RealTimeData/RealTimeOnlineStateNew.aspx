<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RealTimeOnlineStateNew.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.RealTimeData.RealTimeOnlineStateNew" %>
            ...
            <telerik:RadPane ID="paneWhere" runat="server" Height="60px" Width="100%" Scrolling="None"
                ...
                <table id="Tb" style="width: 100%; height: 100%" cellspacing="1" cellpadding="0" class="Table_Customer"
                    ...
                    <tr>
                        ...
                        <td style="width: 4%; text-align: center;">测点:</td>
                        ...
                        <td class="title" style="width: 6%; text-align: center;">测点因子:
                        </td>
                        <td class="content" style="width: 22%;">
                            <CbxRsm:FactorCbxRsm runat="server" ApplicationType="Air" CbxWidth="280" DropDownWidth="420" ID="factorCbxRsm"></CbxRsm:FactorCbxRsm>

                        </td>
                        <td style="width: 7%; text-align: center;">联网状态：</td>
                        <td style="width: 10%; text-align: left;">

                            <telerik:RadDropDownList ID="weekTo" runat="server" Width="100px" SelectedText="4" SelectedValue="4">
                                <Items>
                                    <telerik:DropDownListItem runat="server" Value="9999" Text="全部" />
                                    <telerik:DropDownListItem runat="server" Value="1" Text="在线" />
                                    <telerik:DropDownListItem runat="server" Value="0" Text="离线" />
                                    <%--<telerik:DropDownListItem runat="server" Value="4" Text="报警" />
                                    <telerik:DropDownListItem runat="server" Value="8" Text="故障" />
                                    <telerik:DropDownListItem runat="server" Value="16" Text="停运" />
                                    <telerik:DropDownListItem runat="server" Value="32" Text="始终在线" />--%>
                    ...
                    <tr>
                        ...
                        <td colspan="7" id="ti">
                            <span class="margin20-l"><a id="TotalNetwork" class="netState" href="javascript:void(0)" title="显示全部点位">在线率：<asp:Label ID="lblNetwork" runat="server" Text="0%"></asp:Label></a>&nbsp;&nbsp;&nbsp;
                                <a class="netState" href="javascript:void(0)" title="显示全部点位">联网总数<asp:Label ID="lblAllNetwork" runat="server" Text="0"></asp:Label>个</a>
                                <img class="netState margin20-l" src="../../../Resources/images/public/online.PNG" />&nbsp;&nbsp;
                                <a class="netState" href="javascript:void(0)" title="只显示在线点位">在线<asp:Label ID="lblOnline" runat="server" Text="0"></asp:Label>个</a>
                                <img class="netState margin20-l" src="../../../Resources/images/public/offline.PNG" />&nbsp;&nbsp;
                                <a class="netState" href="javascript:void(0)" title="只显示离线点位">离线<asp:Label ID="lblOffOnline" runat="server" Text="0"></asp:Label>个</a>
<%--                                <img class="netState margin20-l" src="../../../Resources/images/public/warn.PNG" />&nbsp;
                                <a class="netState" href="javascript:void(0)" title="只显示报警点位">报警<asp:Label ID="lblWarn" runat="server" Text="0"></asp:Label>个</a>
                                <img class="netState margin20-l" src="../../../Resources/images/public/fault.PNG" />&nbsp;
                                <a class="netState" href="javascript:void(0)" title="只显示故障点位">故障<asp:Label ID="lblFault" runat="server" Text="0"></asp:Label>个</a>
                                <img class="netState margin20-l" src="../../../Resources/images/public/stop.PNG" />&nbsp;
                                <a class="netState" href="javascript:void(0)" title="只显示停运点位">停运<asp:Label ID="lblStop" runat="server" Text="0"></asp:Label>个</a>
                                <img class="netState margin20-l" src="../../../Resources/images/public/alwaysOnline.PNG" />&nbsp;
                                <a class="netState" href="javascript:void(0)" title="只显示始终在线点位">始终在线<asp:Label ID="lblAlwaysOnline" runat="server" Text="0"></asp:Label>个</a>--%>
                        ...
                        <%--<td colspan="2"></td>
                        <td>
                            <input id="getNoBtn" class="getDPwdBtn2" type="button" value="刷新" />
                            <asp:Button ID="getNoBtn" runat="server" Text="刷新" />
                        </td>--%>
                    </tr>
                    <%--<tr>
            ...
            <telerik:RadPane ID="paneGrid" runat="server" Width="100%" Height="100%" Scrolling="None"
                ...
                <telerik:RadGrid ID="gridRealTimeOnlineState" runat="server" GridLines="None" Height="100%" Width="100%"
                    AllowPaging="True" PageSize="50" AllowCustomPaging="true" AllowSorting="false" ShowFooter="false"
                        ...
                        <CommandItemTemplate>
                            <div style="position: relative;">
                                <telerik:RadToolBar BorderWidth="0" ID="gridRTB" CssClass="RadToolBar_Customer" AutoPostBack="true"
                                    runat="server" Width="50%" Height="35px" />
