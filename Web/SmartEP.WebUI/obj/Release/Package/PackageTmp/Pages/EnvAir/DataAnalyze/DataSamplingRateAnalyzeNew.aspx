<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataSamplingRateAnalyzeNew.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.DataAnalyze.DataSamplingRateAnalyzeNew" %>
        ...
        <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            <script type="text/javascript">
                ...
                function ShowDetailForm(samplingRateId) {
                    ...
                    var uri = "DataSamplingDetailNew.aspx?SamplingRateId=" + samplingRateId
