<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MutilPointAuditDataHg.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.Audit.MutilPointAuditDataHg" %>
        ...
        <telerik:RadCodeBlock ID="RadCodeBlock3" runat="server">
            ...
            <script type="text/javascript">
                ...
                function SubmitAuditClicked(sender, args) {
                    ...
                    var StartTime = $find("<%=RadDatePickerBegin.ClientID%>").get_selectedDate().format("yyyy/M/dd");
                    var EndTime = $find("<%=RadDatePickerEnd.ClientID%>").get_selectedDate().format("yyyy/MM/dd");
                    var pointId = $("#PointIDHidden").val();
                    AjaxSubmitAudit(StartTime, EndTime, pointId, '<%=Session["applicationUID"]%>', '<%=Session["UserGuid"]%>', '<%=ViewState["pointType"]%>');
