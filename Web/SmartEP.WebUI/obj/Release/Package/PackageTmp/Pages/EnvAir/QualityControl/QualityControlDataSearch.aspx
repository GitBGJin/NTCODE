<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QualityControlDataSearch.aspx.cs" Inherits="SmartEP.WebUI.Pages.EnvAir.QualityControl.QualityControlDataSearch" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" DefaultLoadingPanelID="RadAjaxLoadingPanel1"
            ...
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="TreeView1">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="ddlInstrument"></telerik:AjaxUpdatedControl>
                        <telerik:AjaxUpdatedControl ControlID="ddlSearch"></telerik:AjaxUpdatedControl>
                    </UpdatedControls>
                </telerik:AjaxSetting>
                <telerik:AjaxSetting AjaxControlID="pointCbxRsm">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="divTree" LoadingPanelID="RadAjaxLoadingPanel1"></telerik:AjaxUpdatedControl>
                    </UpdatedControls>
                </telerik:AjaxSetting>
                    ...
                    <telerik:RadPane ID="RadPane2" runat="server" Height="60px" Scrolling="None">
                        <table style="width: 100%; text-align: left">
                            <tr>
                                ...
                                <td class="title" style="width: 70px; text-align: center;">测点：
                                </td>
                                ...
                                <td class="content" style="width: 280px;">
                                    <telerik:RadDropDownList runat="server" ID="ddlSearch" Width="280px">
                                        <Items>
        ...
        <asp:HiddenField ID="AjaxURL" runat="server" Value="../ChartAjaxRequest/QualityControlDataSearch.ashx" />
