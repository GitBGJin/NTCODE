<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PointCbxRsm.ascx.cs" Inherits="SmartEP.WebUI.Controls.PointCbxRsm" %>
...
<telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        //遍历选中CheckBox信息
        function OnPointClientDropDownClosed_Change(sender, args) {
            ...
            var points = document.getElementById("<%=pointNames.ClientID%>");
            if (points.value == checkName) {
                return;
            }
            points.value = checkName;
            document.getElementById("<%=btnPointChange.ClientID%>").click();
        }
        //下拉选项不自动收回
...
<div style="display: none">
    <asp:HiddenField ID="pointNames" runat="server" Value="" />
    <telerik:RadButton ID="btnPointChange" runat="server" AutoPostBack="true" OnClick="btnPointChange_Click"></telerik:RadButton>
</div>
<telerik:RadComboBox ID="RadCBoxPoint" runat="server" AutoPostBack="false" SkinID="Default" Skin="Default"
    OnClientDropDownOpening="OnClientDropDownOpening"
    OnClientDropDownOpened="OnClientDropDownOpened"
    OnClientDropDownClosed="OnPointClientDropDownClosed_Change">
    <HeaderTemplate>
        <table>
            <tr>
                <td>
                    <asp:RadioButtonList ID="radPointType" AutoPostBack="true" Visible="false" runat="server" RepeatDirection="Horizontal" OnSelectedIndexChanged="pointType_SelectedIndexChanged">
                    </asp:RadioButtonList>
                </td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
