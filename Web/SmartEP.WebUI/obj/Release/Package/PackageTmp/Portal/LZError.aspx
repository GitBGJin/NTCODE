<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LZError.aspx.cs" Inherits="SmartEP.WebUI.Portal.LZError" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        var url = PortalUrl + "/LZ404.aspx";
        var errorCode = "<%=Request.QueryString["ErrorCode"]%>";
            switch (errorCode) {
                case "404":
                    url = PortalUrl + "/LZ404.aspx";
                    break;
            }
